...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NDIRECT){
    ...
    8000266e:	0cb7fc63          	bgeu	a5,a1,80002746 <bmap+0xee>
  ...
  if(bn < NINDIRECT){
    ...
    8000267e:	10e7f163          	bgeu	a5,a4,80002780 <bmap+0x128>
    }
    brelse(bp);
    return addr;
  }
  ...
  bn -= NINDIRECT;
    80002682:	ef55891b          	addiw	s2,a1,-267
    80002686:	0009071b          	sext.w	a4,s2
  ...
  if (bn < NDBL_INDIRECT) {
    ...
    80002690:	08052483          	lw	s1,128(a0)
    80002694:	e899                	bnez	s1,800026aa <bmap+0x52>
      addr = balloc(ip->dev);
    80002696:	4108                	lw	a0,0(a0)
    80002698:	00000097          	auipc	ra,0x0
    8000269c:	e8e080e7          	jalr	-370(ra) # 80002526 <balloc>
    800026a0:	0005049b          	sext.w	s1,a0
      if (addr == 0)
    800026a4:	c8d5                	beqz	s1,80002758 <bmap+0x100>
        return 0;
      ip->addrs[NDIRECT + 1] = addr;
    800026a6:	0899a023          	sw	s1,128(s3)
    }

    // 读取双间接块
    bp = bread(ip->dev, addr);
    800026aa:	85a6                	mv	a1,s1
    800026ac:	0009a503          	lw	a0,0(s3)
    800026b0:	00000097          	auipc	ra,0x0
    800026b4:	bb4080e7          	jalr	-1100(ra) # 80002264 <bread>
    800026b8:	8a2a                	mv	s4,a0
    a = (uint*)bp->data;
    800026ba:	05850a93          	addi	s5,a0,88
    ...
    // 如果这个单间接块不存在，则分配一个
    if ((addr = a[index1]) == 0) {
    800026be:	0089579b          	srliw	a5,s2,0x8
    800026c2:	078a                	slli	a5,a5,0x2
    800026c4:	9abe                	add	s5,s5,a5
    800026c6:	000aa483          	lw	s1,0(s5)
    800026ca:	e08d                	bnez	s1,800026ec <bmap+0x94>
      addr = balloc(ip->dev);
    800026cc:	0009a503          	lw	a0,0(s3)
    800026d0:	00000097          	auipc	ra,0x0
    800026d4:	e56080e7          	jalr	-426(ra) # 80002526 <balloc>
    800026d8:	0005049b          	sext.w	s1,a0
      if (addr == 0)
    800026dc:	ccb5                	beqz	s1,80002758 <bmap+0x100>
        return 0;
      a[bn / NINDIRECT] = addr;
    800026de:	009aa023          	sw	s1,0(s5)
      log_write(bp);  // Record changes in the log
    800026e2:	8552                	mv	a0,s4
    800026e4:	00001097          	auipc	ra,0x1
    800026e8:	09a080e7          	jalr	154(ra) # 8000377e <log_write>
    }
    brelse(bp);
    800026ec:	8552                	mv	a0,s4
    800026ee:	00000097          	auipc	ra,0x0
    800026f2:	ca6080e7          	jalr	-858(ra) # 80002394 <brelse>

    // 读取相应的单间接块
    bp = bread(ip->dev, addr);
    800026f6:	85a6                	mv	a1,s1
    800026f8:	0009a503          	lw	a0,0(s3)
    800026fc:	00000097          	auipc	ra,0x0
    80002700:	b68080e7          	jalr	-1176(ra) # 80002264 <bread>
    ...
    // 如果这个数据块不存在，则分配一个
    if ((addr = a[index2]) == 0) {
    8000270a:	0ff97593          	andi	a1,s2,255
    8000270e:	058a                	slli	a1,a1,0x2
    80002710:	00b78933          	add	s2,a5,a1
    80002714:	00092483          	lw	s1,0(s2)
    80002718:	e08d                	bnez	s1,8000273a <bmap+0xe2>
      addr = balloc(ip->dev);
    8000271a:	0009a503          	lw	a0,0(s3)
    8000271e:	00000097          	auipc	ra,0x0
    80002722:	e08080e7          	jalr	-504(ra) # 80002526 <balloc>
    80002726:	0005049b          	sext.w	s1,a0
      if (addr == 0)
    8000272a:	c49d                	beqz	s1,80002758 <bmap+0x100>
        return 0;
      a[bn % NINDIRECT] = addr;
    8000272c:	00992023          	sw	s1,0(s2)
      log_write(bp);  // Record changes in the log
    80002730:	8552                	mv	a0,s4
    80002732:	00001097          	auipc	ra,0x1
    80002736:	04c080e7          	jalr	76(ra) # 8000377e <log_write>
    }
    brelse(bp);
    8000273a:	8552                	mv	a0,s4
    8000273c:	00000097          	auipc	ra,0x0
    80002740:	c58080e7          	jalr	-936(ra) # 80002394 <brelse>
    return addr;  // Returns the actual data block
    80002744:	a811                	j	80002758 <bmap+0x100>
    if((addr = ip->addrs[bn]) == 0)
    80002746:	02059913          	slli	s2,a1,0x20
    8000274a:	02095913          	srli	s2,s2,0x20
    8000274e:	090a                	slli	s2,s2,0x2
    80002750:	992a                	add	s2,s2,a0
    80002752:	05092483          	lw	s1,80(s2)
    80002756:	c899                	beqz	s1,8000276c <bmap+0x114>
  }

  panic("bmap: out of range");
}
    80002758:	8526                	mv	a0,s1
    8000275a:	70e2                	ld	ra,56(sp)
    8000275c:	7442                	ld	s0,48(sp)
    8000275e:	74a2                	ld	s1,40(sp)
    80002760:	7902                	ld	s2,32(sp)
    80002762:	69e2                	ld	s3,24(sp)
    80002764:	6a42                	ld	s4,16(sp)
    80002766:	6aa2                	ld	s5,8(sp)
    80002768:	6121                	addi	sp,sp,64
    8000276a:	8082                	ret
      ip->addrs[bn] = addr = balloc(ip->dev);
    8000276c:	4108                	lw	a0,0(a0)
    8000276e:	00000097          	auipc	ra,0x0
    80002772:	db8080e7          	jalr	-584(ra) # 80002526 <balloc>
    80002776:	0005049b          	sext.w	s1,a0
    8000277a:	04992823          	sw	s1,80(s2)
    8000277e:	bfe9                	j	80002758 <bmap+0x100>
    if((addr = ip->addrs[NDIRECT]) == 0)
    80002780:	5d6c                	lw	a1,124(a0)
    80002782:	c59d                	beqz	a1,800027b0 <bmap+0x158>
    bp = bread(ip->dev, addr);
    80002784:	0009a503          	lw	a0,0(s3)
    80002788:	00000097          	auipc	ra,0x0
    8000278c:	adc080e7          	jalr	-1316(ra) # 80002264 <bread>
    80002790:	892a                	mv	s2,a0
    a = (uint*)bp->data;
    80002792:	05850a13          	addi	s4,a0,88
    if((addr = a[bn]) == 0){
    80002796:	1482                	slli	s1,s1,0x20
    80002798:	9081                	srli	s1,s1,0x20
    8000279a:	048a                	slli	s1,s1,0x2
    8000279c:	9a26                	add	s4,s4,s1
    8000279e:	000a2483          	lw	s1,0(s4) # 2000 <_entry-0x7fffe000>
    800027a2:	c08d                	beqz	s1,800027c4 <bmap+0x16c>
    brelse(bp);
    800027a4:	854a                	mv	a0,s2
    800027a6:	00000097          	auipc	ra,0x0
    800027aa:	bee080e7          	jalr	-1042(ra) # 80002394 <brelse>
    return addr;
    800027ae:	b76d                	j	80002758 <bmap+0x100>
      ip->addrs[NDIRECT] = addr = balloc(ip->dev);
    800027b0:	4108                	lw	a0,0(a0)
    800027b2:	00000097          	auipc	ra,0x0
    800027b6:	d74080e7          	jalr	-652(ra) # 80002526 <balloc>
    800027ba:	0005059b          	sext.w	a1,a0
    800027be:	06b9ae23          	sw	a1,124(s3)
    800027c2:	b7c9                	j	80002784 <bmap+0x12c>
      a[bn] = addr = balloc(ip->dev);
    800027c4:	0009a503          	lw	a0,0(s3)
    800027c8:	00000097          	auipc	ra,0x0
    800027cc:	d5e080e7          	jalr	-674(ra) # 80002526 <balloc>
    800027d0:	0005049b          	sext.w	s1,a0
    800027d4:	009a2023          	sw	s1,0(s4)
      log_write(bp);
    800027d8:	854a                	mv	a0,s2
    800027da:	00001097          	auipc	ra,0x1
    800027de:	fa4080e7          	jalr	-92(ra) # 8000377e <log_write>
    800027e2:	b7c9                	j	800027a4 <bmap+0x14c>
  panic("bmap: out of range");
    800027e4:	00006517          	auipc	a0,0x6
    800027e8:	d0450513          	addi	a0,a0,-764 # 800084e8 <syscalls+0x120>
    800027ec:	00003097          	auipc	ra,0x3
    800027f0:	65c080e7          	jalr	1628(ra) # 80005e48 <panic>
...
00000000800027f4 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80002814:	b82080e7          	jalr	-1150(ra) # 80006392 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    8000285a:	bf0080e7          	jalr	-1040(ra) # 80006446 <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    8000288a:	bc0080e7          	jalr	-1088(ra) # 80006446 <release>
}
    ...
    800028ac:	5a0080e7          	jalr	1440(ra) # 80005e48 <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    8000292c:	520080e7          	jalr	1312(ra) # 80005e48 <panic>
...
0000000080002930 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002952:	9b4080e7          	jalr	-1612(ra) # 80006302 <initlock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002990 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    80002a10:	43c080e7          	jalr	1084(ra) # 80005e48 <panic>
...
0000000080002aea <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002b02:	894080e7          	jalr	-1900(ra) # 80006392 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002b18:	932080e7          	jalr	-1742(ra) # 80006446 <release>
}
...
0000000080002b28 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b64:	2e8080e7          	jalr	744(ra) # 80005e48 <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002be6:	266080e7          	jalr	614(ra) # 80005e48 <panic>
...
0000000080002bea <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002c32:	21a080e7          	jalr	538(ra) # 80005e48 <panic>
...
itrunc(struct inode *ip)
{
  ...
  iupdate(ip);
    ...
    80002d0a:	45850b93          	addi	s7,a0,1112
...
sys_open(void)
{
  ...
  iunlock(ip);
    ...
    80004c2c:	fc2080e7          	jalr	-62(ra) # 80002bea <iunlock>
  end_op();
  ...
  return fd;
    ...
    80004c6c:	ec0080e7          	jalr	-320(ra) # 80002b28 <ilock>
  ...
  for(i = 0; i < NSYMLINK; ++i) {
    ...
    80004d28:	e04080e7          	jalr	-508(ra) # 80002b28 <ilock>
    if(ip->type != T_SYMLINK) {
  ...
  return 0;
    ...
    80004dba:	e80080e7          	jalr	-384(ra) # 80002c36 <itrunc>
...
0000000080004de0 <sys_symlink>:

// Generating symbolic links
uint64 
sys_symlink(void) {
    80004de0:	712d                	addi	sp,sp,-288
    80004de2:	ee06                	sd	ra,280(sp)
    80004de4:	ea22                	sd	s0,272(sp)
    80004de6:	e626                	sd	s1,264(sp)
    80004de8:	e24a                	sd	s2,256(sp)
    80004dea:	1200                	addi	s0,sp,288
  ...
  if ((n = argstr(0, target, MAXPATH)) < 0
    ...
    80004dfa:	142080e7          	jalr	322(ra) # 80001f38 <argstr>
    80004dfe:	84aa                	mv	s1,a0
    || argstr(1, path, MAXPATH) < 0) {
    return -1;
    80004e00:	557d                	li	a0,-1
  if ((n = argstr(0, target, MAXPATH)) < 0
    80004e02:	0604c463          	bltz	s1,80004e6a <sys_symlink+0x8a>
    || argstr(1, path, MAXPATH) < 0) {
    80004e06:	08000613          	li	a2,128
    80004e0a:	ee040593          	addi	a1,s0,-288
    80004e0e:	4505                	li	a0,1
    80004e10:	ffffd097          	auipc	ra,0xffffd
    80004e14:	128080e7          	jalr	296(ra) # 80001f38 <argstr>
    80004e18:	87aa                	mv	a5,a0
    return -1;
    80004e1a:	557d                	li	a0,-1
    || argstr(1, path, MAXPATH) < 0) {
    80004e1c:	0407c763          	bltz	a5,80004e6a <sys_symlink+0x8a>
  }

  begin_op();
    80004e20:	ffffe097          	auipc	ra,0xffffe
    80004e24:	786080e7          	jalr	1926(ra) # 800035a6 <begin_op>
  // create the symlink's inode
  if((ip = create(path, T_SYMLINK, 0, 0)) == 0) {
    80004e28:	4681                	li	a3,0
    80004e2a:	4601                	li	a2,0
    80004e2c:	4591                	li	a1,4
    80004e2e:	ee040513          	addi	a0,s0,-288
    80004e32:	fffff097          	auipc	ra,0xfffff
    80004e36:	6d4080e7          	jalr	1748(ra) # 80004506 <create>
    80004e3a:	892a                	mv	s2,a0
    80004e3c:	cd0d                	beqz	a0,80004e76 <sys_symlink+0x96>
    end_op();
    return -1;
  }
  // write the target path to the inode
  if(writei(ip, 0, (uint64)target, 0, n) != n) {
    80004e3e:	0004871b          	sext.w	a4,s1
    80004e42:	4681                	li	a3,0
    80004e44:	f6040613          	addi	a2,s0,-160
    80004e48:	4581                	li	a1,0
    80004e4a:	ffffe097          	auipc	ra,0xffffe
    80004e4e:	134080e7          	jalr	308(ra) # 80002f7e <writei>
    80004e52:	02951863          	bne	a0,s1,80004e82 <sys_symlink+0xa2>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  iunlockput(ip);
    ...
    80004e5c:	fdc080e7          	jalr	-36(ra) # 80002e34 <iunlockput>
  end_op();
    80004e60:	ffffe097          	auipc	ra,0xffffe
    80004e64:	7c6080e7          	jalr	1990(ra) # 80003626 <end_op>
  return 0;
    80004e68:	4501                	li	a0,0
}
    80004e6a:	60f2                	ld	ra,280(sp)
    80004e6c:	6452                	ld	s0,272(sp)
    80004e6e:	64b2                	ld	s1,264(sp)
    80004e70:	6912                	ld	s2,256(sp)
    80004e72:	6115                	addi	sp,sp,288
    80004e74:	8082                	ret
    end_op();
    80004e76:	ffffe097          	auipc	ra,0xffffe
    80004e7a:	7b0080e7          	jalr	1968(ra) # 80003626 <end_op>
    return -1;
    80004e7e:	557d                	li	a0,-1
    80004e80:	b7ed                	j	80004e6a <sys_symlink+0x8a>
    iunlockput(ip);
    80004e82:	854a                	mv	a0,s2
    80004e84:	ffffe097          	auipc	ra,0xffffe
    80004e88:	fb0080e7          	jalr	-80(ra) # 80002e34 <iunlockput>
    end_op();
    80004e8c:	ffffe097          	auipc	ra,0xffffe
    80004e90:	79a080e7          	jalr	1946(ra) # 80003626 <end_op>
    return -1;
    80004e94:	557d                	li	a0,-1
    80004e96:	bfd1                	j	80004e6a <sys_symlink+0x8a>
...
sys_mkdir(void)
{
  ...
  begin_op();
    ...
    80004ea4:	706080e7          	jalr	1798(ra) # 800035a6 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80004eb6:	086080e7          	jalr	134(ra) # 80001f38 <argstr>
    ...
    80004ecc:	63e080e7          	jalr	1598(ra) # 80004506 <create>
  ...
  iunlockput(ip);
    ...
    80004ed6:	f62080e7          	jalr	-158(ra) # 80002e34 <iunlockput>
  end_op();
    80004eda:	ffffe097          	auipc	ra,0xffffe
    80004ede:	74c080e7          	jalr	1868(ra) # 80003626 <end_op>
  return 0;
    ...
    80004ef0:	73a080e7          	jalr	1850(ra) # 80003626 <end_op>
    return -1;
...
sys_mknod(void)
{
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80004f28:	fd0080e7          	jalr	-48(ra) # 80001ef4 <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80004f3a:	fbe080e7          	jalr	-66(ra) # 80001ef4 <argint>
     argint(1, &major) < 0 ||
    ...
    80004f54:	5b6080e7          	jalr	1462(ra) # 80004506 <create>
     argint(2, &minor) < 0 ||
  ...
  iunlockput(ip);
    ...
    80004f5e:	eda080e7          	jalr	-294(ra) # 80002e34 <iunlockput>
  end_op();
    80004f62:	ffffe097          	auipc	ra,0xffffe
    80004f66:	6c4080e7          	jalr	1732(ra) # 80003626 <end_op>
  return 0;
    80004f6a:	4501                	li	a0,0
    80004f6c:	a031                	j	80004f78 <sys_mknod+0x80>
    end_op();
    80004f6e:	ffffe097          	auipc	ra,0xffffe
    80004f72:	6b8080e7          	jalr	1720(ra) # 80003626 <end_op>
    return -1;
...
sys_chdir(void)
{
  ...
  struct proc *p = myproc();
    ...
    80004f90:	ebc080e7          	jalr	-324(ra) # 80000e48 <myproc>
    80004f94:	892a                	mv	s2,a0
  
  begin_op();
    80004f96:	ffffe097          	auipc	ra,0xffffe
    80004f9a:	610080e7          	jalr	1552(ra) # 800035a6 <begin_op>
  ...
  ilock(ip);
    ...
    80004fc8:	b64080e7          	jalr	-1180(ra) # 80002b28 <ilock>
  if(ip->type != T_DIR){
  ...
  iunlock(ip);
    ...
    80004fdc:	c12080e7          	jalr	-1006(ra) # 80002bea <iunlock>
  iput(p->cwd);
    80004fe0:	15093503          	ld	a0,336(s2)
    80004fe4:	ffffe097          	auipc	ra,0xffffe
    80004fe8:	da8080e7          	jalr	-600(ra) # 80002d8c <iput>
  end_op();
    80004fec:	ffffe097          	auipc	ra,0xffffe
    80004ff0:	63a080e7          	jalr	1594(ra) # 80003626 <end_op>
  p->cwd = ip;
  ...
  return 0;
    ...
    8000500a:	620080e7          	jalr	1568(ra) # 80003626 <end_op>
    return -1;
    ...
    80005018:	e20080e7          	jalr	-480(ra) # 80002e34 <iunlockput>
    end_op();
    8000501c:	ffffe097          	auipc	ra,0xffffe
    80005020:	60a080e7          	jalr	1546(ra) # 80003626 <end_op>
    return -1;
...
sys_exec(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005048:	ef4080e7          	jalr	-268(ra) # 80001f38 <argstr>
    return -1;
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    8000505c:	ebe080e7          	jalr	-322(ra) # 80001f16 <argaddr>
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80005098:	dc6080e7          	jalr	-570(ra) # 80001e5a <fetchaddr>
    ...
    800050c0:	df0080e7          	jalr	-528(ra) # 80001eac <fetchstr>
 ...
 bad:
  ...
  int ret = exec(path, argv);
    ...
    80005102:	fd4080e7          	jalr	-44(ra) # 800040d2 <exec>
...
sys_pipe(void)
{
  ...
  struct proc *p = myproc();
    ...
    80005144:	d08080e7          	jalr	-760(ra) # 80000e48 <myproc>
  ...
  if(argaddr(0, &fdarray) < 0)
    ...
    80005154:	dc6080e7          	jalr	-570(ra) # 80001f16 <argaddr>
    return -1;
  ...
  if(pipealloc(&rf, &wf) < 0)
    ...
    8000516a:	c3c080e7          	jalr	-964(ra) # 80003da2 <pipealloc>
    return -1;
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    ...
    80005180:	348080e7          	jalr	840(ra) # 800044c4 <fdalloc>
    ...
    80005194:	334080e7          	jalr	820(ra) # 800044c4 <fdalloc>
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    800051b0:	95e080e7          	jalr	-1698(ra) # 80000b0a <copyout>
    ...
    800051ca:	944080e7          	jalr	-1724(ra) # 80000b0a <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    800051f8:	87e080e7          	jalr	-1922(ra) # 80003a72 <fileclose>
    fileclose(wf);
    800051fc:	fc843503          	ld	a0,-56(s0)
    80005200:	fffff097          	auipc	ra,0xfffff
    80005204:	872080e7          	jalr	-1934(ra) # 80003a72 <fileclose>
    return -1;
    ...
    80005228:	84e080e7          	jalr	-1970(ra) # 80003a72 <fileclose>
    fileclose(wf);
    8000522c:	fc843503          	ld	a0,-56(s0)
    80005230:	fffff097          	auipc	ra,0xfffff
    80005234:	842080e7          	jalr	-1982(ra) # 80003a72 <fileclose>
    return -1;
