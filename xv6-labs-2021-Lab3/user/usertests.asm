...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0ba50513          	addi	a0,a0,186 # 60f8 <malloc+0x44a>
      46:	00006097          	auipc	ra,0x6
      4a:	baa080e7          	jalr	-1110(ra) # 5bf0 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	09850513          	addi	a0,a0,152 # 6118 <malloc+0x46a>
      88:	00006097          	auipc	ra,0x6
      8c:	b68080e7          	jalr	-1176(ra) # 5bf0 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	08850513          	addi	a0,a0,136 # 6130 <malloc+0x482>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	08a50513          	addi	a0,a0,138 # 6150 <malloc+0x4a2>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	05250513          	addi	a0,a0,82 # 6138 <malloc+0x48a>
      ee:	00006097          	auipc	ra,0x6
      f2:	b02080e7          	jalr	-1278(ra) # 5bf0 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	05e50513          	addi	a0,a0,94 # 6160 <malloc+0x4b2>
     10a:	00006097          	auipc	ra,0x6
     10e:	ae6080e7          	jalr	-1306(ra) # 5bf0 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	05c50513          	addi	a0,a0,92 # 6188 <malloc+0x4da>
     134:	00005097          	auipc	ra,0x5
     138:	784080e7          	jalr	1924(ra) # 58b8 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	04850513          	addi	a0,a0,72 # 6188 <malloc+0x4da>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	04458593          	addi	a1,a1,68 # 6198 <malloc+0x4ea>
     15c:	00005097          	auipc	ra,0x5
     160:	72c080e7          	jalr	1836(ra) # 5888 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	02050513          	addi	a0,a0,32 # 6188 <malloc+0x4da>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	02458593          	addi	a1,a1,36 # 61a0 <malloc+0x4f2>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	ff450513          	addi	a0,a0,-12 # 6188 <malloc+0x4da>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fde50513          	addi	a0,a0,-34 # 61a8 <malloc+0x4fa>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	a1e080e7          	jalr	-1506(ra) # 5bf0 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	cfc50513          	addi	a0,a0,-772 # 5f78 <malloc+0x2ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	ce8a8a93          	addi	s5,s5,-792 # 5f78 <malloc+0x2ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ebe50513          	addi	a0,a0,-322 # 61d0 <malloc+0x522>
     31a:	00006097          	auipc	ra,0x6
     31e:	8d6080e7          	jalr	-1834(ra) # 5bf0 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	eba50513          	addi	a0,a0,-326 # 61f0 <malloc+0x542>
     33e:	00006097          	auipc	ra,0x6
     342:	8b2080e7          	jalr	-1870(ra) # 5bf0 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	e96a0a13          	addi	s4,s4,-362 # 6208 <malloc+0x55a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	df250513          	addi	a0,a0,-526 # 6210 <malloc+0x562>
     426:	00005097          	auipc	ra,0x5
     42a:	7ca080e7          	jalr	1994(ra) # 5bf0 <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	dec50513          	addi	a0,a0,-532 # 6228 <malloc+0x57a>
     444:	00005097          	auipc	ra,0x5
     448:	7ac080e7          	jalr	1964(ra) # 5bf0 <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	dfe50513          	addi	a0,a0,-514 # 6258 <malloc+0x5aa>
     462:	00005097          	auipc	ra,0x5
     466:	78e080e7          	jalr	1934(ra) # 5bf0 <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	e1450513          	addi	a0,a0,-492 # 6288 <malloc+0x5da>
     47c:	00005097          	auipc	ra,0x5
     480:	774080e7          	jalr	1908(ra) # 5bf0 <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	e0650513          	addi	a0,a0,-506 # 6298 <malloc+0x5ea>
     49a:	00005097          	auipc	ra,0x5
     49e:	756080e7          	jalr	1878(ra) # 5bf0 <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	df8a0a13          	addi	s4,s4,-520 # 62c8 <malloc+0x61a>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	cc8a8a93          	addi	s5,s5,-824 # 61a0 <malloc+0x4f2>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	d5250513          	addi	a0,a0,-686 # 62d0 <malloc+0x622>
     586:	00005097          	auipc	ra,0x5
     58a:	66a080e7          	jalr	1642(ra) # 5bf0 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	d4c50513          	addi	a0,a0,-692 # 62e8 <malloc+0x63a>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	64c080e7          	jalr	1612(ra) # 5bf0 <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	cd250513          	addi	a0,a0,-814 # 6288 <malloc+0x5da>
     5be:	00005097          	auipc	ra,0x5
     5c2:	632080e7          	jalr	1586(ra) # 5bf0 <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	d4850513          	addi	a0,a0,-696 # 6318 <malloc+0x66a>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	618080e7          	jalr	1560(ra) # 5bf0 <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	d4250513          	addi	a0,a0,-702 # 6330 <malloc+0x682>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	5fa080e7          	jalr	1530(ra) # 5bf0 <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	b5458593          	addi	a1,a1,-1196 # 6198 <malloc+0x4ea>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	b2850513          	addi	a0,a0,-1240 # 6188 <malloc+0x4da>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	afc50513          	addi	a0,a0,-1284 # 6188 <malloc+0x4da>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	ae850513          	addi	a0,a0,-1304 # 6188 <malloc+0x4da>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	ce258593          	addi	a1,a1,-798 # 63c0 <malloc+0x712>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	a6850513          	addi	a0,a0,-1432 # 6188 <malloc+0x4da>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	bfc50513          	addi	a0,a0,-1028 # 6360 <malloc+0x6b2>
     76c:	00005097          	auipc	ra,0x5
     770:	484080e7          	jalr	1156(ra) # 5bf0 <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	c0050513          	addi	a0,a0,-1024 # 6380 <malloc+0x6d2>
     788:	00005097          	auipc	ra,0x5
     78c:	468080e7          	jalr	1128(ra) # 5bf0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	bfc50513          	addi	a0,a0,-1028 # 6390 <malloc+0x6e2>
     79c:	00005097          	auipc	ra,0x5
     7a0:	454080e7          	jalr	1108(ra) # 5bf0 <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	c0050513          	addi	a0,a0,-1024 # 63b0 <malloc+0x702>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	438080e7          	jalr	1080(ra) # 5bf0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	bcc50513          	addi	a0,a0,-1076 # 6390 <malloc+0x6e2>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	424080e7          	jalr	1060(ra) # 5bf0 <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	be650513          	addi	a0,a0,-1050 # 63c8 <malloc+0x71a>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	406080e7          	jalr	1030(ra) # 5bf0 <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	be850513          	addi	a0,a0,-1048 # 63e8 <malloc+0x73a>
     808:	00005097          	auipc	ra,0x5
     80c:	3e8080e7          	jalr	1000(ra) # 5bf0 <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	bd450513          	addi	a0,a0,-1068 # 6408 <malloc+0x75a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	be498993          	addi	s3,s3,-1052 # 6430 <malloc+0x782>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	c14a8a93          	addi	s5,s5,-1004 # 6468 <malloc+0x7ba>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	b6e50513          	addi	a0,a0,-1170 # 6408 <malloc+0x75a>
  ...
  if(unlink("small") < 0){
     ...
     8da:	b3250513          	addi	a0,a0,-1230 # 6408 <malloc+0x75a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	b1050513          	addi	a0,a0,-1264 # 6410 <malloc+0x762>
     908:	00005097          	auipc	ra,0x5
     90c:	2e8080e7          	jalr	744(ra) # 5bf0 <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	b2250513          	addi	a0,a0,-1246 # 6440 <malloc+0x792>
     926:	00005097          	auipc	ra,0x5
     92a:	2ca080e7          	jalr	714(ra) # 5bf0 <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	b3c50513          	addi	a0,a0,-1220 # 6478 <malloc+0x7ca>
     944:	00005097          	auipc	ra,0x5
     948:	2ac080e7          	jalr	684(ra) # 5bf0 <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	b4850513          	addi	a0,a0,-1208 # 64a0 <malloc+0x7f2>
     960:	00005097          	auipc	ra,0x5
     964:	290080e7          	jalr	656(ra) # 5bf0 <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	b4c50513          	addi	a0,a0,-1204 # 64c0 <malloc+0x812>
     97c:	00005097          	auipc	ra,0x5
     980:	274080e7          	jalr	628(ra) # 5bf0 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	b4850513          	addi	a0,a0,-1208 # 64d8 <malloc+0x82a>
     998:	00005097          	auipc	ra,0x5
     99c:	258080e7          	jalr	600(ra) # 5bf0 <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	b3650513          	addi	a0,a0,-1226 # 64f8 <malloc+0x84a>
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	ae450513          	addi	a0,a0,-1308 # 64f8 <malloc+0x84a>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	aa450513          	addi	a0,a0,-1372 # 6500 <malloc+0x852>
     a64:	00005097          	auipc	ra,0x5
     a68:	18c080e7          	jalr	396(ra) # 5bf0 <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	aa650513          	addi	a0,a0,-1370 # 6520 <malloc+0x872>
     a82:	00005097          	auipc	ra,0x5
     a86:	16e080e7          	jalr	366(ra) # 5bf0 <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	ab250513          	addi	a0,a0,-1358 # 6548 <malloc+0x89a>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	152080e7          	jalr	338(ra) # 5bf0 <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	a3650513          	addi	a0,a0,-1482 # 64f8 <malloc+0x84a>
     ...
     af2:	a7a50513          	addi	a0,a0,-1414 # 6568 <malloc+0x8ba>
     af6:	00005097          	auipc	ra,0x5
     afa:	0fa080e7          	jalr	250(ra) # 5bf0 <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	a8450513          	addi	a0,a0,-1404 # 6590 <malloc+0x8e2>
     b14:	00005097          	auipc	ra,0x5
     b18:	0dc080e7          	jalr	220(ra) # 5bf0 <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	a7e50513          	addi	a0,a0,-1410 # 65a8 <malloc+0x8fa>
     b32:	00005097          	auipc	ra,0x5
     b36:	0be080e7          	jalr	190(ra) # 5bf0 <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	a8a50513          	addi	a0,a0,-1398 # 65d0 <malloc+0x922>
     b4e:	00005097          	auipc	ra,0x5
     b52:	0a2080e7          	jalr	162(ra) # 5bf0 <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	39450513          	addi	a0,a0,916 # 5f08 <malloc+0x25a>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	a7c58593          	addi	a1,a1,-1412 # 6608 <malloc+0x95a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	36050513          	addi	a0,a0,864 # 5f08 <malloc+0x25a>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	34a50513          	addi	a0,a0,842 # 5f08 <malloc+0x25a>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	33450513          	addi	a0,a0,820 # 5f08 <malloc+0x25a>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	a6858593          	addi	a1,a1,-1432 # 6650 <malloc+0x9a2>
  ...
  unlink("unlinkread");
     ...
     c54:	2b850513          	addi	a0,a0,696 # 5f08 <malloc+0x25a>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	97850513          	addi	a0,a0,-1672 # 65e8 <malloc+0x93a>
     c78:	00005097          	auipc	ra,0x5
     c7c:	f78080e7          	jalr	-136(ra) # 5bf0 <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	98450513          	addi	a0,a0,-1660 # 6610 <malloc+0x962>
     c94:	00005097          	auipc	ra,0x5
     c98:	f5c080e7          	jalr	-164(ra) # 5bf0 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	98850513          	addi	a0,a0,-1656 # 6630 <malloc+0x982>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	f40080e7          	jalr	-192(ra) # 5bf0 <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	99450513          	addi	a0,a0,-1644 # 6658 <malloc+0x9aa>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	f24080e7          	jalr	-220(ra) # 5bf0 <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	99850513          	addi	a0,a0,-1640 # 6678 <malloc+0x9ca>
     ce8:	00005097          	auipc	ra,0x5
     cec:	f08080e7          	jalr	-248(ra) # 5bf0 <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	99c50513          	addi	a0,a0,-1636 # 6698 <malloc+0x9ea>
     d04:	00005097          	auipc	ra,0x5
     d08:	eec080e7          	jalr	-276(ra) # 5bf0 <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	8a858593          	addi	a1,a1,-1880 # 6608 <malloc+0x95a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	94058593          	addi	a1,a1,-1728 # 66c0 <malloc+0xa12>
     d88:	00006517          	auipc	a0,0x6
     d8c:	93050513          	addi	a0,a0,-1744 # 66b8 <malloc+0xa0a>
  ...
  unlink("lf1");
     ...
     da0:	91c50513          	addi	a0,a0,-1764 # 66b8 <malloc+0xa0a>
     da4:	00005097          	auipc	ra,0x5
     da8:	b14080e7          	jalr	-1260(ra) # 58b8 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00006517          	auipc	a0,0x6
     db2:	90a50513          	addi	a0,a0,-1782 # 66b8 <malloc+0xa0a>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	8fc50513          	addi	a0,a0,-1796 # 66c0 <malloc+0xa12>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	8c458593          	addi	a1,a1,-1852 # 66c0 <malloc+0xa12>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	8ae50513          	addi	a0,a0,-1874 # 66c0 <malloc+0xa12>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	a9e080e7          	jalr	-1378(ra) # 58b8 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00006597          	auipc	a1,0x6
     e26:	89658593          	addi	a1,a1,-1898 # 66b8 <malloc+0xa0a>
     e2a:	00006517          	auipc	a0,0x6
     e2e:	89650513          	addi	a0,a0,-1898 # 66c0 <malloc+0xa12>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	87a58593          	addi	a1,a1,-1926 # 66b8 <malloc+0xa0a>
     e46:	00006517          	auipc	a0,0x6
     e4a:	98250513          	addi	a0,a0,-1662 # 67c8 <malloc+0xb1a>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	86050513          	addi	a0,a0,-1952 # 66c8 <malloc+0xa1a>
     e70:	00005097          	auipc	ra,0x5
     e74:	d80080e7          	jalr	-640(ra) # 5bf0 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	85c50513          	addi	a0,a0,-1956 # 66e0 <malloc+0xa32>
     e8c:	00005097          	auipc	ra,0x5
     e90:	d64080e7          	jalr	-668(ra) # 5bf0 <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	85850513          	addi	a0,a0,-1960 # 66f8 <malloc+0xa4a>
     ea8:	00005097          	auipc	ra,0x5
     eac:	d48080e7          	jalr	-696(ra) # 5bf0 <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	85c50513          	addi	a0,a0,-1956 # 6718 <malloc+0xa6a>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	d2c080e7          	jalr	-724(ra) # 5bf0 <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	87050513          	addi	a0,a0,-1936 # 6748 <malloc+0xa9a>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	d10080e7          	jalr	-752(ra) # 5bf0 <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	86c50513          	addi	a0,a0,-1940 # 6760 <malloc+0xab2>
     efc:	00005097          	auipc	ra,0x5
     f00:	cf4080e7          	jalr	-780(ra) # 5bf0 <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	86850513          	addi	a0,a0,-1944 # 6778 <malloc+0xaca>
     f18:	00005097          	auipc	ra,0x5
     f1c:	cd8080e7          	jalr	-808(ra) # 5bf0 <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f30:	87450513          	addi	a0,a0,-1932 # 67a0 <malloc+0xaf2>
     f34:	00005097          	auipc	ra,0x5
     f38:	cbc080e7          	jalr	-836(ra) # 5bf0 <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	88850513          	addi	a0,a0,-1912 # 67d0 <malloc+0xb22>
     f50:	00005097          	auipc	ra,0x5
     f54:	ca0080e7          	jalr	-864(ra) # 5bf0 <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	842a0a13          	addi	s4,s4,-1982 # 67f0 <malloc+0xb42>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	7f050513          	addi	a0,a0,2032 # 67f0 <malloc+0xb42>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	78850513          	addi	a0,a0,1928 # 67f8 <malloc+0xb4a>
    1078:	00005097          	auipc	ra,0x5
    107c:	b78080e7          	jalr	-1160(ra) # 5bf0 <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	78850513          	addi	a0,a0,1928 # 6818 <malloc+0xb6a>
    1098:	00005097          	auipc	ra,0x5
    109c:	b58080e7          	jalr	-1192(ra) # 5bf0 <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	78c50513          	addi	a0,a0,1932 # 6838 <malloc+0xb8a>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	b3c080e7          	jalr	-1220(ra) # 5bf0 <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	77a98993          	addi	s3,s3,1914 # 6858 <malloc+0xbaa>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	74e50513          	addi	a0,a0,1870 # 6868 <malloc+0xbba>
    1122:	00005097          	auipc	ra,0x5
    1126:	ace080e7          	jalr	-1330(ra) # 5bf0 <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    118a:	faa98993          	addi	s3,s3,-86 # 6130 <malloc+0x482>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	84078793          	addi	a5,a5,-1984 # 7a50 <malloc+0x1da2>
  ...
  if(pid == 0){
    ...
    124a:	45a78793          	addi	a5,a5,1114 # 86a0 <big.1282>
    ...
    1270:	ef478793          	addi	a5,a5,-268 # 8160 <malloc+0x24b2>
    ...
    1294:	ea050513          	addi	a0,a0,-352 # 6130 <malloc+0x482>
    ...
    12ac:	66850513          	addi	a0,a0,1640 # 6910 <malloc+0xc62>
    12b0:	00005097          	auipc	ra,0x5
    12b4:	940080e7          	jalr	-1728(ra) # 5bf0 <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	5c050513          	addi	a0,a0,1472 # 6888 <malloc+0xbda>
    12d0:	00005097          	auipc	ra,0x5
    12d4:	920080e7          	jalr	-1760(ra) # 5bf0 <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	5c050513          	addi	a0,a0,1472 # 68a8 <malloc+0xbfa>
    12f0:	00005097          	auipc	ra,0x5
    12f4:	900080e7          	jalr	-1792(ra) # 5bf0 <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	5be50513          	addi	a0,a0,1470 # 68c8 <malloc+0xc1a>
    1312:	00005097          	auipc	ra,0x5
    1316:	8de080e7          	jalr	-1826(ra) # 5bf0 <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	5c650513          	addi	a0,a0,1478 # 68f0 <malloc+0xc42>
    1332:	00005097          	auipc	ra,0x5
    1336:	8be080e7          	jalr	-1858(ra) # 5bf0 <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	a4450513          	addi	a0,a0,-1468 # 6d88 <malloc+0x10da>
    134c:	00005097          	auipc	ra,0x5
    1350:	8a4080e7          	jalr	-1884(ra) # 5bf0 <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	5aa50513          	addi	a0,a0,1450 # 6938 <malloc+0xc8a>
    1396:	00005097          	auipc	ra,0x5
    139a:	85a080e7          	jalr	-1958(ra) # 5bf0 <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	dc850513          	addi	a0,a0,-568 # 6188 <malloc+0x4da>
  ...
  if(pid == 0){
    ...
    13ee:	d9ea0a13          	addi	s4,s4,-610 # 6188 <malloc+0x4da>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	5a6a8a93          	addi	s5,s5,1446 # 6998 <malloc+0xcea>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	50650513          	addi	a0,a0,1286 # 6968 <malloc+0xcba>
    146a:	00004097          	auipc	ra,0x4
    146e:	786080e7          	jalr	1926(ra) # 5bf0 <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	50250513          	addi	a0,a0,1282 # 6980 <malloc+0xcd2>
    1486:	00004097          	auipc	ra,0x4
    148a:	76a080e7          	jalr	1898(ra) # 5bf0 <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	50c50513          	addi	a0,a0,1292 # 69a8 <malloc+0xcfa>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	74c080e7          	jalr	1868(ra) # 5bf0 <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	ccea0a13          	addi	s4,s4,-818 # 6188 <malloc+0x4da>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	506a8a93          	addi	s5,s5,1286 # 69c8 <malloc+0xd1a>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	c7c50513          	addi	a0,a0,-900 # 6188 <malloc+0x4da>
  ...
  exit(xstatus);
    ...
    152e:	45650513          	addi	a0,a0,1110 # 6980 <malloc+0xcd2>
    1532:	00004097          	auipc	ra,0x4
    1536:	6be080e7          	jalr	1726(ra) # 5bf0 <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	48850513          	addi	a0,a0,1160 # 69d0 <malloc+0xd22>
    1550:	00004097          	auipc	ra,0x4
    1554:	6a0080e7          	jalr	1696(ra) # 5bf0 <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	bc078793          	addi	a5,a5,-1088 # 6130 <malloc+0x482>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	47478793          	addi	a5,a5,1140 # 69f0 <malloc+0xd42>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	46c50513          	addi	a0,a0,1132 # 69f8 <malloc+0xd4a>
  ...
  if(pid == 0) {
    ...
    15be:	43e50513          	addi	a0,a0,1086 # 69f8 <malloc+0xd4a>
    ...
    15da:	44250513          	addi	a0,a0,1090 # 6a18 <malloc+0xd6a>
    15de:	00004097          	auipc	ra,0x4
    15e2:	612080e7          	jalr	1554(ra) # 5bf0 <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	37650513          	addi	a0,a0,886 # 6968 <malloc+0xcba>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	5f6080e7          	jalr	1526(ra) # 5bf0 <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	3f250513          	addi	a0,a0,1010 # 6a00 <malloc+0xd52>
    1616:	00004097          	auipc	ra,0x4
    161a:	5da080e7          	jalr	1498(ra) # 5bf0 <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	b0450513          	addi	a0,a0,-1276 # 6130 <malloc+0x482>
  ...
  if(xstatus != 0)
    ...
    1664:	3c850513          	addi	a0,a0,968 # 6a28 <malloc+0xd7a>
    1668:	00004097          	auipc	ra,0x4
    166c:	588080e7          	jalr	1416(ra) # 5bf0 <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	3c450513          	addi	a0,a0,964 # 6a40 <malloc+0xd92>
    1684:	00004097          	auipc	ra,0x4
    1688:	56c080e7          	jalr	1388(ra) # 5bf0 <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	36850513          	addi	a0,a0,872 # 69f8 <malloc+0xd4a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	e0650513          	addi	a0,a0,-506 # 64c0 <malloc+0x812>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	52e080e7          	jalr	1326(ra) # 5bf0 <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	2aa50513          	addi	a0,a0,682 # 6980 <malloc+0xcd2>
    16de:	00004097          	auipc	ra,0x4
    16e2:	512080e7          	jalr	1298(ra) # 5bf0 <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	30850513          	addi	a0,a0,776 # 69f8 <malloc+0xd4a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	33e50513          	addi	a0,a0,830 # 6a58 <malloc+0xdaa>
    1722:	00004097          	auipc	ra,0x4
    1726:	4ce080e7          	jalr	1230(ra) # 5bf0 <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17e0:	29450513          	addi	a0,a0,660 # 6a70 <malloc+0xdc2>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	40c080e7          	jalr	1036(ra) # 5bf0 <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	22650513          	addi	a0,a0,550 # 6a88 <malloc+0xdda>
    186a:	00004097          	auipc	ra,0x4
    186e:	386080e7          	jalr	902(ra) # 5bf0 <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	22250513          	addi	a0,a0,546 # 6aa0 <malloc+0xdf2>
    1886:	00004097          	auipc	ra,0x4
    188a:	36a080e7          	jalr	874(ra) # 5bf0 <printf>
}
    ...
    18b4:	20850513          	addi	a0,a0,520 # 6ab8 <malloc+0xe0a>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	338080e7          	jalr	824(ra) # 5bf0 <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	1e850513          	addi	a0,a0,488 # 6ad8 <malloc+0xe2a>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	2f8080e7          	jalr	760(ra) # 5bf0 <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	00650513          	addi	a0,a0,6 # 6968 <malloc+0xcba>
    196a:	00004097          	auipc	ra,0x4
    196e:	286080e7          	jalr	646(ra) # 5bf0 <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	17250513          	addi	a0,a0,370 # 6af0 <malloc+0xe42>
    1986:	00004097          	auipc	ra,0x4
    198a:	26a080e7          	jalr	618(ra) # 5bf0 <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	16e50513          	addi	a0,a0,366 # 6b08 <malloc+0xe5a>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	24e080e7          	jalr	590(ra) # 5bf0 <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	f5650513          	addi	a0,a0,-170 # 6968 <malloc+0xcba>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	1d6080e7          	jalr	470(ra) # 5bf0 <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	f3250513          	addi	a0,a0,-206 # 6968 <malloc+0xcba>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	1b2080e7          	jalr	434(ra) # 5bf0 <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	07850513          	addi	a0,a0,120 # 6b28 <malloc+0xe7a>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	138080e7          	jalr	312(ra) # 5bf0 <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	da6080e7          	jalr	-602(ra) # 5868 <exit>
{
    ...
    1b0c:	03050513          	addi	a0,a0,48 # 6b38 <malloc+0xe8a>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	0e0080e7          	jalr	224(ra) # 5bf0 <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	23250513          	addi	a0,a0,562 # 6d88 <malloc+0x10da>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	092080e7          	jalr	146(ra) # 5bf0 <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	19450513          	addi	a0,a0,404 # 6d88 <malloc+0x10da>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	ff4080e7          	jalr	-12(ra) # 5bf0 <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	de050513          	addi	a0,a0,-544 # 6a00 <malloc+0xd52>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	fc8080e7          	jalr	-56(ra) # 5bf0 <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	ec650513          	addi	a0,a0,-314 # 6b58 <malloc+0xeaa>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	f56080e7          	jalr	-170(ra) # 5bf0 <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	eaa50513          	addi	a0,a0,-342 # 6b70 <malloc+0xec2>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	f22080e7          	jalr	-222(ra) # 5bf0 <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	e6c50513          	addi	a0,a0,-404 # 6b98 <malloc+0xeea>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	ebc080e7          	jalr	-324(ra) # 5bf0 <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	3d450513          	addi	a0,a0,980 # 61a0 <malloc+0x4f2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	398a8a93          	addi	s5,s5,920 # 61a0 <malloc+0x4f2>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	db0b8b93          	addi	s7,s7,-592 # 6bc0 <malloc+0xf12>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	b4c50513          	addi	a0,a0,-1204 # 6968 <malloc+0xcba>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	dcc080e7          	jalr	-564(ra) # 5bf0 <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	e7e50513          	addi	a0,a0,-386 # 6d88 <malloc+0x10da>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	cde080e7          	jalr	-802(ra) # 5bf0 <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1fbe:	c0e50513          	addi	a0,a0,-1010 # 6bc8 <malloc+0xf1a>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	c2e080e7          	jalr	-978(ra) # 5bf0 <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	21650513          	addi	a0,a0,534 # 61f0 <malloc+0x542>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	c0e080e7          	jalr	-1010(ra) # 5bf0 <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	bd050513          	addi	a0,a0,-1072 # 6bf8 <malloc+0xf4a>
    2030:	00004097          	auipc	ra,0x4
    2034:	bc0080e7          	jalr	-1088(ra) # 5bf0 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	b5650513          	addi	a0,a0,-1194 # 6be0 <malloc+0xf32>
    2092:	00004097          	auipc	ra,0x4
    2096:	b5e080e7          	jalr	-1186(ra) # 5bf0 <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	b7a50513          	addi	a0,a0,-1158 # 6c20 <malloc+0xf72>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	b42080e7          	jalr	-1214(ra) # 5bf0 <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	b7650513          	addi	a0,a0,-1162 # 6c38 <malloc+0xf8a>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	b26080e7          	jalr	-1242(ra) # 5bf0 <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	82650513          	addi	a0,a0,-2010 # 6968 <malloc+0xcba>
    214a:	00004097          	auipc	ra,0x4
    214e:	aa6080e7          	jalr	-1370(ra) # 5bf0 <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	aec50513          	addi	a0,a0,-1300 # 6c50 <malloc+0xfa2>
    216c:	00004097          	auipc	ra,0x4
    2170:	a84080e7          	jalr	-1404(ra) # 5bf0 <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21ea:	78250513          	addi	a0,a0,1922 # 6968 <malloc+0xcba>
    21ee:	00004097          	auipc	ra,0x4
    21f2:	a02080e7          	jalr	-1534(ra) # 5bf0 <printf>
      exit(1);
    21f6:	4505                	li	a0,1
    ...
    2216:	a5e50513          	addi	a0,a0,-1442 # 6c70 <malloc+0xfc2>
    221a:	00004097          	auipc	ra,0x4
    221e:	9d6080e7          	jalr	-1578(ra) # 5bf0 <printf>
      exit(1);
    2222:	4505                	li	a0,1
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2246:	a4650513          	addi	a0,a0,-1466 # 6c88 <malloc+0xfda>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2278:	a1450513          	addi	a0,a0,-1516 # 6c88 <malloc+0xfda>
  ...
  close(fd);
    ...
    229e:	30678793          	addi	a5,a5,774 # 85a0 <args.1871>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3f668693          	addi	a3,a3,1014 # 8698 <args.1871+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22aa:	00005717          	auipc	a4,0x5
    22ae:	9ee70713          	addi	a4,a4,-1554 # 6c98 <malloc+0xfea>
    ...
    2302:	a7a50513          	addi	a0,a0,-1414 # 6d78 <malloc+0x10ca>
    2306:	00004097          	auipc	ra,0x4
    230a:	8ea080e7          	jalr	-1814(ra) # 5bf0 <printf>
    exit(1);
    230e:	4505                	li	a0,1
    ...
    2326:	a7650513          	addi	a0,a0,-1418 # 6d98 <malloc+0x10ea>
    232a:	00004097          	auipc	ra,0x4
    232e:	8c6080e7          	jalr	-1850(ra) # 5bf0 <printf>
    exit(1);
    2332:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2384:	a3850513          	addi	a0,a0,-1480 # 6db8 <malloc+0x110a>
    2388:	00004097          	auipc	ra,0x4
    238c:	868080e7          	jalr	-1944(ra) # 5bf0 <printf>
    exit(1);
    2390:	4505                	li	a0,1
    ...
    23a0:	5cc50513          	addi	a0,a0,1484 # 6968 <malloc+0xcba>
    23a4:	00004097          	auipc	ra,0x4
    23a8:	84c080e7          	jalr	-1972(ra) # 5bf0 <printf>
    exit(1);
    23ac:	4505                	li	a0,1
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    243a:	61a78793          	addi	a5,a5,1562 # 7a50 <malloc+0x1da2>
  ...
  if(ret != -1){
    ...
    247c:	96850513          	addi	a0,a0,-1688 # 6de0 <malloc+0x1132>
    2480:	00003097          	auipc	ra,0x3
    2484:	770080e7          	jalr	1904(ra) # 5bf0 <printf>
    exit(1);
    2488:	4505                	li	a0,1
    ...
    249a:	3f250513          	addi	a0,a0,1010 # 6888 <malloc+0xbda>
    249e:	00003097          	auipc	ra,0x3
    24a2:	752080e7          	jalr	1874(ra) # 5bf0 <printf>
    exit(1);
    24a6:	4505                	li	a0,1
    ...
    24b8:	3f450513          	addi	a0,a0,1012 # 68a8 <malloc+0xbfa>
    24bc:	00003097          	auipc	ra,0x3
    24c0:	734080e7          	jalr	1844(ra) # 5bf0 <printf>
    exit(1);
    24c4:	4505                	li	a0,1
    ...
    24d8:	3f450513          	addi	a0,a0,1012 # 68c8 <malloc+0xc1a>
    24dc:	00003097          	auipc	ra,0x3
    24e0:	714080e7          	jalr	1812(ra) # 5bf0 <printf>
    exit(1);
    24e4:	4505                	li	a0,1
    ...
    24f6:	3fe50513          	addi	a0,a0,1022 # 68f0 <malloc+0xc42>
    24fa:	00003097          	auipc	ra,0x3
    24fe:	6f6080e7          	jalr	1782(ra) # 5bf0 <printf>
    exit(1);
    2502:	4505                	li	a0,1
...
000000000000250c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2542:	8e250513          	addi	a0,a0,-1822 # 5e20 <malloc+0x172>
  ...
  if(n >= 0){
    ...
    2574:	8c850513          	addi	a0,a0,-1848 # 6e38 <malloc+0x118a>
    2578:	00003097          	auipc	ra,0x3
    257c:	678080e7          	jalr	1656(ra) # 5bf0 <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	85e50513          	addi	a0,a0,-1954 # 6de8 <malloc+0x113a>
    2592:	00003097          	auipc	ra,0x3
    2596:	65e080e7          	jalr	1630(ra) # 5bf0 <printf>
    exit(1);
    259a:	4505                	li	a0,1
    ...
    25a8:	85c50513          	addi	a0,a0,-1956 # 6e00 <malloc+0x1152>
    25ac:	00003097          	auipc	ra,0x3
    25b0:	644080e7          	jalr	1604(ra) # 5bf0 <printf>
    exit(1);
    25b4:	4505                	li	a0,1
    ...
    25c2:	86250513          	addi	a0,a0,-1950 # 6e20 <malloc+0x1172>
    25c6:	00003097          	auipc	ra,0x3
    25ca:	62a080e7          	jalr	1578(ra) # 5bf0 <printf>
    exit(1);
    25ce:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e6:	83e50513          	addi	a0,a0,-1986 # 5e20 <malloc+0x172>
    25ea:	00003097          	auipc	ra,0x3
    25ee:	2ce080e7          	jalr	718(ra) # 58b8 <unlink>
  fd = open("README", O_RDONLY);
    25f2:	4581                	li	a1,0
    25f4:	00004517          	auipc	a0,0x4
    25f8:	cd450513          	addi	a0,a0,-812 # 62c8 <malloc+0x61a>
  ...
  if(n >= 0){
    ...
    2622:	84a50513          	addi	a0,a0,-1974 # 6e68 <malloc+0x11ba>
    2626:	00003097          	auipc	ra,0x3
    262a:	5ca080e7          	jalr	1482(ra) # 5bf0 <printf>
    exit(1);
    262e:	4505                	li	a0,1
    ...
    263c:	7e850513          	addi	a0,a0,2024 # 6e20 <malloc+0x1172>
    2640:	00003097          	auipc	ra,0x3
    2644:	5b0080e7          	jalr	1456(ra) # 5bf0 <printf>
    exit(1);
    2648:	4505                	li	a0,1
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26be:	7d650513          	addi	a0,a0,2006 # 6e90 <malloc+0x11e2>
    26c2:	00003097          	auipc	ra,0x3
    26c6:	52e080e7          	jalr	1326(ra) # 5bf0 <printf>
    exit(1);
    26ca:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2712:	7a250513          	addi	a0,a0,1954 # 6eb0 <malloc+0x1202>
    2716:	00003097          	auipc	ra,0x3
    271a:	4da080e7          	jalr	1242(ra) # 5bf0 <printf>
    exit(1);
    271e:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2774:	7a050513          	addi	a0,a0,1952 # 6f10 <malloc+0x1262>
    2778:	00003097          	auipc	ra,0x3
    277c:	478080e7          	jalr	1144(ra) # 5bf0 <printf>
    exit(1);
    2780:	4505                	li	a0,1
    ...
    2796:	73e50513          	addi	a0,a0,1854 # 6ed0 <malloc+0x1222>
    279a:	00003097          	auipc	ra,0x3
    279e:	456080e7          	jalr	1110(ra) # 5bf0 <printf>
      exit(1);
    27a2:	4505                	li	a0,1
    ...
    27b2:	74250513          	addi	a0,a0,1858 # 6ef0 <malloc+0x1242>
    27b6:	00003097          	auipc	ra,0x3
    27ba:	43a080e7          	jalr	1082(ra) # 5bf0 <printf>
    exit(1);
    27be:	4505                	li	a0,1
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    28fc:	63850513          	addi	a0,a0,1592 # 6f30 <malloc+0x1282>
    2900:	00003097          	auipc	ra,0x3
    2904:	2f0080e7          	jalr	752(ra) # 5bf0 <printf>
    exit(1);
    2908:	4505                	li	a0,1
    ...
    2918:	66450513          	addi	a0,a0,1636 # 6f78 <malloc+0x12ca>
    291c:	00003097          	auipc	ra,0x3
    2920:	2d4080e7          	jalr	724(ra) # 5bf0 <printf>
    exit(1);
    2924:	4505                	li	a0,1
    ...
    2938:	66450513          	addi	a0,a0,1636 # 6f98 <malloc+0x12ea>
    293c:	00003097          	auipc	ra,0x3
    2940:	2b4080e7          	jalr	692(ra) # 5bf0 <printf>
    exit(1);
    2944:	4505                	li	a0,1
    ...
    2958:	68450513          	addi	a0,a0,1668 # 6fd8 <malloc+0x132a>
    295c:	00003097          	auipc	ra,0x3
    2960:	294080e7          	jalr	660(ra) # 5bf0 <printf>
    exit(1);
    2964:	4505                	li	a0,1
    ...
    2974:	69850513          	addi	a0,a0,1688 # 7008 <malloc+0x135a>
    2978:	00003097          	auipc	ra,0x3
    297c:	278080e7          	jalr	632(ra) # 5bf0 <printf>
    exit(1);
    2980:	4505                	li	a0,1
    ...
    2994:	6b050513          	addi	a0,a0,1712 # 7040 <malloc+0x1392>
    2998:	00003097          	auipc	ra,0x3
    299c:	258080e7          	jalr	600(ra) # 5bf0 <printf>
    exit(1);
    29a0:	4505                	li	a0,1
...
00000000000029aa <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29ce:	69e50513          	addi	a0,a0,1694 # 7068 <malloc+0x13ba>
    29d2:	00003097          	auipc	ra,0x3
    29d6:	ed6080e7          	jalr	-298(ra) # 58a8 <open>
    29da:	84aa                	mv	s1,a0
  unlink("sbrk");
    29dc:	00004517          	auipc	a0,0x4
    29e0:	68c50513          	addi	a0,a0,1676 # 7068 <malloc+0x13ba>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a34:	64050513          	addi	a0,a0,1600 # 7070 <malloc+0x13c2>
    2a38:	00003097          	auipc	ra,0x3
    2a3c:	1b8080e7          	jalr	440(ra) # 5bf0 <printf>
    exit(1);
    2a40:	4505                	li	a0,1
    ...
    2a50:	63c50513          	addi	a0,a0,1596 # 7088 <malloc+0x13da>
    2a54:	00003097          	auipc	ra,0x3
    2a58:	19c080e7          	jalr	412(ra) # 5bf0 <printf>
    exit(1);
    2a5c:	4505                	li	a0,1
    ...
    2a6c:	00850513          	addi	a0,a0,8 # 6a70 <malloc+0xdc2>
    2a70:	00003097          	auipc	ra,0x3
    2a74:	180080e7          	jalr	384(ra) # 5bf0 <printf>
    exit(1);
    2a78:	4505                	li	a0,1
...
0000000000002a82 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a96:	60e50513          	addi	a0,a0,1550 # 70a0 <malloc+0x13f2>
  ...
  close(fd);
    ...
    2ade:	ea650513          	addi	a0,a0,-346 # 6980 <malloc+0xcd2>
    2ae2:	00003097          	auipc	ra,0x3
    2ae6:	10e080e7          	jalr	270(ra) # 5bf0 <printf>
    exit(1);
    2aea:	4505                	li	a0,1
...
0000000000002af4 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b2c:	26050513          	addi	a0,a0,608 # 6d88 <malloc+0x10da>
    2b30:	00003097          	auipc	ra,0x3
    2b34:	0c0080e7          	jalr	192(ra) # 5bf0 <printf>
    exit(1);
    2b38:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b82:	20a50513          	addi	a0,a0,522 # 6d88 <malloc+0x10da>
    2b86:	00003097          	auipc	ra,0x3
    2b8a:	06a080e7          	jalr	106(ra) # 5bf0 <printf>
    exit(1);
    2b8e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2be2:	1aa50513          	addi	a0,a0,426 # 6d88 <malloc+0x10da>
    2be6:	00003097          	auipc	ra,0x3
    2bea:	00a080e7          	jalr	10(ra) # 5bf0 <printf>
    exit(1);
    2bee:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d56:	03650513          	addi	a0,a0,54 # 6d88 <malloc+0x10da>
    2d5a:	00003097          	auipc	ra,0x3
    2d5e:	e96080e7          	jalr	-362(ra) # 5bf0 <printf>
      exit(1);
    2d62:	4505                	li	a0,1
    ...
    2daa:	38a50513          	addi	a0,a0,906 # 6130 <malloc+0x482>
    2dae:	faa43c23          	sd	a0,-72(s0)
    2db2:	00003797          	auipc	a5,0x3
    2db6:	3ee78793          	addi	a5,a5,1006 # 61a0 <malloc+0x4f2>
...
0000000000002dd8 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de8:	49450513          	addi	a0,a0,1172 # 7278 <malloc+0x15ca>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2dfa:	2da50513          	addi	a0,a0,730 # 70d0 <malloc+0x1422>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e10:	31c50513          	addi	a0,a0,796 # 7128 <malloc+0x147a>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e2e:	37650513          	addi	a0,a0,886 # 71a0 <malloc+0x14f2>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e4a:	3ca50513          	addi	a0,a0,970 # 7210 <malloc+0x1562>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5c:	41050513          	addi	a0,a0,1040 # 7268 <malloc+0x15ba>
  ...
  unlink("12345678901234");
    ...
    2eda:	1d250513          	addi	a0,a0,466 # 70a8 <malloc+0x13fa>
    2ede:	00003097          	auipc	ra,0x3
    2ee2:	d12080e7          	jalr	-750(ra) # 5bf0 <printf>
    exit(1);
    2ee6:	4505                	li	a0,1
    ...
    2ef6:	1fe50513          	addi	a0,a0,510 # 70f0 <malloc+0x1442>
    2efa:	00003097          	auipc	ra,0x3
    2efe:	cf6080e7          	jalr	-778(ra) # 5bf0 <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f12:	24a50513          	addi	a0,a0,586 # 7158 <malloc+0x14aa>
    2f16:	00003097          	auipc	ra,0x3
    2f1a:	cda080e7          	jalr	-806(ra) # 5bf0 <printf>
    exit(1);
    2f1e:	4505                	li	a0,1
    ...
    2f2e:	2a650513          	addi	a0,a0,678 # 71d0 <malloc+0x1522>
    2f32:	00003097          	auipc	ra,0x3
    2f36:	cbe080e7          	jalr	-834(ra) # 5bf0 <printf>
    exit(1);
    2f3a:	4505                	li	a0,1
    ...
    2f4a:	2ea50513          	addi	a0,a0,746 # 7230 <malloc+0x1582>
    2f4e:	00003097          	auipc	ra,0x3
    2f52:	ca2080e7          	jalr	-862(ra) # 5bf0 <printf>
    exit(1);
    2f56:	4505                	li	a0,1
    ...
    2f66:	32650513          	addi	a0,a0,806 # 7288 <malloc+0x15da>
    2f6a:	00003097          	auipc	ra,0x3
    2f6e:	c86080e7          	jalr	-890(ra) # 5bf0 <printf>
    exit(1);
    2f72:	4505                	li	a0,1
...
0000000000002f7c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8c:	33850513          	addi	a0,a0,824 # 72c0 <malloc+0x1612>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa0:	32450513          	addi	a0,a0,804 # 72c0 <malloc+0x1612>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb4:	35050513          	addi	a0,a0,848 # 7300 <malloc+0x1652>
  ...
  if(chdir("/") < 0){
    ...
    2fc8:	36c50513          	addi	a0,a0,876 # 7330 <malloc+0x1682>
    ...
    2fe8:	2e450513          	addi	a0,a0,740 # 72c8 <malloc+0x161a>
    2fec:	00003097          	auipc	ra,0x3
    2ff0:	c04080e7          	jalr	-1020(ra) # 5bf0 <printf>
    exit(1);
    2ff4:	4505                	li	a0,1
    ...
    3004:	2e050513          	addi	a0,a0,736 # 72e0 <malloc+0x1632>
    3008:	00003097          	auipc	ra,0x3
    300c:	be8080e7          	jalr	-1048(ra) # 5bf0 <printf>
    exit(1);
    3010:	4505                	li	a0,1
    ...
    3020:	2f450513          	addi	a0,a0,756 # 7310 <malloc+0x1662>
    3024:	00003097          	auipc	ra,0x3
    3028:	bcc080e7          	jalr	-1076(ra) # 5bf0 <printf>
    exit(1);
    302c:	4505                	li	a0,1
    ...
    303c:	30050513          	addi	a0,a0,768 # 7338 <malloc+0x168a>
    3040:	00003097          	auipc	ra,0x3
    3044:	bb0080e7          	jalr	-1104(ra) # 5bf0 <printf>
    exit(1);
    3048:	4505                	li	a0,1
...
0000000000003052 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3070:	25450513          	addi	a0,a0,596 # 72c0 <malloc+0x1612>
    ...
    3084:	24050513          	addi	a0,a0,576 # 72c0 <malloc+0x1612>
    ...
    3098:	26c50513          	addi	a0,a0,620 # 7300 <malloc+0x1652>
    ...
    30b8:	8b450513          	addi	a0,a0,-1868 # 6968 <malloc+0xcba>
    30bc:	00003097          	auipc	ra,0x3
    30c0:	b34080e7          	jalr	-1228(ra) # 5bf0 <printf>
    exit(1);
    30c4:	4505                	li	a0,1
    ...
    30d4:	1f850513          	addi	a0,a0,504 # 72c8 <malloc+0x161a>
    30d8:	00003097          	auipc	ra,0x3
    30dc:	b18080e7          	jalr	-1256(ra) # 5bf0 <printf>
      exit(1);
    30e0:	4505                	li	a0,1
    ...
    30f0:	26450513          	addi	a0,a0,612 # 7350 <malloc+0x16a2>
    30f4:	00003097          	auipc	ra,0x3
    30f8:	afc080e7          	jalr	-1284(ra) # 5bf0 <printf>
      exit(1);
    30fc:	4505                	li	a0,1
    ...
    310c:	20850513          	addi	a0,a0,520 # 7310 <malloc+0x1662>
    3110:	00003097          	auipc	ra,0x3
    3114:	ae0080e7          	jalr	-1312(ra) # 5bf0 <printf>
      exit(1);
    3118:	4505                	li	a0,1
...
000000000000313a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    314a:	22250513          	addi	a0,a0,546 # 7368 <malloc+0x16ba>
  ...
  if(chdir("dir0") < 0){
    ...
    315e:	20e50513          	addi	a0,a0,526 # 7368 <malloc+0x16ba>
  ...
  if(chdir("..") < 0){
    ...
    3172:	21a50513          	addi	a0,a0,538 # 7388 <malloc+0x16da>
  ...
  if(unlink("dir0") < 0){
    ...
    3186:	1e650513          	addi	a0,a0,486 # 7368 <malloc+0x16ba>
    ...
    31a6:	12650513          	addi	a0,a0,294 # 72c8 <malloc+0x161a>
    31aa:	00003097          	auipc	ra,0x3
    31ae:	a46080e7          	jalr	-1466(ra) # 5bf0 <printf>
    exit(1);
    31b2:	4505                	li	a0,1
    ...
    31c2:	1b250513          	addi	a0,a0,434 # 7370 <malloc+0x16c2>
    31c6:	00003097          	auipc	ra,0x3
    31ca:	a2a080e7          	jalr	-1494(ra) # 5bf0 <printf>
    exit(1);
    31ce:	4505                	li	a0,1
    ...
    31de:	1b650513          	addi	a0,a0,438 # 7390 <malloc+0x16e2>
    31e2:	00003097          	auipc	ra,0x3
    31e6:	a0e080e7          	jalr	-1522(ra) # 5bf0 <printf>
    exit(1);
    31ea:	4505                	li	a0,1
    ...
    31fa:	1b250513          	addi	a0,a0,434 # 73a8 <malloc+0x16fa>
    31fe:	00003097          	auipc	ra,0x3
    3202:	9f2080e7          	jalr	-1550(ra) # 5bf0 <printf>
    exit(1);
    3206:	4505                	li	a0,1
...
0000000000003210 <subdir>:
{
  ...
  unlink("ff");
    ...
    3222:	2d250513          	addi	a0,a0,722 # 74f0 <malloc+0x1842>
    3226:	00002097          	auipc	ra,0x2
    322a:	692080e7          	jalr	1682(ra) # 58b8 <unlink>
  if(mkdir("dd") != 0){
    322e:	00004517          	auipc	a0,0x4
    3232:	19250513          	addi	a0,a0,402 # 73c0 <malloc+0x1712>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    324a:	19a50513          	addi	a0,a0,410 # 73e0 <malloc+0x1732>
  ...
  write(fd, "ff", 2);
    ...
    3262:	29258593          	addi	a1,a1,658 # 74f0 <malloc+0x1842>
  ...
  if(unlink("dd") >= 0){
    ...
    327c:	14850513          	addi	a0,a0,328 # 73c0 <malloc+0x1712>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3290:	1ac50513          	addi	a0,a0,428 # 7438 <malloc+0x178a>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a8:	1bc50513          	addi	a0,a0,444 # 7460 <malloc+0x17b2>
  ...
  write(fd, "FF", 2);
    ...
    32c0:	1d458593          	addi	a1,a1,468 # 7490 <malloc+0x17e2>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32dc:	1c050513          	addi	a0,a0,448 # 7498 <malloc+0x17ea>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3324:	1c858593          	addi	a1,a1,456 # 74e8 <malloc+0x183a>
    3328:	00004517          	auipc	a0,0x4
    332c:	13850513          	addi	a0,a0,312 # 7460 <malloc+0x17b2>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3340:	12450513          	addi	a0,a0,292 # 7460 <malloc+0x17b2>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3356:	10e50513          	addi	a0,a0,270 # 7460 <malloc+0x17b2>
  ...
  if(chdir("dd") != 0){
    ...
    336a:	05a50513          	addi	a0,a0,90 # 73c0 <malloc+0x1712>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337e:	20650513          	addi	a0,a0,518 # 7580 <malloc+0x18d2>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3392:	22250513          	addi	a0,a0,546 # 75b0 <malloc+0x1902>
  ...
  if(chdir("./..") != 0){
    ...
    33a6:	23e50513          	addi	a0,a0,574 # 75e0 <malloc+0x1932>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33bc:	13050513          	addi	a0,a0,304 # 74e8 <malloc+0x183a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33f6:	06e50513          	addi	a0,a0,110 # 7460 <malloc+0x17b2>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340e:	26650513          	addi	a0,a0,614 # 7670 <malloc+0x19c2>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3426:	27e50513          	addi	a0,a0,638 # 76a0 <malloc+0x19f2>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343e:	f8650513          	addi	a0,a0,-122 # 73c0 <malloc+0x1712>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3454:	f7050513          	addi	a0,a0,-144 # 73c0 <malloc+0x1712>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    346a:	f5a50513          	addi	a0,a0,-166 # 73c0 <malloc+0x1712>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    347e:	2b658593          	addi	a1,a1,694 # 7730 <malloc+0x1a82>
    3482:	00004517          	auipc	a0,0x4
    3486:	1ee50513          	addi	a0,a0,494 # 7670 <malloc+0x19c2>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    349a:	29a58593          	addi	a1,a1,666 # 7730 <malloc+0x1a82>
    349e:	00004517          	auipc	a0,0x4
    34a2:	20250513          	addi	a0,a0,514 # 76a0 <malloc+0x19f2>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34b6:	03658593          	addi	a1,a1,54 # 74e8 <malloc+0x183a>
    34ba:	00004517          	auipc	a0,0x4
    34be:	f2650513          	addi	a0,a0,-218 # 73e0 <malloc+0x1732>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d2:	1a250513          	addi	a0,a0,418 # 7670 <malloc+0x19c2>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e6:	1be50513          	addi	a0,a0,446 # 76a0 <malloc+0x19f2>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34fa:	ff250513          	addi	a0,a0,-14 # 74e8 <malloc+0x183a>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350e:	19650513          	addi	a0,a0,406 # 76a0 <malloc+0x19f2>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3522:	15250513          	addi	a0,a0,338 # 7670 <malloc+0x19c2>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3536:	eae50513          	addi	a0,a0,-338 # 73e0 <malloc+0x1732>
  ...
  if(chdir("dd/xx") == 0){
    ...
    354a:	33a50513          	addi	a0,a0,826 # 7880 <malloc+0x1bd2>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355e:	f8e50513          	addi	a0,a0,-114 # 74e8 <malloc+0x183a>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3572:	e7250513          	addi	a0,a0,-398 # 73e0 <malloc+0x1732>
  ...
  if(unlink("dd") == 0){
    ...
    3586:	e3e50513          	addi	a0,a0,-450 # 73c0 <malloc+0x1712>
  ...
  if(unlink("dd/dd") < 0){
    ...
    359a:	35a50513          	addi	a0,a0,858 # 78f0 <malloc+0x1c42>
  ...
  if(unlink("dd") < 0){
    ...
    35ae:	e1650513          	addi	a0,a0,-490 # 73c0 <malloc+0x1712>
    ...
    35d0:	dfc50513          	addi	a0,a0,-516 # 73c8 <malloc+0x171a>
    35d4:	00002097          	auipc	ra,0x2
    35d8:	61c080e7          	jalr	1564(ra) # 5bf0 <printf>
    exit(1);
    35dc:	4505                	li	a0,1
    ...
    35ec:	e0050513          	addi	a0,a0,-512 # 73e8 <malloc+0x173a>
    35f0:	00002097          	auipc	ra,0x2
    35f4:	600080e7          	jalr	1536(ra) # 5bf0 <printf>
    exit(1);
    35f8:	4505                	li	a0,1
    ...
    3608:	e0450513          	addi	a0,a0,-508 # 7408 <malloc+0x175a>
    360c:	00002097          	auipc	ra,0x2
    3610:	5e4080e7          	jalr	1508(ra) # 5bf0 <printf>
    exit(1);
    3614:	4505                	li	a0,1
    ...
    3624:	e2050513          	addi	a0,a0,-480 # 7440 <malloc+0x1792>
    3628:	00002097          	auipc	ra,0x2
    362c:	5c8080e7          	jalr	1480(ra) # 5bf0 <printf>
    exit(1);
    3630:	4505                	li	a0,1
    ...
    3640:	e3450513          	addi	a0,a0,-460 # 7470 <malloc+0x17c2>
    3644:	00002097          	auipc	ra,0x2
    3648:	5ac080e7          	jalr	1452(ra) # 5bf0 <printf>
    exit(1);
    364c:	4505                	li	a0,1
    ...
    365c:	e5050513          	addi	a0,a0,-432 # 74a8 <malloc+0x17fa>
    3660:	00002097          	auipc	ra,0x2
    3664:	590080e7          	jalr	1424(ra) # 5bf0 <printf>
    exit(1);
    3668:	4505                	li	a0,1
    ...
    3678:	e5450513          	addi	a0,a0,-428 # 74c8 <malloc+0x181a>
    367c:	00002097          	auipc	ra,0x2
    3680:	574080e7          	jalr	1396(ra) # 5bf0 <printf>
    exit(1);
    3684:	4505                	li	a0,1
    ...
    3694:	e6850513          	addi	a0,a0,-408 # 74f8 <malloc+0x184a>
    3698:	00002097          	auipc	ra,0x2
    369c:	558080e7          	jalr	1368(ra) # 5bf0 <printf>
    exit(1);
    36a0:	4505                	li	a0,1
    ...
    36b0:	e7450513          	addi	a0,a0,-396 # 7520 <malloc+0x1872>
    36b4:	00002097          	auipc	ra,0x2
    36b8:	53c080e7          	jalr	1340(ra) # 5bf0 <printf>
    exit(1);
    36bc:	4505                	li	a0,1
    ...
    36cc:	e7850513          	addi	a0,a0,-392 # 7540 <malloc+0x1892>
    36d0:	00002097          	auipc	ra,0x2
    36d4:	520080e7          	jalr	1312(ra) # 5bf0 <printf>
    exit(1);
    36d8:	4505                	li	a0,1
    ...
    36e8:	e8450513          	addi	a0,a0,-380 # 7568 <malloc+0x18ba>
    36ec:	00002097          	auipc	ra,0x2
    36f0:	504080e7          	jalr	1284(ra) # 5bf0 <printf>
    exit(1);
    36f4:	4505                	li	a0,1
    ...
    3704:	e9050513          	addi	a0,a0,-368 # 7590 <malloc+0x18e2>
    3708:	00002097          	auipc	ra,0x2
    370c:	4e8080e7          	jalr	1256(ra) # 5bf0 <printf>
    exit(1);
    3710:	4505                	li	a0,1
    ...
    3720:	ea450513          	addi	a0,a0,-348 # 75c0 <malloc+0x1912>
    3724:	00002097          	auipc	ra,0x2
    3728:	4cc080e7          	jalr	1228(ra) # 5bf0 <printf>
    exit(1);
    372c:	4505                	li	a0,1
    ...
    373c:	eb050513          	addi	a0,a0,-336 # 75e8 <malloc+0x193a>
    3740:	00002097          	auipc	ra,0x2
    3744:	4b0080e7          	jalr	1200(ra) # 5bf0 <printf>
    exit(1);
    3748:	4505                	li	a0,1
    ...
    3758:	eac50513          	addi	a0,a0,-340 # 7600 <malloc+0x1952>
    375c:	00002097          	auipc	ra,0x2
    3760:	494080e7          	jalr	1172(ra) # 5bf0 <printf>
    exit(1);
    3764:	4505                	li	a0,1
    ...
    3774:	eb050513          	addi	a0,a0,-336 # 7620 <malloc+0x1972>
    3778:	00002097          	auipc	ra,0x2
    377c:	478080e7          	jalr	1144(ra) # 5bf0 <printf>
    exit(1);
    3780:	4505                	li	a0,1
    ...
    3790:	eb450513          	addi	a0,a0,-332 # 7640 <malloc+0x1992>
    3794:	00002097          	auipc	ra,0x2
    3798:	45c080e7          	jalr	1116(ra) # 5bf0 <printf>
    exit(1);
    379c:	4505                	li	a0,1
    ...
    37ac:	ed850513          	addi	a0,a0,-296 # 7680 <malloc+0x19d2>
    37b0:	00002097          	auipc	ra,0x2
    37b4:	440080e7          	jalr	1088(ra) # 5bf0 <printf>
    exit(1);
    37b8:	4505                	li	a0,1
    ...
    37c8:	eec50513          	addi	a0,a0,-276 # 76b0 <malloc+0x1a02>
    37cc:	00002097          	auipc	ra,0x2
    37d0:	424080e7          	jalr	1060(ra) # 5bf0 <printf>
    exit(1);
    37d4:	4505                	li	a0,1
    ...
    37e4:	ef050513          	addi	a0,a0,-272 # 76d0 <malloc+0x1a22>
    37e8:	00002097          	auipc	ra,0x2
    37ec:	408080e7          	jalr	1032(ra) # 5bf0 <printf>
    exit(1);
    37f0:	4505                	li	a0,1
    ...
    3800:	ef450513          	addi	a0,a0,-268 # 76f0 <malloc+0x1a42>
    3804:	00002097          	auipc	ra,0x2
    3808:	3ec080e7          	jalr	1004(ra) # 5bf0 <printf>
    exit(1);
    380c:	4505                	li	a0,1
    ...
    381c:	ef850513          	addi	a0,a0,-264 # 7710 <malloc+0x1a62>
    3820:	00002097          	auipc	ra,0x2
    3824:	3d0080e7          	jalr	976(ra) # 5bf0 <printf>
    exit(1);
    3828:	4505                	li	a0,1
    ...
    3838:	f0c50513          	addi	a0,a0,-244 # 7740 <malloc+0x1a92>
    383c:	00002097          	auipc	ra,0x2
    3840:	3b4080e7          	jalr	948(ra) # 5bf0 <printf>
    exit(1);
    3844:	4505                	li	a0,1
    ...
    3854:	f1850513          	addi	a0,a0,-232 # 7768 <malloc+0x1aba>
    3858:	00002097          	auipc	ra,0x2
    385c:	398080e7          	jalr	920(ra) # 5bf0 <printf>
    exit(1);
    3860:	4505                	li	a0,1
    ...
    3870:	f2450513          	addi	a0,a0,-220 # 7790 <malloc+0x1ae2>
    3874:	00002097          	auipc	ra,0x2
    3878:	37c080e7          	jalr	892(ra) # 5bf0 <printf>
    exit(1);
    387c:	4505                	li	a0,1
    ...
    388c:	f3050513          	addi	a0,a0,-208 # 77b8 <malloc+0x1b0a>
    3890:	00002097          	auipc	ra,0x2
    3894:	360080e7          	jalr	864(ra) # 5bf0 <printf>
    exit(1);
    3898:	4505                	li	a0,1
    ...
    38a8:	f3450513          	addi	a0,a0,-204 # 77d8 <malloc+0x1b2a>
    38ac:	00002097          	auipc	ra,0x2
    38b0:	344080e7          	jalr	836(ra) # 5bf0 <printf>
    exit(1);
    38b4:	4505                	li	a0,1
    ...
    38c4:	f3850513          	addi	a0,a0,-200 # 77f8 <malloc+0x1b4a>
    38c8:	00002097          	auipc	ra,0x2
    38cc:	328080e7          	jalr	808(ra) # 5bf0 <printf>
    exit(1);
    38d0:	4505                	li	a0,1
    ...
    38e0:	f4450513          	addi	a0,a0,-188 # 7820 <malloc+0x1b72>
    38e4:	00002097          	auipc	ra,0x2
    38e8:	30c080e7          	jalr	780(ra) # 5bf0 <printf>
    exit(1);
    38ec:	4505                	li	a0,1
    ...
    38fc:	f4850513          	addi	a0,a0,-184 # 7840 <malloc+0x1b92>
    3900:	00002097          	auipc	ra,0x2
    3904:	2f0080e7          	jalr	752(ra) # 5bf0 <printf>
    exit(1);
    3908:	4505                	li	a0,1
    ...
    3918:	f4c50513          	addi	a0,a0,-180 # 7860 <malloc+0x1bb2>
    391c:	00002097          	auipc	ra,0x2
    3920:	2d4080e7          	jalr	724(ra) # 5bf0 <printf>
    exit(1);
    3924:	4505                	li	a0,1
    ...
    3934:	f5850513          	addi	a0,a0,-168 # 7888 <malloc+0x1bda>
    3938:	00002097          	auipc	ra,0x2
    393c:	2b8080e7          	jalr	696(ra) # 5bf0 <printf>
    exit(1);
    3940:	4505                	li	a0,1
    ...
    3950:	bd450513          	addi	a0,a0,-1068 # 7520 <malloc+0x1872>
    3954:	00002097          	auipc	ra,0x2
    3958:	29c080e7          	jalr	668(ra) # 5bf0 <printf>
    exit(1);
    395c:	4505                	li	a0,1
    ...
    396c:	f4050513          	addi	a0,a0,-192 # 78a8 <malloc+0x1bfa>
    3970:	00002097          	auipc	ra,0x2
    3974:	280080e7          	jalr	640(ra) # 5bf0 <printf>
    exit(1);
    3978:	4505                	li	a0,1
    ...
    3988:	f4450513          	addi	a0,a0,-188 # 78c8 <malloc+0x1c1a>
    398c:	00002097          	auipc	ra,0x2
    3990:	264080e7          	jalr	612(ra) # 5bf0 <printf>
    exit(1);
    3994:	4505                	li	a0,1
    ...
    39a4:	f5850513          	addi	a0,a0,-168 # 78f8 <malloc+0x1c4a>
    39a8:	00002097          	auipc	ra,0x2
    39ac:	248080e7          	jalr	584(ra) # 5bf0 <printf>
    exit(1);
    39b0:	4505                	li	a0,1
    ...
    39c0:	f5c50513          	addi	a0,a0,-164 # 7918 <malloc+0x1c6a>
    39c4:	00002097          	auipc	ra,0x2
    39c8:	22c080e7          	jalr	556(ra) # 5bf0 <printf>
    exit(1);
    39cc:	4505                	li	a0,1
...
00000000000039d6 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e6:	f4e50513          	addi	a0,a0,-178 # 7930 <malloc+0x1c82>
  ...
  if(chdir("dots") != 0){
    ...
    39f8:	f3c50513          	addi	a0,a0,-196 # 7930 <malloc+0x1c82>
  ...
  if(unlink(".") == 0){
    ...
    3a0a:	dc250513          	addi	a0,a0,-574 # 67c8 <malloc+0xb1a>
  ...
  if(unlink("..") == 0){
    ...
    3a1c:	97050513          	addi	a0,a0,-1680 # 7388 <malloc+0x16da>
  ...
  if(chdir("/") != 0){
    ...
    3a2e:	90650513          	addi	a0,a0,-1786 # 7330 <malloc+0x1682>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a40:	f5c50513          	addi	a0,a0,-164 # 7998 <malloc+0x1cea>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a52:	f7250513          	addi	a0,a0,-142 # 79c0 <malloc+0x1d12>
  ...
  if(unlink("dots") != 0){
    ...
    3a64:	ed050513          	addi	a0,a0,-304 # 7930 <malloc+0x1c82>
    ...
    3a82:	eba50513          	addi	a0,a0,-326 # 7938 <malloc+0x1c8a>
    3a86:	00002097          	auipc	ra,0x2
    3a8a:	16a080e7          	jalr	362(ra) # 5bf0 <printf>
    exit(1);
    3a8e:	4505                	li	a0,1
    ...
    3a9e:	eb650513          	addi	a0,a0,-330 # 7950 <malloc+0x1ca2>
    3aa2:	00002097          	auipc	ra,0x2
    3aa6:	14e080e7          	jalr	334(ra) # 5bf0 <printf>
    exit(1);
    3aaa:	4505                	li	a0,1
    ...
    3aba:	eb250513          	addi	a0,a0,-334 # 7968 <malloc+0x1cba>
    3abe:	00002097          	auipc	ra,0x2
    3ac2:	132080e7          	jalr	306(ra) # 5bf0 <printf>
    exit(1);
    3ac6:	4505                	li	a0,1
    ...
    3ad6:	eae50513          	addi	a0,a0,-338 # 7980 <malloc+0x1cd2>
    3ada:	00002097          	auipc	ra,0x2
    3ade:	116080e7          	jalr	278(ra) # 5bf0 <printf>
    exit(1);
    3ae2:	4505                	li	a0,1
    ...
    3af2:	84a50513          	addi	a0,a0,-1974 # 7338 <malloc+0x168a>
    3af6:	00002097          	auipc	ra,0x2
    3afa:	0fa080e7          	jalr	250(ra) # 5bf0 <printf>
    exit(1);
    3afe:	4505                	li	a0,1
    ...
    3b0e:	e9650513          	addi	a0,a0,-362 # 79a0 <malloc+0x1cf2>
    3b12:	00002097          	auipc	ra,0x2
    3b16:	0de080e7          	jalr	222(ra) # 5bf0 <printf>
    exit(1);
    3b1a:	4505                	li	a0,1
    ...
    3b2a:	ea250513          	addi	a0,a0,-350 # 79c8 <malloc+0x1d1a>
    3b2e:	00002097          	auipc	ra,0x2
    3b32:	0c2080e7          	jalr	194(ra) # 5bf0 <printf>
    exit(1);
    3b36:	4505                	li	a0,1
    ...
    3b46:	ea650513          	addi	a0,a0,-346 # 79e8 <malloc+0x1d3a>
    3b4a:	00002097          	auipc	ra,0x2
    3b4e:	0a6080e7          	jalr	166(ra) # 5bf0 <printf>
    exit(1);
    3b52:	4505                	li	a0,1
...
0000000000003b5c <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b72:	56250513          	addi	a0,a0,1378 # 60d0 <malloc+0x422>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b8e:	54650513          	addi	a0,a0,1350 # 60d0 <malloc+0x422>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba2:	eaa50513          	addi	a0,a0,-342 # 7a48 <malloc+0x1d9a>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bba:	e9250513          	addi	a0,a0,-366 # 7a48 <malloc+0x1d9a>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bce:	e7e50513          	addi	a0,a0,-386 # 7a48 <malloc+0x1d9a>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be2:	e6a50513          	addi	a0,a0,-406 # 7a48 <malloc+0x1d9a>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bf6:	e5658593          	addi	a1,a1,-426 # 7a48 <malloc+0x1d9a>
    3bfa:	00002517          	auipc	a0,0x2
    3bfe:	6ce50513          	addi	a0,a0,1742 # 62c8 <malloc+0x61a>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c12:	4c250513          	addi	a0,a0,1218 # 60d0 <malloc+0x422>
  ...
  fd = open(".", O_RDWR);
    ...
    3c28:	ba450513          	addi	a0,a0,-1116 # 67c8 <malloc+0xb1a>
  ...
  fd = open(".", 0);
    ...
    3c3e:	b8e50513          	addi	a0,a0,-1138 # 67c8 <malloc+0xb1a>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c52:	55258593          	addi	a1,a1,1362 # 61a0 <malloc+0x4f2>
  ...
  close(fd);
    ...
    3c7e:	d8e50513          	addi	a0,a0,-626 # 7a08 <malloc+0x1d5a>
    3c82:	00002097          	auipc	ra,0x2
    3c86:	f6e080e7          	jalr	-146(ra) # 5bf0 <printf>
    exit(1);
    3c8a:	4505                	li	a0,1
    ...
    3c9a:	d9250513          	addi	a0,a0,-622 # 7a28 <malloc+0x1d7a>
    3c9e:	00002097          	auipc	ra,0x2
    3ca2:	f52080e7          	jalr	-174(ra) # 5bf0 <printf>
    exit(1);
    3ca6:	4505                	li	a0,1
    ...
    3cb6:	da650513          	addi	a0,a0,-602 # 7a58 <malloc+0x1daa>
    3cba:	00002097          	auipc	ra,0x2
    3cbe:	f36080e7          	jalr	-202(ra) # 5bf0 <printf>
    exit(1);
    3cc2:	4505                	li	a0,1
    ...
    3cd2:	d8a50513          	addi	a0,a0,-630 # 7a58 <malloc+0x1daa>
    3cd6:	00002097          	auipc	ra,0x2
    3cda:	f1a080e7          	jalr	-230(ra) # 5bf0 <printf>
    exit(1);
    3cde:	4505                	li	a0,1
    ...
    3cee:	d9650513          	addi	a0,a0,-618 # 7a80 <malloc+0x1dd2>
    3cf2:	00002097          	auipc	ra,0x2
    3cf6:	efe080e7          	jalr	-258(ra) # 5bf0 <printf>
    exit(1);
    3cfa:	4505                	li	a0,1
    ...
    3d0a:	da250513          	addi	a0,a0,-606 # 7aa8 <malloc+0x1dfa>
    3d0e:	00002097          	auipc	ra,0x2
    3d12:	ee2080e7          	jalr	-286(ra) # 5bf0 <printf>
    exit(1);
    3d16:	4505                	li	a0,1
    ...
    3d26:	dae50513          	addi	a0,a0,-594 # 7ad0 <malloc+0x1e22>
    3d2a:	00002097          	auipc	ra,0x2
    3d2e:	ec6080e7          	jalr	-314(ra) # 5bf0 <printf>
    exit(1);
    3d32:	4505                	li	a0,1
    ...
    3d42:	dba50513          	addi	a0,a0,-582 # 7af8 <malloc+0x1e4a>
    3d46:	00002097          	auipc	ra,0x2
    3d4a:	eaa080e7          	jalr	-342(ra) # 5bf0 <printf>
    exit(1);
    3d4e:	4505                	li	a0,1
    ...
    3d5e:	dbe50513          	addi	a0,a0,-578 # 7b18 <malloc+0x1e6a>
    3d62:	00002097          	auipc	ra,0x2
    3d66:	e8e080e7          	jalr	-370(ra) # 5bf0 <printf>
    exit(1);
    3d6a:	4505                	li	a0,1
    ...
    3d7a:	dca50513          	addi	a0,a0,-566 # 7b40 <malloc+0x1e92>
    3d7e:	00002097          	auipc	ra,0x2
    3d82:	e72080e7          	jalr	-398(ra) # 5bf0 <printf>
    exit(1);
    3d86:	4505                	li	a0,1
...
0000000000003d90 <iref>:
{
    ...
    3dae:	daea0a13          	addi	s4,s4,-594 # 7b58 <malloc+0x1eaa>
    mkdir("");
    3db2:	00004497          	auipc	s1,0x4
    3db6:	8b648493          	addi	s1,s1,-1866 # 7668 <malloc+0x19ba>
    link("README", "");
    3dba:	00002a97          	auipc	s5,0x2
    3dbe:	50ea8a93          	addi	s5,s5,1294 # 62c8 <malloc+0x61a>
    fd = open("xx", O_CREATE);
    3dc2:	00004997          	auipc	s3,0x4
    3dc6:	c8e98993          	addi	s3,s3,-882 # 7a50 <malloc+0x1da2>
    3dca:	a891                	j	3e1e <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dcc:	85da                	mv	a1,s6
    3dce:	00004517          	auipc	a0,0x4
    3dd2:	d9250513          	addi	a0,a0,-622 # 7b60 <malloc+0x1eb2>
    3dd6:	00002097          	auipc	ra,0x2
    3dda:	e1a080e7          	jalr	-486(ra) # 5bf0 <printf>
      exit(1);
    3dde:	4505                	li	a0,1
    ...
    3dee:	d8e50513          	addi	a0,a0,-626 # 7b78 <malloc+0x1eca>
    3df2:	00002097          	auipc	ra,0x2
    3df6:	dfe080e7          	jalr	-514(ra) # 5bf0 <printf>
      exit(1);
    3dfa:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e82:	50a98993          	addi	s3,s3,1290 # 7388 <malloc+0x16da>
    unlink("irefd");
    3e86:	00004917          	auipc	s2,0x4
    3e8a:	cd290913          	addi	s2,s2,-814 # 7b58 <malloc+0x1eaa>
    chdir("..");
    3e8e:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3eaa:	48a50513          	addi	a0,a0,1162 # 7330 <malloc+0x1682>
...
0000000000003eca <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3eda:	cba50513          	addi	a0,a0,-838 # 7b90 <malloc+0x1ee2>
  ...
  if(pid == 0){
    ...
    3efe:	c9650513          	addi	a0,a0,-874 # 7b90 <malloc+0x1ee2>
    ...
    3f14:	ca050513          	addi	a0,a0,-864 # 7bb0 <malloc+0x1f02>
    3f18:	00002097          	auipc	ra,0x2
    3f1c:	cd8080e7          	jalr	-808(ra) # 5bf0 <printf>
      exit(1);
    3f20:	4505                	li	a0,1
    ...
    3f30:	c6c50513          	addi	a0,a0,-916 # 7b98 <malloc+0x1eea>
    3f34:	00002097          	auipc	ra,0x2
    3f38:	cbc080e7          	jalr	-836(ra) # 5bf0 <printf>
    exit(1);
    3f3c:	4505                	li	a0,1
    ...
    3f4c:	a2050513          	addi	a0,a0,-1504 # 6968 <malloc+0xcba>
    3f50:	00002097          	auipc	ra,0x2
    3f54:	ca0080e7          	jalr	-864(ra) # 5bf0 <printf>
    exit(1);
    3f58:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f7a:	c1a50513          	addi	a0,a0,-998 # 7b90 <malloc+0x1ee2>
    ...
    3f8e:	bce50513          	addi	a0,a0,-1074 # 6b58 <malloc+0xeaa>
    3f92:	00002097          	auipc	ra,0x2
    3f96:	c5e080e7          	jalr	-930(ra) # 5bf0 <printf>
    exit(1);
    3f9a:	4505                	li	a0,1
...
0000000000003fbc <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fcc:	c1050513          	addi	a0,a0,-1008 # 7bd8 <malloc+0x1f2a>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff8:	be450513          	addi	a0,a0,-1052 # 7bd8 <malloc+0x1f2a>
  ...
  sleep(10); // one second
    ...
    4030:	afc50513          	addi	a0,a0,-1284 # 6b28 <malloc+0xe7a>
    4034:	00002097          	auipc	ra,0x2
    4038:	bbc080e7          	jalr	-1092(ra) # 5bf0 <printf>
    exit(1);
    403c:	4505                	li	a0,1
    ...
    404a:	b9248493          	addi	s1,s1,-1134 # 7bd8 <malloc+0x1f2a>
    404e:	4581                	li	a1,0
    4050:	8526                	mv	a0,s1
...
000000000000408c <killstatus>:
{
  ...
  exit(0);
    ...
    40f2:	87a50513          	addi	a0,a0,-1926 # 6968 <malloc+0xcba>
    40f6:	00002097          	auipc	ra,0x2
    40fa:	afa080e7          	jalr	-1286(ra) # 5bf0 <printf>
      exit(1);
    40fe:	4505                	li	a0,1
    ...
    4118:	ad450513          	addi	a0,a0,-1324 # 7be8 <malloc+0x1f3a>
    411c:	00002097          	auipc	ra,0x2
    4120:	ad4080e7          	jalr	-1324(ra) # 5bf0 <printf>
       exit(1);
    4124:	4505                	li	a0,1
...
000000000000412e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4158:	9d450513          	addi	a0,a0,-1580 # 6b28 <malloc+0xe7a>
    415c:	00002097          	auipc	ra,0x2
    4160:	a94080e7          	jalr	-1388(ra) # 5bf0 <printf>
    exit(1);
    4164:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4186:	7e650513          	addi	a0,a0,2022 # 6968 <malloc+0xcba>
    418a:	00002097          	auipc	ra,0x2
    418e:	a66080e7          	jalr	-1434(ra) # 5bf0 <printf>
    exit(1);
    4192:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41ca:	fda58593          	addi	a1,a1,-38 # 61a0 <malloc+0x4f2>
    ...
    41f4:	77850513          	addi	a0,a0,1912 # 6968 <malloc+0xcba>
    41f8:	00002097          	auipc	ra,0x2
    41fc:	9f8080e7          	jalr	-1544(ra) # 5bf0 <printf>
     exit(1);
    4200:	4505                	li	a0,1
    ...
    4210:	9fc50513          	addi	a0,a0,-1540 # 7c08 <malloc+0x1f5a>
    4214:	00002097          	auipc	ra,0x2
    4218:	9dc080e7          	jalr	-1572(ra) # 5bf0 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    424c:	9d850513          	addi	a0,a0,-1576 # 7c20 <malloc+0x1f72>
    4250:	00002097          	auipc	ra,0x2
    4254:	9a0080e7          	jalr	-1632(ra) # 5bf0 <printf>
}
  ...
  printf("kill... ");
    ...
    4278:	9c450513          	addi	a0,a0,-1596 # 7c38 <malloc+0x1f8a>
    427c:	00002097          	auipc	ra,0x2
    4280:	974080e7          	jalr	-1676(ra) # 5bf0 <printf>
  kill(pid1);
    4284:	8552                	mv	a0,s4
  ...
  printf("wait... ");
    ...
    42a6:	9a650513          	addi	a0,a0,-1626 # 7c48 <malloc+0x1f9a>
    42aa:	00002097          	auipc	ra,0x2
    42ae:	946080e7          	jalr	-1722(ra) # 5bf0 <printf>
  wait(0);
    42b2:	4501                	li	a0,0
...
00000000000042d2 <reparent>:
{
  ...
  exit(0);
    ...
    4326:	64650513          	addi	a0,a0,1606 # 6968 <malloc+0xcba>
    432a:	00002097          	auipc	ra,0x2
    432e:	8c6080e7          	jalr	-1850(ra) # 5bf0 <printf>
      exit(1);
    4332:	4505                	li	a0,1
    ...
    4342:	7b250513          	addi	a0,a0,1970 # 6af0 <malloc+0xe42>
    4346:	00002097          	auipc	ra,0x2
    434a:	8aa080e7          	jalr	-1878(ra) # 5bf0 <printf>
        exit(1);
    434e:	4505                	li	a0,1
...
0000000000004382 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b8:	6bc50513          	addi	a0,a0,1724 # 6a70 <malloc+0xdc2>
    43bc:	00002097          	auipc	ra,0x2
    43c0:	834080e7          	jalr	-1996(ra) # 5bf0 <printf>
    exit(1);
    43c4:	4505                	li	a0,1
    ...
    43ee:	db658593          	addi	a1,a1,-586 # 61a0 <malloc+0x4f2>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44b2:	7aa50513          	addi	a0,a0,1962 # 7c58 <malloc+0x1faa>
    44b6:	00001097          	auipc	ra,0x1
    44ba:	73a080e7          	jalr	1850(ra) # 5bf0 <printf>
    exit(1);
    44be:	4505                	li	a0,1
    ...
    44ce:	49e50513          	addi	a0,a0,1182 # 6968 <malloc+0xcba>
    44d2:	00001097          	auipc	ra,0x1
    44d6:	71e080e7          	jalr	1822(ra) # 5bf0 <printf>
    exit(1);
    44da:	4505                	li	a0,1
    ...
    451a:	76250513          	addi	a0,a0,1890 # 7c78 <malloc+0x1fca>
    451e:	00001097          	auipc	ra,0x1
    4522:	6d2080e7          	jalr	1746(ra) # 5bf0 <printf>
    exit(1);
    4526:	4505                	li	a0,1
...
000000000000453a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4562:	750080e7          	jalr	1872(ra) # 5cae <malloc>
    ...
    45a2:	70a50513          	addi	a0,a0,1802 # 7ca8 <malloc+0x1ffa>
    45a6:	00001097          	auipc	ra,0x1
    45aa:	64a080e7          	jalr	1610(ra) # 5bf0 <printf>
      exit(1);
    45ae:	4505                	li	a0,1
...
00000000000045e0 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4676:	65650513          	addi	a0,a0,1622 # 7cc8 <malloc+0x201a>
    467a:	00001097          	auipc	ra,0x1
    467e:	576080e7          	jalr	1398(ra) # 5bf0 <printf>
    exit(1);
    4682:	4505                	li	a0,1
    ...
    4692:	66250513          	addi	a0,a0,1634 # 7cf0 <malloc+0x2042>
    4696:	00001097          	auipc	ra,0x1
    469a:	55a080e7          	jalr	1370(ra) # 5bf0 <printf>
      exit(1);
    469e:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46d6:	86e50513          	addi	a0,a0,-1938 # 5f40 <malloc+0x292>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4716:	5fe50513          	addi	a0,a0,1534 # 7d10 <malloc+0x2062>
    471a:	00001097          	auipc	ra,0x1
    471e:	4d6080e7          	jalr	1238(ra) # 5bf0 <printf>
    exit(1);
    4722:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4752:	7f250513          	addi	a0,a0,2034 # 5f40 <malloc+0x292>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4778:	5c450513          	addi	a0,a0,1476 # 7d38 <malloc+0x208a>
    477c:	00001097          	auipc	ra,0x1
    4780:	474080e7          	jalr	1140(ra) # 5bf0 <printf>
    exit(1);
    4784:	4505                	li	a0,1
...
0000000000004798 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47bc:	5e078793          	addi	a5,a5,1504 # 5d98 <malloc+0xea>
    47c0:	f6f43823          	sd	a5,-144(s0)
    47c4:	00001797          	auipc	a5,0x1
    47c8:	5dc78793          	addi	a5,a5,1500 # 5da0 <malloc+0xf2>
    47cc:	f6f43c23          	sd	a5,-136(s0)
    47d0:	00001797          	auipc	a5,0x1
    47d4:	5d878793          	addi	a5,a5,1496 # 5da8 <malloc+0xfa>
    47d8:	f8f43023          	sd	a5,-128(s0)
    47dc:	00001797          	auipc	a5,0x1
    47e0:	5d478793          	addi	a5,a5,1492 # 5db0 <malloc+0x102>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4858:	53450513          	addi	a0,a0,1332 # 6d88 <malloc+0x10da>
    485c:	00001097          	auipc	ra,0x1
    4860:	394080e7          	jalr	916(ra) # 5bf0 <printf>
      exit(1);
    4864:	4505                	li	a0,1
    ...
    48d2:	48250513          	addi	a0,a0,1154 # 7d50 <malloc+0x20a2>
    48d6:	00001097          	auipc	ra,0x1
    48da:	31a080e7          	jalr	794(ra) # 5bf0 <printf>
        exit(1);
    48de:	4505                	li	a0,1
    ...
    48ec:	47850513          	addi	a0,a0,1144 # 7d60 <malloc+0x20b2>
    48f0:	00001097          	auipc	ra,0x1
    48f4:	300080e7          	jalr	768(ra) # 5bf0 <printf>
          exit(1);
    48f8:	4505                	li	a0,1
    ...
    4910:	46c50513          	addi	a0,a0,1132 # 7d78 <malloc+0x20ca>
    4914:	00001097          	auipc	ra,0x1
    4918:	2dc080e7          	jalr	732(ra) # 5bf0 <printf>
          exit(1);
    491c:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49a0:	3ec50513          	addi	a0,a0,1004 # 7d88 <malloc+0x20da>
    49a4:	00001097          	auipc	ra,0x1
    49a8:	24c080e7          	jalr	588(ra) # 5bf0 <printf>
      exit(1);
    49ac:	4505                	li	a0,1
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a02:	3a2b8b93          	addi	s7,s7,930 # 7da0 <malloc+0x20f2>
  for(i = 0; i < N; i++){
    ...
    4a44:	36850513          	addi	a0,a0,872 # 7da8 <malloc+0x20fa>
    4a48:	00001097          	auipc	ra,0x1
    4a4c:	1a8080e7          	jalr	424(ra) # 5bf0 <printf>
        exit(1);
    4a50:	4505                	li	a0,1
    ...
    4a62:	34250513          	addi	a0,a0,834 # 7da0 <malloc+0x20f2>
  ...
  fd = open(".", 0);
    ...
    4a9a:	d3250513          	addi	a0,a0,-718 # 67c8 <malloc+0xb1a>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ac0:	30c50513          	addi	a0,a0,780 # 7dc8 <malloc+0x211a>
    4ac4:	00001097          	auipc	ra,0x1
    4ac8:	12c080e7          	jalr	300(ra) # 5bf0 <printf>
        exit(1);
    4acc:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b30:	2bc50513          	addi	a0,a0,700 # 7de8 <malloc+0x213a>
    4b34:	00001097          	auipc	ra,0x1
    4b38:	0bc080e7          	jalr	188(ra) # 5bf0 <printf>
        exit(1);
    4b3c:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b68:	2ac50513          	addi	a0,a0,684 # 7e10 <malloc+0x2162>
    4b6c:	00001097          	auipc	ra,0x1
    4b70:	084080e7          	jalr	132(ra) # 5bf0 <printf>
    exit(1);
    4b74:	4505                	li	a0,1
    ...
    4b84:	de850513          	addi	a0,a0,-536 # 6968 <malloc+0xcba>
    4b88:	00001097          	auipc	ra,0x1
    4b8c:	068080e7          	jalr	104(ra) # 5bf0 <printf>
      exit(1);
    4b90:	4505                	li	a0,1
...
0000000000004d2e <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db6:	09650513          	addi	a0,a0,150 # 7e48 <malloc+0x219a>
  ...
  for(i = 0; ; i++){
    ...
    4e1a:	04250513          	addi	a0,a0,66 # 7e58 <malloc+0x21aa>
    4e1e:	00001097          	auipc	ra,0x1
    4e22:	dd2080e7          	jalr	-558(ra) # 5bf0 <printf>
    exit(1);
    4e26:	4505                	li	a0,1
    ...
    4e36:	04650513          	addi	a0,a0,70 # 7e78 <malloc+0x21ca>
    4e3a:	00001097          	auipc	ra,0x1
    4e3e:	db6080e7          	jalr	-586(ra) # 5bf0 <printf>
      exit(1);
    4e42:	4505                	li	a0,1
    ...
    4e52:	04a50513          	addi	a0,a0,74 # 7e98 <malloc+0x21ea>
    4e56:	00001097          	auipc	ra,0x1
    4e5a:	d9a080e7          	jalr	-614(ra) # 5bf0 <printf>
    exit(1);
    4e5e:	4505                	li	a0,1
    ...
    4e6e:	04e50513          	addi	a0,a0,78 # 7eb8 <malloc+0x220a>
    4e72:	00001097          	auipc	ra,0x1
    4e76:	d7e080e7          	jalr	-642(ra) # 5bf0 <printf>
      exit(1);
    4e7a:	4505                	li	a0,1
    ...
    4e8a:	05250513          	addi	a0,a0,82 # 7ed8 <malloc+0x222a>
    4e8e:	00001097          	auipc	ra,0x1
    4e92:	d62080e7          	jalr	-670(ra) # 5bf0 <printf>
      exit(1);
    4e96:	4505                	li	a0,1
    ...
    4ea6:	04e50513          	addi	a0,a0,78 # 7ef0 <malloc+0x2242>
    4eaa:	00001097          	auipc	ra,0x1
    4eae:	d46080e7          	jalr	-698(ra) # 5bf0 <printf>
      exit(1);
    4eb2:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed4:	f7850513          	addi	a0,a0,-136 # 7e48 <malloc+0x219a>
    ...
    4ef8:	01c50513          	addi	a0,a0,28 # 7f10 <malloc+0x2262>
    4efc:	00001097          	auipc	ra,0x1
    4f00:	cf4080e7          	jalr	-780(ra) # 5bf0 <printf>
    exit(1);
    4f04:	4505                	li	a0,1
...
0000000000004f0e <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f30:	00450513          	addi	a0,a0,4 # 7f30 <malloc+0x2282>
    4f34:	00001097          	auipc	ra,0x1
    4f38:	cbc080e7          	jalr	-836(ra) # 5bf0 <printf>
  for(nfiles = 0; ; nfiles++){
    4f3c:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f50:	ff4c8c93          	addi	s9,s9,-12 # 7f40 <malloc+0x2292>
    int total = 0;
    4f54:	4d81                	li	s11,0
    ...
    4fa8:	c4c080e7          	jalr	-948(ra) # 5bf0 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fca:	f8a50513          	addi	a0,a0,-118 # 7f50 <malloc+0x22a2>
    4fce:	00001097          	auipc	ra,0x1
    4fd2:	c22080e7          	jalr	-990(ra) # 5bf0 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5040:	f3450513          	addi	a0,a0,-204 # 7f70 <malloc+0x22c2>
    5044:	00001097          	auipc	ra,0x1
    5048:	bac080e7          	jalr	-1108(ra) # 5bf0 <printf>
}
    ...
    5090:	ed450513          	addi	a0,a0,-300 # 7f60 <malloc+0x22b2>
    5094:	00001097          	auipc	ra,0x1
    5098:	b5c080e7          	jalr	-1188(ra) # 5bf0 <printf>
    close(fd);
    509c:	854a                	mv	a0,s2
...
00000000000050ae <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5122:	e6a50513          	addi	a0,a0,-406 # 7f88 <malloc+0x22da>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513a:	06a58593          	addi	a1,a1,106 # 61a0 <malloc+0x4f2>
    ...
    5150:	e5c50513          	addi	a0,a0,-420 # 7fa8 <malloc+0x22fa>
    5154:	00001097          	auipc	ra,0x1
    5158:	a9c080e7          	jalr	-1380(ra) # 5bf0 <printf>
    exit(1);
    515c:	4505                	li	a0,1
    ...
    516a:	e2a50513          	addi	a0,a0,-470 # 7f90 <malloc+0x22e2>
    516e:	00001097          	auipc	ra,0x1
    5172:	a82080e7          	jalr	-1406(ra) # 5bf0 <printf>
      exit(1);
    5176:	4505                	li	a0,1
    ...
    5184:	e1050513          	addi	a0,a0,-496 # 7f90 <malloc+0x22e2>
    5188:	00001097          	auipc	ra,0x1
    518c:	a68080e7          	jalr	-1432(ra) # 5bf0 <printf>
    exit(1);
    5190:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a8:	de450513          	addi	a0,a0,-540 # 7f88 <malloc+0x22da>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fe:	fa690913          	addi	s2,s2,-90 # 61a0 <malloc+0x4f2>
      uint64 a = (uint64) sbrk(4096);
    ...
    5232:	dca50513          	addi	a0,a0,-566 # 7ff8 <malloc+0x234a>
    5236:	00001097          	auipc	ra,0x1
    523a:	9ba080e7          	jalr	-1606(ra) # 5bf0 <printf>
        exit(1);
    523e:	4505                	li	a0,1
    ...
    524c:	d7050513          	addi	a0,a0,-656 # 7fb8 <malloc+0x230a>
    5250:	00001097          	auipc	ra,0x1
    5254:	9a0080e7          	jalr	-1632(ra) # 5bf0 <printf>
    exit(1);
    5258:	4505                	li	a0,1
    ...
    5266:	d7650513          	addi	a0,a0,-650 # 7fd8 <malloc+0x232a>
    526a:	00001097          	auipc	ra,0x1
    526e:	986080e7          	jalr	-1658(ra) # 5bf0 <printf>
    exit(1);
    5272:	4505                	li	a0,1
  ...
  while(1){
    ...
    52b4:	d6850513          	addi	a0,a0,-664 # 8018 <malloc+0x236a>
    52b8:	00001097          	auipc	ra,0x1
    52bc:	938080e7          	jalr	-1736(ra) # 5bf0 <printf>
      exit(1);
    52c0:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5304:	d3850513          	addi	a0,a0,-712 # 8038 <malloc+0x238a>
    5308:	00001097          	auipc	ra,0x1
    530c:	8e8080e7          	jalr	-1816(ra) # 5bf0 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5334:	d3050513          	addi	a0,a0,-720 # 8060 <malloc+0x23b2>
    5338:	00001097          	auipc	ra,0x1
    533c:	8b8080e7          	jalr	-1864(ra) # 5bf0 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5358:	cf450513          	addi	a0,a0,-780 # 8048 <malloc+0x239a>
    535c:	00001097          	auipc	ra,0x1
    5360:	894080e7          	jalr	-1900(ra) # 5bf0 <printf>
    exit(1);
    5364:	4505                	li	a0,1
    ...
    5380:	cec50513          	addi	a0,a0,-788 # 8068 <malloc+0x23ba>
    5384:	00001097          	auipc	ra,0x1
    5388:	86c080e7          	jalr	-1940(ra) # 5bf0 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53ca:	dba78793          	addi	a5,a5,-582 # 8180 <malloc+0x24d2>
    53ce:	bd040713          	addi	a4,s0,-1072
    53d2:	00003317          	auipc	t1,0x3
    53d6:	19e30313          	addi	t1,t1,414 # 8570 <malloc+0x28c2>
  ...
  printf("usertests starting\n");
    ...
    540a:	d1a50513          	addi	a0,a0,-742 # 8120 <malloc+0x2472>
    540e:	00000097          	auipc	ra,0x0
    5412:	7e2080e7          	jalr	2018(ra) # 5bf0 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5442:	c9a50513          	addi	a0,a0,-870 # 80d8 <malloc+0x242a>
    5446:	00000097          	auipc	ra,0x0
    544a:	7aa080e7          	jalr	1962(ra) # 5bf0 <printf>
    exit(1);
    544e:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    545e:	c1658593          	addi	a1,a1,-1002 # 8070 <malloc+0x23c2>
    ...
    5474:	ce858593          	addi	a1,a1,-792 # 8158 <malloc+0x24aa>
    ...
    5498:	be450513          	addi	a0,a0,-1052 # 8078 <malloc+0x23ca>
    549c:	00000097          	auipc	ra,0x0
    54a0:	754080e7          	jalr	1876(ra) # 5bf0 <printf>
    exit(1);
    54a4:	4505                	li	a0,1
    ...
    54c2:	732080e7          	jalr	1842(ra) # 5bf0 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5504:	bc050513          	addi	a0,a0,-1088 # 80c0 <malloc+0x2412>
    5508:	00000097          	auipc	ra,0x0
    550c:	6e8080e7          	jalr	1768(ra) # 5bf0 <printf>
    exit(1);
    5510:	4505                	li	a0,1
    ...
    551e:	bee50513          	addi	a0,a0,-1042 # 8108 <malloc+0x245a>
    5522:	00000097          	auipc	ra,0x0
    5526:	6ce080e7          	jalr	1742(ra) # 5bf0 <printf>
    exit(0);
    552a:	4501                	li	a0,0
    ...
    553a:	6ba080e7          	jalr	1722(ra) # 5bf0 <printf>
        if(continuous != 2)
    ...
    557c:	c0878793          	addi	a5,a5,-1016 # 8180 <malloc+0x24d2>
    5580:	bd040713          	addi	a4,s0,-1072
    5584:	00003317          	auipc	t1,0x3
    5588:	fec30313          	addi	t1,t1,-20 # 8570 <malloc+0x28c2>
    ...
    55bc:	b8050513          	addi	a0,a0,-1152 # 8138 <malloc+0x248a>
    55c0:	00000097          	auipc	ra,0x0
    55c4:	630080e7          	jalr	1584(ra) # 5bf0 <printf>
        printf("SOME TESTS FAILED\n");
    55c8:	00003a97          	auipc	s5,0x3
    55cc:	af8a8a93          	addi	s5,s5,-1288 # 80c0 <malloc+0x2412>
        if(continuous != 2)
    55d0:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55d2:	00003b17          	auipc	s6,0x3
    55d6:	aceb0b13          	addi	s6,s6,-1330 # 80a0 <malloc+0x23f2>
...
putc(int fd, char c)
{
    5918:	1101                	addi	sp,sp,-32
    591a:	ec06                	sd	ra,24(sp)
    591c:	e822                	sd	s0,16(sp)
    591e:	1000                	addi	s0,sp,32
    5920:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5924:	4605                	li	a2,1
    5926:	fef40593          	addi	a1,s0,-17
    592a:	00000097          	auipc	ra,0x0
    592e:	f5e080e7          	jalr	-162(ra) # 5888 <write>
}
    5932:	60e2                	ld	ra,24(sp)
    5934:	6442                	ld	s0,16(sp)
    5936:	6105                	addi	sp,sp,32
    5938:	8082                	ret

000000000000593a <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    593a:	7139                	addi	sp,sp,-64
    593c:	fc06                	sd	ra,56(sp)
    593e:	f822                	sd	s0,48(sp)
    5940:	f426                	sd	s1,40(sp)
    5942:	f04a                	sd	s2,32(sp)
    5944:	ec4e                	sd	s3,24(sp)
    5946:	0080                	addi	s0,sp,64
    5948:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    594a:	c299                	beqz	a3,5950 <printint+0x16>
    594c:	0805c863          	bltz	a1,59dc <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5950:	2581                	sext.w	a1,a1
  neg = 0;
    5952:	4881                	li	a7,0
    5954:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    595a:	2601                	sext.w	a2,a2
    595c:	00003517          	auipc	a0,0x3
    5960:	c1c50513          	addi	a0,a0,-996 # 8578 <digits>
    5964:	883a                	mv	a6,a4
    5966:	2705                	addiw	a4,a4,1
    5968:	02c5f7bb          	remuw	a5,a1,a2
    596c:	1782                	slli	a5,a5,0x20
    596e:	9381                	srli	a5,a5,0x20
    5970:	97aa                	add	a5,a5,a0
    5972:	0007c783          	lbu	a5,0(a5) # 4000000 <__BSS_END__+0x3ff1238>
    5976:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    597a:	0005879b          	sext.w	a5,a1
    597e:	02c5d5bb          	divuw	a1,a1,a2
    5982:	0685                	addi	a3,a3,1
    5984:	fec7f0e3          	bgeu	a5,a2,5964 <printint+0x2a>
  if(neg)
    5988:	00088b63          	beqz	a7,599e <printint+0x64>
    buf[i++] = '-';
    598c:	fd040793          	addi	a5,s0,-48
    5990:	973e                	add	a4,a4,a5
    5992:	02d00793          	li	a5,45
    5996:	fef70823          	sb	a5,-16(a4)
    599a:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    599e:	02e05863          	blez	a4,59ce <printint+0x94>
    59a2:	fc040793          	addi	a5,s0,-64
    59a6:	00e78933          	add	s2,a5,a4
    59aa:	fff78993          	addi	s3,a5,-1
    59ae:	99ba                	add	s3,s3,a4
    59b0:	377d                	addiw	a4,a4,-1
    59b2:	1702                	slli	a4,a4,0x20
    59b4:	9301                	srli	a4,a4,0x20
    59b6:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    59ba:	fff94583          	lbu	a1,-1(s2)
    59be:	8526                	mv	a0,s1
    59c0:	00000097          	auipc	ra,0x0
    59c4:	f58080e7          	jalr	-168(ra) # 5918 <putc>
  while(--i >= 0)
    59c8:	197d                	addi	s2,s2,-1
    59ca:	ff3918e3          	bne	s2,s3,59ba <printint+0x80>
}
    59ce:	70e2                	ld	ra,56(sp)
    59d0:	7442                	ld	s0,48(sp)
    59d2:	74a2                	ld	s1,40(sp)
    59d4:	7902                	ld	s2,32(sp)
    59d6:	69e2                	ld	s3,24(sp)
    59d8:	6121                	addi	sp,sp,64
    59da:	8082                	ret
    x = -xx;
    59dc:	40b005bb          	negw	a1,a1
    neg = 1;
    59e0:	4885                	li	a7,1
    x = -xx;
    59e2:	bf8d                	j	5954 <printint+0x1a>

00000000000059e4 <vprintf>:
}
...
{
    59e4:	7119                	addi	sp,sp,-128
    59e6:	fc86                	sd	ra,120(sp)
    59e8:	f8a2                	sd	s0,112(sp)
    59ea:	f4a6                	sd	s1,104(sp)
    59ec:	f0ca                	sd	s2,96(sp)
    59ee:	ecce                	sd	s3,88(sp)
    59f0:	e8d2                	sd	s4,80(sp)
    59f2:	e4d6                	sd	s5,72(sp)
    59f4:	e0da                	sd	s6,64(sp)
    59f6:	fc5e                	sd	s7,56(sp)
    59f8:	f862                	sd	s8,48(sp)
    59fa:	f466                	sd	s9,40(sp)
    59fc:	f06a                	sd	s10,32(sp)
    59fe:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    5a02:	0005c903          	lbu	s2,0(a1)
    5a06:	18090f63          	beqz	s2,5ba4 <vprintf+0x1c0>
    5a0a:	8aaa                	mv	s5,a0
    5a0c:	8b32                	mv	s6,a2
    5a0e:	00158493          	addi	s1,a1,1
  state = 0;
    5a12:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5a14:	02500a13          	li	s4,37
      if(c == 'd'){
    5a18:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5a1c:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5a20:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5a24:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a28:	00003b97          	auipc	s7,0x3
    5a2c:	b50b8b93          	addi	s7,s7,-1200 # 8578 <digits>
    5a30:	a839                	j	5a4e <vprintf+0x6a>
        putc(fd, c);
    5a32:	85ca                	mv	a1,s2
    5a34:	8556                	mv	a0,s5
    5a36:	00000097          	auipc	ra,0x0
    5a3a:	ee2080e7          	jalr	-286(ra) # 5918 <putc>
    5a3e:	a019                	j	5a44 <vprintf+0x60>
    } else if(state == '%'){
    5a40:	01498f63          	beq	s3,s4,5a5e <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5a44:	0485                	addi	s1,s1,1
    5a46:	fff4c903          	lbu	s2,-1(s1)
    5a4a:	14090d63          	beqz	s2,5ba4 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5a4e:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5a52:	fe0997e3          	bnez	s3,5a40 <vprintf+0x5c>
      if(c == '%'){
    5a56:	fd479ee3          	bne	a5,s4,5a32 <vprintf+0x4e>
        state = '%';
    5a5a:	89be                	mv	s3,a5
    5a5c:	b7e5                	j	5a44 <vprintf+0x60>
      if(c == 'd'){
    5a5e:	05878063          	beq	a5,s8,5a9e <vprintf+0xba>
      } else if(c == 'l') {
    5a62:	05978c63          	beq	a5,s9,5aba <vprintf+0xd6>
      } else if(c == 'x') {
    5a66:	07a78863          	beq	a5,s10,5ad6 <vprintf+0xf2>
      } else if(c == 'p') {
    5a6a:	09b78463          	beq	a5,s11,5af2 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5a6e:	07300713          	li	a4,115
    5a72:	0ce78663          	beq	a5,a4,5b3e <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5a76:	06300713          	li	a4,99
    5a7a:	0ee78e63          	beq	a5,a4,5b76 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5a7e:	11478863          	beq	a5,s4,5b8e <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5a8a:	e92080e7          	jalr	-366(ra) # 5918 <putc>
        putc(fd, c);
    5a8e:	85ca                	mv	a1,s2
    5a90:	8556                	mv	a0,s5
    5a92:	00000097          	auipc	ra,0x0
    5a96:	e86080e7          	jalr	-378(ra) # 5918 <putc>
      }
      state = 0;
    5a9a:	4981                	li	s3,0
    5a9c:	b765                	j	5a44 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5ab0:	e8e080e7          	jalr	-370(ra) # 593a <printint>
    5ab4:	8b4a                	mv	s6,s2
      state = 0;
    5ab6:	4981                	li	s3,0
    5ab8:	b771                	j	5a44 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5acc:	e72080e7          	jalr	-398(ra) # 593a <printint>
    5ad0:	8b4a                	mv	s6,s2
      state = 0;
    5ad2:	4981                	li	s3,0
    5ad4:	bf85                	j	5a44 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    5ae8:	e56080e7          	jalr	-426(ra) # 593a <printint>
    5aec:	8b4a                	mv	s6,s2
      state = 0;
    5aee:	4981                	li	s3,0
    5af0:	bf91                	j	5a44 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5af2:	008b0793          	addi	a5,s6,8
    5af6:	f8f43423          	sd	a5,-120(s0)
    5afa:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5afe:	03000593          	li	a1,48
    5b02:	8556                	mv	a0,s5
    5b04:	00000097          	auipc	ra,0x0
    5b08:	e14080e7          	jalr	-492(ra) # 5918 <putc>
  putc(fd, 'x');
    5b0c:	85ea                	mv	a1,s10
    5b0e:	8556                	mv	a0,s5
    5b10:	00000097          	auipc	ra,0x0
    5b14:	e08080e7          	jalr	-504(ra) # 5918 <putc>
    5b18:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5b1a:	03c9d793          	srli	a5,s3,0x3c
    5b1e:	97de                	add	a5,a5,s7
    5b20:	0007c583          	lbu	a1,0(a5)
    5b24:	8556                	mv	a0,s5
    5b26:	00000097          	auipc	ra,0x0
    5b2a:	df2080e7          	jalr	-526(ra) # 5918 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b2e:	0992                	slli	s3,s3,0x4
    5b30:	397d                	addiw	s2,s2,-1
    5b32:	fe0914e3          	bnez	s2,5b1a <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5b36:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b3a:	4981                	li	s3,0
    5b3c:	b721                	j	5a44 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b3e:	008b0993          	addi	s3,s6,8
    5b42:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5b46:	02090163          	beqz	s2,5b68 <vprintf+0x184>
        while(*s != 0){
    5b4a:	00094583          	lbu	a1,0(s2)
    5b4e:	c9a1                	beqz	a1,5b9e <vprintf+0x1ba>
          putc(fd, *s);
    5b50:	8556                	mv	a0,s5
    5b52:	00000097          	auipc	ra,0x0
    5b56:	dc6080e7          	jalr	-570(ra) # 5918 <putc>
          s++;
    5b5a:	0905                	addi	s2,s2,1
        while(*s != 0){
    5b5c:	00094583          	lbu	a1,0(s2)
    5b60:	f9e5                	bnez	a1,5b50 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5b62:	8b4e                	mv	s6,s3
      state = 0;
    5b64:	4981                	li	s3,0
    5b66:	bdf9                	j	5a44 <vprintf+0x60>
          s = "(null)";
    5b68:	00003917          	auipc	s2,0x3
    5b6c:	a0890913          	addi	s2,s2,-1528 # 8570 <malloc+0x28c2>
        while(*s != 0){
    5b70:	02800593          	li	a1,40
    5b74:	bff1                	j	5b50 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5b76:	008b0913          	addi	s2,s6,8
    5b7a:	000b4583          	lbu	a1,0(s6)
    5b7e:	8556                	mv	a0,s5
    5b80:	00000097          	auipc	ra,0x0
    5b84:	d98080e7          	jalr	-616(ra) # 5918 <putc>
    5b88:	8b4a                	mv	s6,s2
      state = 0;
    5b8a:	4981                	li	s3,0
    5b8c:	bd65                	j	5a44 <vprintf+0x60>
        putc(fd, c);
    5b8e:	85d2                	mv	a1,s4
    5b90:	8556                	mv	a0,s5
    5b92:	00000097          	auipc	ra,0x0
    5b96:	d86080e7          	jalr	-634(ra) # 5918 <putc>
      state = 0;
    5b9a:	4981                	li	s3,0
    5b9c:	b565                	j	5a44 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b9e:	8b4e                	mv	s6,s3
      state = 0;
    5ba0:	4981                	li	s3,0
    5ba2:	b54d                	j	5a44 <vprintf+0x60>
    }
  }
}
    5ba4:	70e6                	ld	ra,120(sp)
    5ba6:	7446                	ld	s0,112(sp)
    5ba8:	74a6                	ld	s1,104(sp)
    5baa:	7906                	ld	s2,96(sp)
    5bac:	69e6                	ld	s3,88(sp)
    5bae:	6a46                	ld	s4,80(sp)
    5bb0:	6aa6                	ld	s5,72(sp)
    5bb2:	6b06                	ld	s6,64(sp)
    5bb4:	7be2                	ld	s7,56(sp)
    5bb6:	7c42                	ld	s8,48(sp)
    5bb8:	7ca2                	ld	s9,40(sp)
    5bba:	7d02                	ld	s10,32(sp)
    5bbc:	6de2                	ld	s11,24(sp)
    5bbe:	6109                	addi	sp,sp,128
    5bc0:	8082                	ret

0000000000005bc2 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5bc2:	715d                	addi	sp,sp,-80
    5bc4:	ec06                	sd	ra,24(sp)
    5bc6:	e822                	sd	s0,16(sp)
    5bc8:	1000                	addi	s0,sp,32
    5bca:	e010                	sd	a2,0(s0)
    5bcc:	e414                	sd	a3,8(s0)
    5bce:	e818                	sd	a4,16(s0)
    5bd0:	ec1c                	sd	a5,24(s0)
    5bd2:	03043023          	sd	a6,32(s0)
    5bd6:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5bda:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5bde:	8622                	mv	a2,s0
    5be0:	00000097          	auipc	ra,0x0
    5be4:	e04080e7          	jalr	-508(ra) # 59e4 <vprintf>
}
    5be8:	60e2                	ld	ra,24(sp)
    5bea:	6442                	ld	s0,16(sp)
    5bec:	6161                	addi	sp,sp,80
    5bee:	8082                	ret

0000000000005bf0 <printf>:

void
printf(const char *fmt, ...)
{
    5bf0:	711d                	addi	sp,sp,-96
    5bf2:	ec06                	sd	ra,24(sp)
    5bf4:	e822                	sd	s0,16(sp)
    5bf6:	1000                	addi	s0,sp,32
    5bf8:	e40c                	sd	a1,8(s0)
    5bfa:	e810                	sd	a2,16(s0)
    5bfc:	ec14                	sd	a3,24(s0)
    5bfe:	f018                	sd	a4,32(s0)
    5c00:	f41c                	sd	a5,40(s0)
    5c02:	03043823          	sd	a6,48(s0)
    5c06:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5c0a:	00840613          	addi	a2,s0,8
    5c0e:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5c12:	85aa                	mv	a1,a0
    5c14:	4505                	li	a0,1
    5c16:	00000097          	auipc	ra,0x0
    5c1a:	dce080e7          	jalr	-562(ra) # 59e4 <vprintf>
}
    5c1e:	60e2                	ld	ra,24(sp)
    5c20:	6442                	ld	s0,16(sp)
    5c22:	6125                	addi	sp,sp,96
    5c24:	8082                	ret

0000000000005c26 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5c26:	1141                	addi	sp,sp,-16
    5c28:	e422                	sd	s0,8(sp)
    5c2a:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c2c:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c30:	00003797          	auipc	a5,0x3
    5c34:	9687b783          	ld	a5,-1688(a5) # 8598 <freep>
    5c38:	a805                	j	5c68 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c3a:	4618                	lw	a4,8(a2)
    5c3c:	9db9                	addw	a1,a1,a4
    5c3e:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c42:	6398                	ld	a4,0(a5)
    5c44:	6318                	ld	a4,0(a4)
    5c46:	fee53823          	sd	a4,-16(a0)
    5c4a:	a091                	j	5c8e <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c4c:	ff852703          	lw	a4,-8(a0)
    5c50:	9e39                	addw	a2,a2,a4
    5c52:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5c54:	ff053703          	ld	a4,-16(a0)
    5c58:	e398                	sd	a4,0(a5)
    5c5a:	a099                	j	5ca0 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c5c:	6398                	ld	a4,0(a5)
    5c5e:	00e7e463          	bltu	a5,a4,5c66 <free+0x40>
    5c62:	00e6ea63          	bltu	a3,a4,5c76 <free+0x50>
{
    5c66:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c68:	fed7fae3          	bgeu	a5,a3,5c5c <free+0x36>
    5c6c:	6398                	ld	a4,0(a5)
    5c6e:	00e6e463          	bltu	a3,a4,5c76 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c72:	fee7eae3          	bltu	a5,a4,5c66 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5c76:	ff852583          	lw	a1,-8(a0)
    5c7a:	6390                	ld	a2,0(a5)
    5c7c:	02059713          	slli	a4,a1,0x20
    5c80:	9301                	srli	a4,a4,0x20
    5c82:	0712                	slli	a4,a4,0x4
    5c84:	9736                	add	a4,a4,a3
    5c86:	fae60ae3          	beq	a2,a4,5c3a <free+0x14>
    bp->s.ptr = p->s.ptr;
    5c8a:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c8e:	4790                	lw	a2,8(a5)
    5c90:	02061713          	slli	a4,a2,0x20
    5c94:	9301                	srli	a4,a4,0x20
    5c96:	0712                	slli	a4,a4,0x4
    5c98:	973e                	add	a4,a4,a5
    5c9a:	fae689e3          	beq	a3,a4,5c4c <free+0x26>
  } else
    p->s.ptr = bp;
    5c9e:	e394                	sd	a3,0(a5)
  freep = p;
    5ca0:	00003717          	auipc	a4,0x3
    5ca4:	8ef73c23          	sd	a5,-1800(a4) # 8598 <freep>
}
    5ca8:	6422                	ld	s0,8(sp)
    5caa:	0141                	addi	sp,sp,16
    5cac:	8082                	ret

0000000000005cae <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5cae:	7139                	addi	sp,sp,-64
    5cb0:	fc06                	sd	ra,56(sp)
    5cb2:	f822                	sd	s0,48(sp)
    5cb4:	f426                	sd	s1,40(sp)
    5cb6:	f04a                	sd	s2,32(sp)
    5cb8:	ec4e                	sd	s3,24(sp)
    5cba:	e852                	sd	s4,16(sp)
    5cbc:	e456                	sd	s5,8(sp)
    5cbe:	e05a                	sd	s6,0(sp)
    5cc0:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5cc2:	02051493          	slli	s1,a0,0x20
    5cc6:	9081                	srli	s1,s1,0x20
    5cc8:	04bd                	addi	s1,s1,15
    5cca:	8091                	srli	s1,s1,0x4
    5ccc:	0014899b          	addiw	s3,s1,1
    5cd0:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5cd2:	00003517          	auipc	a0,0x3
    5cd6:	8c653503          	ld	a0,-1850(a0) # 8598 <freep>
    5cda:	c515                	beqz	a0,5d06 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5cdc:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5cde:	4798                	lw	a4,8(a5)
    5ce0:	02977f63          	bgeu	a4,s1,5d1e <malloc+0x70>
    5ce4:	8a4e                	mv	s4,s3
    5ce6:	0009871b          	sext.w	a4,s3
    5cea:	6685                	lui	a3,0x1
    5cec:	00d77363          	bgeu	a4,a3,5cf2 <malloc+0x44>
    5cf0:	6a05                	lui	s4,0x1
    5cf2:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cf6:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5cfa:	00003917          	auipc	s2,0x3
    5cfe:	89e90913          	addi	s2,s2,-1890 # 8598 <freep>
  if(p == (char*)-1)
    5d02:	5afd                	li	s5,-1
    5d04:	a88d                	j	5d76 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5d06:	00009797          	auipc	a5,0x9
    5d0a:	0b278793          	addi	a5,a5,178 # edb8 <base>
    5d0e:	00003717          	auipc	a4,0x3
    5d12:	88f73523          	sd	a5,-1910(a4) # 8598 <freep>
    5d16:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5d18:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5d1c:	b7e1                	j	5ce4 <malloc+0x36>
      if(p->s.size == nunits)
    5d1e:	02e48b63          	beq	s1,a4,5d54 <malloc+0xa6>
        p->s.size -= nunits;
    5d22:	4137073b          	subw	a4,a4,s3
    5d26:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d28:	1702                	slli	a4,a4,0x20
    5d2a:	9301                	srli	a4,a4,0x20
    5d2c:	0712                	slli	a4,a4,0x4
    5d2e:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d30:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d34:	00003717          	auipc	a4,0x3
    5d38:	86a73223          	sd	a0,-1948(a4) # 8598 <freep>
      return (void*)(p + 1);
    ...
    5d58:	bff1                	j	5d34 <malloc+0x86>
  hp->s.size = nu;
    5d5a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d5e:	0541                	addi	a0,a0,16
    5d60:	00000097          	auipc	ra,0x0
    5d64:	ec6080e7          	jalr	-314(ra) # 5c26 <free>
  return freep;
    5d68:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d6c:	d971                	beqz	a0,5d40 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d6e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d70:	4798                	lw	a4,8(a5)
    5d72:	fa9776e3          	bgeu	a4,s1,5d1e <malloc+0x70>
    if(p == freep)
    5d76:	00093703          	ld	a4,0(s2)
    5d7a:	853e                	mv	a0,a5
    5d7c:	fef719e3          	bne	a4,a5,5d6e <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5d80:	8552                	mv	a0,s4
    5d82:	00000097          	auipc	ra,0x0
    5d86:	b6e080e7          	jalr	-1170(ra) # 58f0 <sbrk>
  if(p == (char*)-1)
    5d8a:	fd5518e3          	bne	a0,s5,5d5a <malloc+0xac>
        return 0;
    5d8e:	4501                	li	a0,0
    5d90:	bf45                	j	5d40 <malloc+0x92>
