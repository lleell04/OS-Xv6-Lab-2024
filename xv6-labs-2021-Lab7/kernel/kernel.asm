...
0000000080000000 <_entry>:
    ...
    80000016:	6f6060ef          	jal	ra,8000670c <start>
...
kfree(void *pa)
{
  ...
  release(&kmem.lock);
    ...
    8000008e:	b32080e7          	jalr	-1230(ra) # 80006bbc <panic>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000348:	ed4080e7          	jalr	-300(ra) # 80007218 <lockfree_read4>
    ...
    80000368:	8a2080e7          	jalr	-1886(ra) # 80006c06 <printf>
  ...
  scheduler();        
    ...
    80000430:	1e0080e7          	jalr	480(ra) # 8000660c <pci_init>
    sockinit();
    80000434:	00006097          	auipc	ra,0x6
    80000438:	dce080e7          	jalr	-562(ra) # 80006202 <sockinit>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800004aa:	716080e7          	jalr	1814(ra) # 80006bbc <panic>
...
0000000080000600 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000062c:	594080e7          	jalr	1428(ra) # 80006bbc <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    800008ca:	2f6080e7          	jalr	758(ra) # 80006bbc <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    80000a0c:	1b4080e7          	jalr	436(ra) # 80006bbc <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b62:	05e080e7          	jalr	94(ra) # 80006bbc <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dc2:	dfe080e7          	jalr	-514(ra) # 80006bbc <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000dee:	28c080e7          	jalr	652(ra) # 80007076 <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000e06:	274080e7          	jalr	628(ra) # 80007076 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e3c:	23e080e7          	jalr	574(ra) # 80007076 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000eae:	210080e7          	jalr	528(ra) # 800070ba <push_off>
  ...
  pop_off();
    ...
    80000ec8:	296080e7          	jalr	662(ra) # 8000715a <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000eec:	2d2080e7          	jalr	722(ra) # 800071ba <release>
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000f38:	1d2080e7          	jalr	466(ra) # 80007106 <acquire>
  pid = nextpid;
  ...
  release(&pid_lock);
    ...
    80000f52:	26c080e7          	jalr	620(ra) # 800071ba <release>
}
...
00000000800010aa <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800010cc:	03e080e7          	jalr	62(ra) # 80007106 <acquire>
    if(p->state == UNUSED) {
    ...
    800010da:	0e4080e7          	jalr	228(ra) # 800071ba <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    80001158:	066080e7          	jalr	102(ra) # 800071ba <release>
    return 0;
    ...
    80001170:	04e080e7          	jalr	78(ra) # 800071ba <release>
    return 0;
...
0000000080001178 <userinit>:
{
  ...
  release(&p->lock);
    ...
    800011ec:	fd2080e7          	jalr	-46(ra) # 800071ba <release>
}
...
000000008000126e <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  release(&np->lock);
    ...
    80001356:	e68080e7          	jalr	-408(ra) # 800071ba <release>
  acquire(&wait_lock);
    ...
    80001368:	da2080e7          	jalr	-606(ra) # 80007106 <acquire>
  np->parent = p;
    8000136c:	0329bc23          	sd	s2,56(s3)
  release(&wait_lock);
    80001370:	8526                	mv	a0,s1
    80001372:	00006097          	auipc	ra,0x6
    80001376:	e48080e7          	jalr	-440(ra) # 800071ba <release>
  acquire(&np->lock);
    8000137a:	854e                	mv	a0,s3
    8000137c:	00006097          	auipc	ra,0x6
    80001380:	d8a080e7          	jalr	-630(ra) # 80007106 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001390:	e2e080e7          	jalr	-466(ra) # 800071ba <release>
}
...
00000000800013aa <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000142c:	d92080e7          	jalr	-622(ra) # 800071ba <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000143e:	ccc080e7          	jalr	-820(ra) # 80007106 <acquire>
      if(p->state == RUNNABLE) {
...
000000008000144a <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    80001466:	c2a080e7          	jalr	-982(ra) # 8000708c <holding>
...
0000000080001520 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    80001538:	bd2080e7          	jalr	-1070(ra) # 80007106 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    8000154e:	c70080e7          	jalr	-912(ra) # 800071ba <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    8000157c:	b8e080e7          	jalr	-1138(ra) # 80007106 <acquire>
  release(lk);
    80001580:	854a                	mv	a0,s2
    80001582:	00006097          	auipc	ra,0x6
    80001586:	c38080e7          	jalr	-968(ra) # 800071ba <release>
  ...
  release(&p->lock);
    ...
    800015a4:	c1a080e7          	jalr	-998(ra) # 800071ba <release>
  acquire(lk);
    800015a8:	854a                	mv	a0,s2
    800015aa:	00006097          	auipc	ra,0x6
    800015ae:	b5c080e7          	jalr	-1188(ra) # 80007106 <acquire>
}
...
00000000800015c0 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015f0:	b1a080e7          	jalr	-1254(ra) # 80007106 <acquire>
    havekids = 0;
    ...
    8000168e:	a7c080e7          	jalr	-1412(ra) # 80007106 <acquire>
        if(np->state == ZOMBIE){
    ...
    8000169e:	b20080e7          	jalr	-1248(ra) # 800071ba <release>
        havekids = 1;
    ...
    800016ba:	b04080e7          	jalr	-1276(ra) # 800071ba <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000171c:	aa2080e7          	jalr	-1374(ra) # 800071ba <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000173a:	9d0080e7          	jalr	-1584(ra) # 80007106 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
00000000800017b8 <exit>:
{
  ...
  if(p == initproc)
    ...
    800017f4:	3cc080e7          	jalr	972(ra) # 80006bbc <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    8000183e:	8cc080e7          	jalr	-1844(ra) # 80007106 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    8000185e:	8ac080e7          	jalr	-1876(ra) # 80007106 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    80001872:	94c080e7          	jalr	-1716(ra) # 800071ba <release>
  sched();
  ...
  panic("zombie exit");
    ...
    8000188a:	336080e7          	jalr	822(ra) # 80006bbc <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800018b4:	856080e7          	jalr	-1962(ra) # 80007106 <acquire>
    if(p->pid == pid){
    ...
    800018c4:	8fa080e7          	jalr	-1798(ra) # 800071ba <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    800018e6:	8d8080e7          	jalr	-1832(ra) # 800071ba <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800019ce:	23c080e7          	jalr	572(ra) # 80006c06 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a10:	1fa080e7          	jalr	506(ra) # 80006c06 <printf>
    printf("\n");
    80001a14:	8552                	mv	a0,s4
    80001a16:	00005097          	auipc	ra,0x5
    80001a1a:	1f0080e7          	jalr	496(ra) # 80006c06 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001ae0:	59a080e7          	jalr	1434(ra) # 80007076 <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bba:	550080e7          	jalr	1360(ra) # 80007106 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001bda:	5e4080e7          	jalr	1508(ra) # 800071ba <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c4a:	fc0080e7          	jalr	-64(ra) # 80006c06 <printf>
    80001c4e:	a029                	j	80001c58 <devintr+0x70>
      uartintr();
    80001c50:	00005097          	auipc	ra,0x5
    80001c54:	3d6080e7          	jalr	982(ra) # 80007026 <uartintr>
      plic_complete(irq);
...
0000000080001c9c <usertrap>:
{
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001cee:	52e080e7          	jalr	1326(ra) # 80007218 <lockfree_read4>
    ...
    80001d02:	ebe080e7          	jalr	-322(ra) # 80006bbc <panic>
    if(lockfree_read4(&p->killed))
    80001d06:	02850513          	addi	a0,a0,40
    80001d0a:	00005097          	auipc	ra,0x5
    80001d0e:	50e080e7          	jalr	1294(ra) # 80007218 <lockfree_read4>
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d38:	4e4080e7          	jalr	1252(ra) # 80007218 <lockfree_read4>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001d82:	e88080e7          	jalr	-376(ra) # 80006c06 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d9a:	e70080e7          	jalr	-400(ra) # 80006c06 <printf>
    p->killed = 1;
...
0000000080001dae <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e08:	db8080e7          	jalr	-584(ra) # 80006bbc <panic>
    ...
    80001e18:	da8080e7          	jalr	-600(ra) # 80006bbc <panic>
    printf("scause %p\n", scause);
    ...
    80001e2a:	de0080e7          	jalr	-544(ra) # 80006c06 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001ede:	ce2080e7          	jalr	-798(ra) # 80006bbc <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002046:	bc4080e7          	jalr	-1084(ra) # 80006c06 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    8000216c:	f9e080e7          	jalr	-98(ra) # 80007106 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021c0:	ffe080e7          	jalr	-2(ra) # 800071ba <release>
  return 0;
    ...
    800021e2:	fdc080e7          	jalr	-36(ra) # 800071ba <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002232:	ed8080e7          	jalr	-296(ra) # 80007106 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    8000224a:	f74080e7          	jalr	-140(ra) # 800071ba <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002282:	df8080e7          	jalr	-520(ra) # 80007076 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000230a:	e00080e7          	jalr	-512(ra) # 80007106 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000234a:	e74080e7          	jalr	-396(ra) # 800071ba <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002388:	838080e7          	jalr	-1992(ra) # 80006bbc <panic>
      b->dev = dev;
    ...
    800023a8:	e16080e7          	jalr	-490(ra) # 800071ba <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002418:	7a8080e7          	jalr	1960(ra) # 80006bbc <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002450:	cba080e7          	jalr	-838(ra) # 80007106 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000249a:	d24080e7          	jalr	-732(ra) # 800071ba <release>
}
    ...
    800024b6:	70a080e7          	jalr	1802(ra) # 80006bbc <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024d2:	c38080e7          	jalr	-968(ra) # 80007106 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    800024e8:	cd6080e7          	jalr	-810(ra) # 800071ba <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000250e:	bfc080e7          	jalr	-1028(ra) # 80007106 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002524:	c9a080e7          	jalr	-870(ra) # 800071ba <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    800025aa:	616080e7          	jalr	1558(ra) # 80006bbc <panic>
...
00000000800025ae <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    80002670:	550080e7          	jalr	1360(ra) # 80006bbc <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027b6:	40a080e7          	jalr	1034(ra) # 80006bbc <panic>
...
00000000800027ba <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    800027da:	930080e7          	jalr	-1744(ra) # 80007106 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002820:	99e080e7          	jalr	-1634(ra) # 800071ba <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    80002850:	96e080e7          	jalr	-1682(ra) # 800071ba <release>
}
    ...
    80002872:	34e080e7          	jalr	846(ra) # 80006bbc <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    800028f2:	2ce080e7          	jalr	718(ra) # 80006bbc <panic>
...
00000000800028f6 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002918:	762080e7          	jalr	1890(ra) # 80007076 <initlock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002956 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    800029d6:	1ea080e7          	jalr	490(ra) # 80006bbc <panic>
...
0000000080002ab0 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002ac8:	642080e7          	jalr	1602(ra) # 80007106 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002ade:	6e0080e7          	jalr	1760(ra) # 800071ba <release>
}
...
0000000080002aee <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b2a:	096080e7          	jalr	150(ra) # 80006bbc <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002bac:	014080e7          	jalr	20(ra) # 80006bbc <panic>
...
0000000080002bb0 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002bf8:	fc8080e7          	jalr	-56(ra) # 80006bbc <panic>
...
0000000080002ca8 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002cc2:	448080e7          	jalr	1096(ra) # 80007106 <acquire>
  ...
  release(&itable.lock);
    ...
    80002ce0:	4de080e7          	jalr	1246(ra) # 800071ba <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002d14:	4aa080e7          	jalr	1194(ra) # 800071ba <release>
    itrunc(ip);
    ...
    80002d4a:	3c0080e7          	jalr	960(ra) # 80007106 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003008:	bb8080e7          	jalr	-1096(ra) # 80006bbc <panic>
    ...
    80003018:	ba8080e7          	jalr	-1112(ra) # 80006bbc <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
000000008000341c <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003444:	c36080e7          	jalr	-970(ra) # 80007076 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800034d8:	c32080e7          	jalr	-974(ra) # 80007106 <acquire>
  while(1){
    if(log.committing){
    ...
    80003530:	c8e080e7          	jalr	-882(ra) # 800071ba <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003560:	baa080e7          	jalr	-1110(ra) # 80007106 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    80003588:	c36080e7          	jalr	-970(ra) # 800071ba <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800035a0:	b6a080e7          	jalr	-1174(ra) # 80007106 <acquire>
    log.committing = 0;
    ...
    800035b8:	c06080e7          	jalr	-1018(ra) # 800071ba <release>
}
    ...
    800035da:	5e6080e7          	jalr	1510(ra) # 80006bbc <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    800035f6:	bc8080e7          	jalr	-1080(ra) # 800071ba <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800036b4:	a56080e7          	jalr	-1450(ra) # 80007106 <acquire>
  ...
  release(&log.lock);
    ...
    8000376e:	a50080e7          	jalr	-1456(ra) # 800071ba <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    8000379c:	8de080e7          	jalr	-1826(ra) # 80007076 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800037d0:	93a080e7          	jalr	-1734(ra) # 80007106 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800037fe:	9c0080e7          	jalr	-1600(ra) # 800071ba <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003826:	8e4080e7          	jalr	-1820(ra) # 80007106 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    80003842:	97c080e7          	jalr	-1668(ra) # 800071ba <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000386c:	89e080e7          	jalr	-1890(ra) # 80007106 <acquire>
  ...
  release(&lk->lk);
    ...
    8000387c:	942080e7          	jalr	-1726(ra) # 800071ba <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800038c4:	7b6080e7          	jalr	1974(ra) # 80007076 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800038e6:	824080e7          	jalr	-2012(ra) # 80007106 <acquire>
  ...
  release(&ftable.lock);
    ...
    80003912:	8ac080e7          	jalr	-1876(ra) # 800071ba <release>
  return 0;
    ...
    8000392a:	894080e7          	jalr	-1900(ra) # 800071ba <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003952:	7b8080e7          	jalr	1976(ra) # 80007106 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    8000396c:	852080e7          	jalr	-1966(ra) # 800071ba <release>
  return f;
}
    ...
    80003988:	238080e7          	jalr	568(ra) # 80006bbc <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800039ae:	75c080e7          	jalr	1884(ra) # 80007106 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800039ec:	7d2080e7          	jalr	2002(ra) # 800071ba <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003a0c:	948080e7          	jalr	-1720(ra) # 80006350 <sockclose>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b1c:	8c8080e7          	jalr	-1848(ra) # 800063e0 <sockread>
  ...
  return r;
    ...
    80003ba8:	018080e7          	jalr	24(ra) # 80006bbc <panic>
    return -1;
    ...
    80003bbc:	12078263          	beqz	a5,80003ce0 <filewrite+0x128>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003bfe:	8b6080e7          	jalr	-1866(ra) # 800064b0 <sockwrite>
  else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80003cdc:	ee4080e7          	jalr	-284(ra) # 80006bbc <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003d4c:	32e080e7          	jalr	814(ra) # 80007076 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003dda:	330080e7          	jalr	816(ra) # 80007106 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003dfe:	3c0080e7          	jalr	960(ra) # 800071ba <release>
    kfree((char*)pi);
    ...
    80003e30:	38e080e7          	jalr	910(ra) # 800071ba <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003e66:	2a4080e7          	jalr	676(ra) # 80007106 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003e84:	33a080e7          	jalr	826(ra) # 800071ba <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003f26:	298080e7          	jalr	664(ra) # 800071ba <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f5c:	1ae080e7          	jalr	430(ra) # 80007106 <acquire>
  ...
  release(&pi->lock);
    ...
    80003ff0:	1ce080e7          	jalr	462(ra) # 800071ba <release>
  return i;
}
    ...
    80004010:	1ae080e7          	jalr	430(ra) # 800071ba <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004118:	aa8080e7          	jalr	-1368(ra) # 80006bbc <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    8000454a:	676080e7          	jalr	1654(ra) # 80006bbc <panic>
    dp->nlink++;  // for ".."
...
00000000800048b8 <sys_unlink>:
{
  ...
  return 0;
    ...
    800049e4:	1dc080e7          	jalr	476(ra) # 80006bbc <panic>
...
sys_connect(void)
{
  ...
  if(sockalloc(&f, raddr, lport, rport) < 0)
    ...
    80005022:	20c080e7          	jalr	524(ra) # 8000622a <sockalloc>
...
000000008000527c <virtio_disk_init>:
{
  ...
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
  ...
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    ...
    8000539c:	824080e7          	jalr	-2012(ra) # 80006bbc <panic>
    ...
    800053ac:	814080e7          	jalr	-2028(ra) # 80006bbc <panic>
    ...
    800053bc:	804080e7          	jalr	-2044(ra) # 80006bbc <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800053fa:	d10080e7          	jalr	-752(ra) # 80007106 <acquire>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    80005634:	b8a080e7          	jalr	-1142(ra) # 800071ba <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800056ae:	a5c080e7          	jalr	-1444(ra) # 80007106 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005740:	a7e080e7          	jalr	-1410(ra) # 800071ba <release>
}
    ...
    8000575c:	464080e7          	jalr	1124(ra) # 80006bbc <panic>
...
e1000_init(uint32 *xregs)
{
  ...
  initlock(&e1000_lock, "e1000");
    ...
    80005784:	8f6080e7          	jalr	-1802(ra) # 80007076 <initlock>
  ...
  for (i = 0; i < RX_RING_SIZE; i++) {
    ...
    8000583e:	40a080e7          	jalr	1034(ra) # 80005c44 <mbufalloc>
  ...
  regs[E1000_IMS] = (1 << 7); // RXDW -- Receiver Descriptor Write Back
    ...
    80005900:	2c0080e7          	jalr	704(ra) # 80006bbc <panic>
...
e1000_transmit(struct mbuf *m)
{
  ...
  acquire(&e1000_lock);
    ...
    80005922:	7e8080e7          	jalr	2024(ra) # 80007106 <acquire>
  // 查询ring里下一个packet的下标
  ...
  if (tx_mbufs[idx])
    ...
    8000595e:	342080e7          	jalr	834(ra) # 80005c9c <mbuffree>

  // 把这个新的网络包的pointer塞到ring这个下标位置
  tx_mbufs[idx] = m;
    80005962:	00019517          	auipc	a0,0x19
    80005966:	69e50513          	addi	a0,a0,1694 # 8001f000 <e1000_lock>
    8000596a:	00349793          	slli	a5,s1,0x3
    8000596e:	97aa                	add	a5,a5,a0
    80005970:	1327b023          	sd	s2,288(a5)
  tx_ring[idx].length = m->len;
    80005974:	00449793          	slli	a5,s1,0x4
    80005978:	97aa                	add	a5,a5,a0
    8000597a:	01092703          	lw	a4,16(s2)
    8000597e:	02e79423          	sh	a4,40(a5)
  tx_ring[idx].addr = (uint64) m->head;
    80005982:	00893703          	ld	a4,8(s2)
    80005986:	f398                	sd	a4,32(a5)
  tx_ring[idx].cmd = E1000_TXD_CMD_RS | E1000_TXD_CMD_EOP;
    80005988:	4725                	li	a4,9
    8000598a:	02e785a3          	sb	a4,43(a5)
  ...
  release(&e1000_lock);
    ...
    800059b2:	80c080e7          	jalr	-2036(ra) # 800071ba <release>
  ...
  return 0;
    ...
    800059d2:	7ec080e7          	jalr	2028(ra) # 800071ba <release>
    return -1;
...
e1000_intr(void)
{
    ...
    800059ea:	e05a                	sd	s6,0(sp)
    800059ec:	0080                	addi	s0,sp,64
  // tell the e1000 we've seen this interrupt;
  // without this the e1000 won't raise any
  // further interrupts.
  regs[E1000_ICR] = 0xffffffff;
    800059ee:	00004797          	auipc	a5,0x4
    800059f2:	6327b783          	ld	a5,1586(a5) # 8000a020 <regs>
    800059f6:	577d                	li	a4,-1
    800059f8:	0ce7a023          	sw	a4,192(a5)
    int idx = (regs[E1000_RDT] + 1) % RX_RING_SIZE;
    800059fc:	670d                	lui	a4,0x3
    800059fe:	97ba                	add	a5,a5,a4
    80005a00:	8187a483          	lw	s1,-2024(a5)
    80005a04:	2485                	addiw	s1,s1,1
    80005a06:	88bd                	andi	s1,s1,15
    if ((rx_ring[idx].status & E1000_RXD_STAT_DD) == 0) {
    80005a08:	00449713          	slli	a4,s1,0x4
    80005a0c:	00019797          	auipc	a5,0x19
    80005a10:	5f478793          	addi	a5,a5,1524 # 8001f000 <e1000_lock>
    80005a14:	97ba                	add	a5,a5,a4
    80005a16:	1ac7c783          	lbu	a5,428(a5)
    80005a1a:	8b85                	andi	a5,a5,1
    80005a1c:	cba5                	beqz	a5,80005a8c <e1000_intr+0xb2>
    rx_mbufs[idx]->len = rx_ring[idx].length;
    80005a1e:	00019a17          	auipc	s4,0x19
    80005a22:	5e2a0a13          	addi	s4,s4,1506 # 8001f000 <e1000_lock>
    regs[E1000_RDT] = idx;
    80005a26:	00004b17          	auipc	s6,0x4
    80005a2a:	5fab0b13          	addi	s6,s6,1530 # 8000a020 <regs>
    80005a2e:	6a8d                	lui	s5,0x3
    rx_mbufs[idx]->len = rx_ring[idx].length;
    80005a30:	00349993          	slli	s3,s1,0x3
    80005a34:	99d2                	add	s3,s3,s4
    80005a36:	2a09b783          	ld	a5,672(s3)
    80005a3a:	00449913          	slli	s2,s1,0x4
    80005a3e:	9952                	add	s2,s2,s4
    80005a40:	1a895703          	lhu	a4,424(s2)
    80005a44:	cb98                	sw	a4,16(a5)
    net_rx(rx_mbufs[idx]);
    80005a46:	2a09b503          	ld	a0,672(s3)
    80005a4a:	00000097          	auipc	ra,0x0
    80005a4e:	3c6080e7          	jalr	966(ra) # 80005e10 <net_rx>
    rx_mbufs[idx] = mbufalloc(0);
    80005a52:	4501                	li	a0,0
    80005a54:	00000097          	auipc	ra,0x0
    80005a58:	1f0080e7          	jalr	496(ra) # 80005c44 <mbufalloc>
    80005a5c:	2aa9b023          	sd	a0,672(s3)
    rx_ring[idx].status = 0;
    80005a60:	1a090623          	sb	zero,428(s2)
    rx_ring[idx].addr = (uint64)rx_mbufs[idx]->head;
    80005a64:	651c                	ld	a5,8(a0)
    80005a66:	1af93023          	sd	a5,416(s2)
    regs[E1000_RDT] = idx;
    80005a6a:	000b3783          	ld	a5,0(s6)
    80005a6e:	2481                	sext.w	s1,s1
    80005a70:	97d6                	add	a5,a5,s5
    80005a72:	8097ac23          	sw	s1,-2024(a5)
    int idx = (regs[E1000_RDT] + 1) % RX_RING_SIZE;
    80005a76:	8187a483          	lw	s1,-2024(a5)
    80005a7a:	2485                	addiw	s1,s1,1
    80005a7c:	88bd                	andi	s1,s1,15
    if ((rx_ring[idx].status & E1000_RXD_STAT_DD) == 0) {
    80005a7e:	00449793          	slli	a5,s1,0x4
    80005a82:	97d2                	add	a5,a5,s4
    80005a84:	1ac7c783          	lbu	a5,428(a5)
    80005a88:	8b85                	andi	a5,a5,1
    80005a8a:	f3dd                	bnez	a5,80005a30 <e1000_intr+0x56>

  e1000_recv();
}
    80005a8c:	70e2                	ld	ra,56(sp)
    80005a8e:	7442                	ld	s0,48(sp)
    80005a90:	74a2                	ld	s1,40(sp)
    80005a92:	7902                	ld	s2,32(sp)
    80005a94:	69e2                	ld	s3,24(sp)
    80005a96:	6a42                	ld	s4,16(sp)
    80005a98:	6aa2                	ld	s5,8(sp)
    80005a9a:	6b02                	ld	s6,0(sp)
    80005a9c:	6121                	addi	sp,sp,64
    80005a9e:	8082                	ret

0000000080005aa0 <in_cksum>:
...
in_cksum(const unsigned char *addr, int len)
{
    ...
    80005aa2:	ec22                	sd	s0,24(sp)
    80005aa4:	1000                	addi	s0,sp,32
  int nleft = len;
  const unsigned short *w = (const unsigned short *)addr;
  unsigned int sum = 0;
  unsigned short answer = 0;
    80005aa6:	fe041723          	sh	zero,-18(s0)
  /*
  ...
  while (nleft > 1)  {
    ...
    80005aac:	04b7d963          	bge	a5,a1,80005afe <in_cksum+0x5e>
    80005ab0:	ffe5879b          	addiw	a5,a1,-2
    80005ab4:	0017d61b          	srliw	a2,a5,0x1
    80005ab8:	0017d71b          	srliw	a4,a5,0x1
    80005abc:	0705                	addi	a4,a4,1
    80005abe:	0706                	slli	a4,a4,0x1
    80005ac0:	972a                	add	a4,a4,a0
  unsigned int sum = 0;
    80005ac2:	4781                	li	a5,0
    sum += *w++;
    80005ac4:	0509                	addi	a0,a0,2
    80005ac6:	ffe55683          	lhu	a3,-2(a0)
    80005aca:	9fb5                	addw	a5,a5,a3
  while (nleft > 1)  {
    80005acc:	fee51ce3          	bne	a0,a4,80005ac4 <in_cksum+0x24>
    80005ad0:	35f9                	addiw	a1,a1,-2
    80005ad2:	0016169b          	slliw	a3,a2,0x1
    80005ad6:	9d95                	subw	a1,a1,a3
    nleft -= 2;
  }
  ...
  if (nleft == 1) {
    ...
    80005ada:	02d58563          	beq	a1,a3,80005b04 <in_cksum+0x64>
  ...
  sum = (sum & 0xffff) + (sum >> 16);
    80005ade:	03079513          	slli	a0,a5,0x30
    80005ae2:	9141                	srli	a0,a0,0x30
    80005ae4:	0107d79b          	srliw	a5,a5,0x10
    80005ae8:	9fa9                	addw	a5,a5,a0
  sum += (sum >> 16);
    80005aea:	0107d51b          	srliw	a0,a5,0x10
  /* guaranteed now that the lower 16 bits of sum are correct */

  answer = ~sum; /* truncate to 16 bits */
    80005aee:	9d3d                	addw	a0,a0,a5
    80005af0:	fff54513          	not	a0,a0
  return answer;
}
    80005af4:	1542                	slli	a0,a0,0x30
    80005af6:	9141                	srli	a0,a0,0x30
    80005af8:	6462                	ld	s0,24(sp)
    80005afa:	6105                	addi	sp,sp,32
    80005afc:	8082                	ret
  const unsigned short *w = (const unsigned short *)addr;
    80005afe:	872a                	mv	a4,a0
  unsigned int sum = 0;
    80005b00:	4781                	li	a5,0
    80005b02:	bfd9                	j	80005ad8 <in_cksum+0x38>
    *(unsigned char *)(&answer) = *(const unsigned char *)w;
    80005b04:	00074703          	lbu	a4,0(a4) # 3000 <_entry-0x7fffd000>
    80005b08:	fee40723          	sb	a4,-18(s0)
    sum += answer;
    80005b0c:	fee45703          	lhu	a4,-18(s0)
    80005b10:	9fb9                	addw	a5,a5,a4
    80005b12:	b7f1                	j	80005ade <in_cksum+0x3e>

0000000080005b14 <mbufpull>:
{
    80005b14:	1141                	addi	sp,sp,-16
    80005b16:	e422                	sd	s0,8(sp)
    80005b18:	0800                	addi	s0,sp,16
    80005b1a:	87aa                	mv	a5,a0
  char *tmp = m->head;
    80005b1c:	6508                	ld	a0,8(a0)
  if (m->len < len)
    80005b1e:	4b98                	lw	a4,16(a5)
    80005b20:	00b76b63          	bltu	a4,a1,80005b36 <mbufpull+0x22>
  m->len -= len;
    80005b24:	9f0d                	subw	a4,a4,a1
    80005b26:	cb98                	sw	a4,16(a5)
  m->head += len;
    80005b28:	1582                	slli	a1,a1,0x20
    80005b2a:	9181                	srli	a1,a1,0x20
    80005b2c:	95aa                	add	a1,a1,a0
    80005b2e:	e78c                	sd	a1,8(a5)
}
    80005b30:	6422                	ld	s0,8(sp)
    80005b32:	0141                	addi	sp,sp,16
    80005b34:	8082                	ret
    return 0;
    80005b36:	4501                	li	a0,0
    80005b38:	bfe5                	j	80005b30 <mbufpull+0x1c>

0000000080005b3a <mbufpush>:
{
    80005b3a:	87aa                	mv	a5,a0
  m->head -= len;
    80005b3c:	02059713          	slli	a4,a1,0x20
    80005b40:	9301                	srli	a4,a4,0x20
    80005b42:	6508                	ld	a0,8(a0)
    80005b44:	8d19                	sub	a0,a0,a4
    80005b46:	e788                	sd	a0,8(a5)
  if (m->head < m->buf)
    80005b48:	01478713          	addi	a4,a5,20
    80005b4c:	00e56663          	bltu	a0,a4,80005b58 <mbufpush+0x1e>
  m->len += len;
    80005b50:	4b98                	lw	a4,16(a5)
    80005b52:	9db9                	addw	a1,a1,a4
    80005b54:	cb8c                	sw	a1,16(a5)
}
    80005b56:	8082                	ret
{
    ...
    80005b64:	c8850513          	addi	a0,a0,-888 # 800097e8 <syscalls+0x410>
    80005b68:	00001097          	auipc	ra,0x1
    80005b6c:	054080e7          	jalr	84(ra) # 80006bbc <panic>

0000000080005b70 <net_tx_eth>:
...
net_tx_eth(struct mbuf *m, uint16 ethtype)
{
    ...
    80005b7a:	e44e                	sd	s3,8(sp)
    80005b7c:	1800                	addi	s0,sp,48
    80005b7e:	89aa                	mv	s3,a0
    80005b80:	892e                	mv	s2,a1
  struct eth *ethhdr;

  ethhdr = mbufpushhdr(m, *ethhdr);
    80005b82:	45b9                	li	a1,14
    80005b84:	00000097          	auipc	ra,0x0
    80005b88:	fb6080e7          	jalr	-74(ra) # 80005b3a <mbufpush>
    80005b8c:	84aa                	mv	s1,a0
  memmove(ethhdr->shost, local_mac, ETHADDR_LEN);
    80005b8e:	4619                	li	a2,6
    80005b90:	00004597          	auipc	a1,0x4
    80005b94:	d1058593          	addi	a1,a1,-752 # 800098a0 <local_mac>
    80005b98:	0519                	addi	a0,a0,6
    80005b9a:	ffffa097          	auipc	ra,0xffffa
    80005b9e:	63e080e7          	jalr	1598(ra) # 800001d8 <memmove>
  // In a real networking stack, dhost would be set to the address discovered
  // through ARP. Because we don't support enough of the ARP protocol, set it
  // to broadcast instead.
  memmove(ethhdr->dhost, broadcast_mac, ETHADDR_LEN);
    80005ba2:	4619                	li	a2,6
    80005ba4:	00004597          	auipc	a1,0x4
    80005ba8:	cf458593          	addi	a1,a1,-780 # 80009898 <broadcast_mac>
    80005bac:	8526                	mv	a0,s1
    80005bae:	ffffa097          	auipc	ra,0xffffa
    80005bb2:	62a080e7          	jalr	1578(ra) # 800001d8 <memmove>
// endianness support
//
...
static inline uint16 bswaps(uint16 val)
{
  return (((val & 0x00ffU) << 8) |
    80005bb6:	0089579b          	srliw	a5,s2,0x8
  ethhdr->type = htons(ethtype);
    80005bba:	00f48623          	sb	a5,12(s1)
    80005bbe:	012486a3          	sb	s2,13(s1)
  if (e1000_transmit(m)) {
    80005bc2:	854e                	mv	a0,s3
    80005bc4:	00000097          	auipc	ra,0x0
    80005bc8:	d40080e7          	jalr	-704(ra) # 80005904 <e1000_transmit>
    80005bcc:	e901                	bnez	a0,80005bdc <net_tx_eth+0x6c>
    mbuffree(m);
  }
}
    ...
    80005bd6:	69a2                	ld	s3,8(sp)
    80005bd8:	6145                	addi	sp,sp,48
    80005bda:	8082                	ret
  kfree(m);
    80005bdc:	854e                	mv	a0,s3
    80005bde:	ffffa097          	auipc	ra,0xffffa
    80005be2:	43e080e7          	jalr	1086(ra) # 8000001c <kfree>
}
    80005be6:	b7e5                	j	80005bce <net_tx_eth+0x5e>

0000000080005be8 <mbufput>:
{
    80005be8:	87aa                	mv	a5,a0
  char *tmp = m->head + m->len;
    80005bea:	4918                	lw	a4,16(a0)
    80005bec:	02071693          	slli	a3,a4,0x20
    80005bf0:	9281                	srli	a3,a3,0x20
    80005bf2:	6508                	ld	a0,8(a0)
    80005bf4:	9536                	add	a0,a0,a3
  m->len += len;
    80005bf6:	9f2d                	addw	a4,a4,a1
    80005bf8:	0007069b          	sext.w	a3,a4
    80005bfc:	cb98                	sw	a4,16(a5)
  if (m->len > MBUF_SIZE)
    80005bfe:	6785                	lui	a5,0x1
    80005c00:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    80005c04:	00d7e363          	bltu	a5,a3,80005c0a <mbufput+0x22>
}
    80005c08:	8082                	ret
{
    80005c0a:	1141                	addi	sp,sp,-16
    80005c0c:	e406                	sd	ra,8(sp)
    80005c0e:	e022                	sd	s0,0(sp)
    80005c10:	0800                	addi	s0,sp,16
    panic("mbufput");
    80005c12:	00004517          	auipc	a0,0x4
    80005c16:	be650513          	addi	a0,a0,-1050 # 800097f8 <syscalls+0x420>
    80005c1a:	00001097          	auipc	ra,0x1
    80005c1e:	fa2080e7          	jalr	-94(ra) # 80006bbc <panic>

0000000080005c22 <mbuftrim>:
{
    80005c22:	1141                	addi	sp,sp,-16
    80005c24:	e422                	sd	s0,8(sp)
    80005c26:	0800                	addi	s0,sp,16
  if (len > m->len)
    80005c28:	491c                	lw	a5,16(a0)
    80005c2a:	00b7eb63          	bltu	a5,a1,80005c40 <mbuftrim+0x1e>
  m->len -= len;
    80005c2e:	9f8d                	subw	a5,a5,a1
    80005c30:	c91c                	sw	a5,16(a0)
  return m->head + m->len;
    80005c32:	1782                	slli	a5,a5,0x20
    80005c34:	9381                	srli	a5,a5,0x20
    80005c36:	6508                	ld	a0,8(a0)
    80005c38:	953e                	add	a0,a0,a5
}
    ...
    80005c42:	bfe5                	j	80005c3a <mbuftrim+0x18>

0000000080005c44 <mbufalloc>:
{
  ...
  if (headroom > MBUF_SIZE)
    80005c50:	6785                	lui	a5,0x1
    80005c52:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    return 0;
    80005c56:	4901                	li	s2,0
  if (headroom > MBUF_SIZE)
    80005c58:	02a7eb63          	bltu	a5,a0,80005c8e <mbufalloc+0x4a>
    80005c5c:	84aa                	mv	s1,a0
  m = kalloc();
    80005c5e:	ffffa097          	auipc	ra,0xffffa
    80005c62:	4ba080e7          	jalr	1210(ra) # 80000118 <kalloc>
    80005c66:	892a                	mv	s2,a0
  if (m == 0)
    80005c68:	c11d                	beqz	a0,80005c8e <mbufalloc+0x4a>
  m->next = 0;
    80005c6a:	00053023          	sd	zero,0(a0)
  m->head = (char *)m->buf + headroom;
    80005c6e:	0551                	addi	a0,a0,20
    80005c70:	1482                	slli	s1,s1,0x20
    80005c72:	9081                	srli	s1,s1,0x20
    80005c74:	94aa                	add	s1,s1,a0
    80005c76:	00993423          	sd	s1,8(s2)
  m->len = 0;
    80005c7a:	00092823          	sw	zero,16(s2)
  memset(m->buf, 0, sizeof(m->buf));
    80005c7e:	6605                	lui	a2,0x1
    80005c80:	80060613          	addi	a2,a2,-2048 # 800 <_entry-0x7ffff800>
    80005c84:	4581                	li	a1,0
    80005c86:	ffffa097          	auipc	ra,0xffffa
    80005c8a:	4f2080e7          	jalr	1266(ra) # 80000178 <memset>
}
...
0000000080005c9c <mbuffree>:
{
  ...
  kfree(m);
    80005ca4:	ffffa097          	auipc	ra,0xffffa
    80005ca8:	378080e7          	jalr	888(ra) # 8000001c <kfree>
}
    80005cac:	60a2                	ld	ra,8(sp)
    80005cae:	6402                	ld	s0,0(sp)
    80005cb0:	0141                	addi	sp,sp,16
    80005cb2:	8082                	ret

0000000080005cb4 <mbufq_pushtail>:
{
    80005cb4:	1141                	addi	sp,sp,-16
    80005cb6:	e422                	sd	s0,8(sp)
    80005cb8:	0800                	addi	s0,sp,16
  m->next = 0;
    80005cba:	0005b023          	sd	zero,0(a1)
  if (!q->head){
    80005cbe:	611c                	ld	a5,0(a0)
    80005cc0:	c799                	beqz	a5,80005cce <mbufq_pushtail+0x1a>
  q->tail->next = m;
    80005cc2:	651c                	ld	a5,8(a0)
    80005cc4:	e38c                	sd	a1,0(a5)
  q->tail = m;
    80005cc6:	e50c                	sd	a1,8(a0)
}
    80005cc8:	6422                	ld	s0,8(sp)
    80005cca:	0141                	addi	sp,sp,16
    80005ccc:	8082                	ret
    q->head = q->tail = m;
    80005cce:	e50c                	sd	a1,8(a0)
    80005cd0:	e10c                	sd	a1,0(a0)
    return;
    80005cd2:	bfdd                	j	80005cc8 <mbufq_pushtail+0x14>

0000000080005cd4 <mbufq_pophead>:
{
    80005cd4:	1141                	addi	sp,sp,-16
    80005cd6:	e422                	sd	s0,8(sp)
    80005cd8:	0800                	addi	s0,sp,16
    80005cda:	87aa                	mv	a5,a0
  struct mbuf *head = q->head;
    80005cdc:	6108                	ld	a0,0(a0)
  if (!head)
    80005cde:	c119                	beqz	a0,80005ce4 <mbufq_pophead+0x10>
  q->head = head->next;
    80005ce0:	6118                	ld	a4,0(a0)
    80005ce2:	e398                	sd	a4,0(a5)
}
    80005ce4:	6422                	ld	s0,8(sp)
    80005ce6:	0141                	addi	sp,sp,16
    80005ce8:	8082                	ret

0000000080005cea <mbufq_empty>:
{
    80005cea:	1141                	addi	sp,sp,-16
    80005cec:	e422                	sd	s0,8(sp)
    80005cee:	0800                	addi	s0,sp,16
  return q->head == 0;
    80005cf0:	6108                	ld	a0,0(a0)
}
    80005cf2:	00153513          	seqz	a0,a0
    80005cf6:	6422                	ld	s0,8(sp)
    80005cf8:	0141                	addi	sp,sp,16
    80005cfa:	8082                	ret

0000000080005cfc <mbufq_init>:
{
    80005cfc:	1141                	addi	sp,sp,-16
    80005cfe:	e422                	sd	s0,8(sp)
           ...
           uint16 sport, uint16 dport)
{
    ...
    80005d12:	ec26                	sd	s1,24(sp)
    80005d14:	e84a                	sd	s2,16(sp)
    80005d16:	e44e                	sd	s3,8(sp)
    80005d18:	e052                	sd	s4,0(sp)
    80005d1a:	1800                	addi	s0,sp,48
    80005d1c:	8a2a                	mv	s4,a0
    80005d1e:	892e                	mv	s2,a1
    80005d20:	89b2                	mv	s3,a2
    80005d22:	84b6                	mv	s1,a3
  struct udp *udphdr;

  // put the UDP header
  udphdr = mbufpushhdr(m, *udphdr);
    80005d24:	45a1                	li	a1,8
    80005d26:	00000097          	auipc	ra,0x0
    80005d2a:	e14080e7          	jalr	-492(ra) # 80005b3a <mbufpush>
    80005d2e:	0089d61b          	srliw	a2,s3,0x8
    80005d32:	0089999b          	slliw	s3,s3,0x8
    80005d36:	00c9e9b3          	or	s3,s3,a2
  udphdr->sport = htons(sport);
    80005d3a:	01351023          	sh	s3,0(a0)
    80005d3e:	0084d69b          	srliw	a3,s1,0x8
    80005d42:	0084949b          	slliw	s1,s1,0x8
    80005d46:	8cd5                	or	s1,s1,a3
  udphdr->dport = htons(dport);
    80005d48:	00951123          	sh	s1,2(a0)
  udphdr->ulen = htons(m->len);
    80005d4c:	010a2783          	lw	a5,16(s4)
    80005d50:	0087d713          	srli	a4,a5,0x8
    80005d54:	0087979b          	slliw	a5,a5,0x8
    80005d58:	0ff77713          	andi	a4,a4,255
    80005d5c:	8fd9                	or	a5,a5,a4
    80005d5e:	00f51223          	sh	a5,4(a0)
  udphdr->sum = 0; // zero means no checksum is provided
    80005d62:	00051323          	sh	zero,6(a0)
  iphdr = mbufpushhdr(m, *iphdr);
    80005d66:	45d1                	li	a1,20
    80005d68:	8552                	mv	a0,s4
    80005d6a:	00000097          	auipc	ra,0x0
    80005d6e:	dd0080e7          	jalr	-560(ra) # 80005b3a <mbufpush>
    80005d72:	84aa                	mv	s1,a0
  memset(iphdr, 0, sizeof(*iphdr));
    80005d74:	4651                	li	a2,20
    80005d76:	4581                	li	a1,0
    80005d78:	ffffa097          	auipc	ra,0xffffa
    80005d7c:	400080e7          	jalr	1024(ra) # 80000178 <memset>
  iphdr->ip_vhl = (4 << 4) | (20 >> 2);
    80005d80:	04500793          	li	a5,69
    80005d84:	00f48023          	sb	a5,0(s1)
  iphdr->ip_p = proto;
    80005d88:	47c5                	li	a5,17
    80005d8a:	00f484a3          	sb	a5,9(s1)
  iphdr->ip_src = htonl(local_ip);
    80005d8e:	0f0207b7          	lui	a5,0xf020
    80005d92:	27a9                	addiw	a5,a5,10
    80005d94:	c4dc                	sw	a5,12(s1)
          ((val & 0xff00U) >> 8));
}
...
static inline uint32 bswapl(uint32 val)
{
  return (((val & 0x000000ffUL) << 24) |
    80005d96:	0189179b          	slliw	a5,s2,0x18
          ((val & 0x0000ff00UL) << 8) |
          ((val & 0x00ff0000UL) >> 8) |
          ((val & 0xff000000UL) >> 24));
    80005d9a:	0189571b          	srliw	a4,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005d9e:	8fd9                	or	a5,a5,a4
          ((val & 0x0000ff00UL) << 8) |
    80005da0:	0089171b          	slliw	a4,s2,0x8
    80005da4:	00ff06b7          	lui	a3,0xff0
    80005da8:	8f75                	and	a4,a4,a3
          ((val & 0x00ff0000UL) >> 8) |
    80005daa:	8fd9                	or	a5,a5,a4
    80005dac:	0089591b          	srliw	s2,s2,0x8
    80005db0:	65c1                	lui	a1,0x10
    80005db2:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005db6:	00b97933          	and	s2,s2,a1
    80005dba:	0127e933          	or	s2,a5,s2
  iphdr->ip_dst = htonl(dip);
    80005dbe:	0124a823          	sw	s2,16(s1)
  iphdr->ip_len = htons(m->len);
    80005dc2:	010a2783          	lw	a5,16(s4)
  return (((val & 0x00ffU) << 8) |
    80005dc6:	0087d713          	srli	a4,a5,0x8
    80005dca:	0087979b          	slliw	a5,a5,0x8
    80005dce:	0ff77713          	andi	a4,a4,255
    80005dd2:	8fd9                	or	a5,a5,a4
    80005dd4:	00f49123          	sh	a5,2(s1)
  iphdr->ip_ttl = 100;
    80005dd8:	06400793          	li	a5,100
    80005ddc:	00f48423          	sb	a5,8(s1)
  iphdr->ip_sum = in_cksum((unsigned char *)iphdr, sizeof(*iphdr));
    80005de0:	45d1                	li	a1,20
    80005de2:	8526                	mv	a0,s1
    80005de4:	00000097          	auipc	ra,0x0
    80005de8:	cbc080e7          	jalr	-836(ra) # 80005aa0 <in_cksum>
    80005dec:	00a49523          	sh	a0,10(s1)
  net_tx_eth(m, ETHTYPE_IP);
    80005df0:	6585                	lui	a1,0x1
    80005df2:	80058593          	addi	a1,a1,-2048 # 800 <_entry-0x7ffff800>
    80005df6:	8552                	mv	a0,s4
    80005df8:	00000097          	auipc	ra,0x0
    80005dfc:	d78080e7          	jalr	-648(ra) # 80005b70 <net_tx_eth>

  // now on to the IP layer
  net_tx_ip(m, IPPROTO_UDP, dip);
}
    80005e00:	70a2                	ld	ra,40(sp)
    80005e02:	7402                	ld	s0,32(sp)
    80005e04:	64e2                	ld	s1,24(sp)
    80005e06:	6942                	ld	s2,16(sp)
    80005e08:	69a2                	ld	s3,8(sp)
    80005e0a:	6a02                	ld	s4,0(sp)
    80005e0c:	6145                	addi	sp,sp,48
    80005e0e:	8082                	ret

0000000080005e10 <net_rx>:
}
...
{
    80005e10:	715d                	addi	sp,sp,-80
    80005e12:	e486                	sd	ra,72(sp)
    80005e14:	e0a2                	sd	s0,64(sp)
    80005e16:	fc26                	sd	s1,56(sp)
    80005e18:	f84a                	sd	s2,48(sp)
    80005e1a:	f44e                	sd	s3,40(sp)
    80005e1c:	f052                	sd	s4,32(sp)
    80005e1e:	ec56                	sd	s5,24(sp)
    80005e20:	0880                	addi	s0,sp,80
    80005e22:	84aa                	mv	s1,a0
  struct eth *ethhdr;
  uint16 type;

  ethhdr = mbufpullhdr(m, *ethhdr);
    80005e24:	45b9                	li	a1,14
    80005e26:	00000097          	auipc	ra,0x0
    80005e2a:	cee080e7          	jalr	-786(ra) # 80005b14 <mbufpull>
  if (!ethhdr) {
    80005e2e:	c521                	beqz	a0,80005e76 <net_rx+0x66>
    mbuffree(m);
    return;
  }

  type = ntohs(ethhdr->type);
    80005e30:	00c54783          	lbu	a5,12(a0)
    80005e34:	00d54703          	lbu	a4,13(a0)
    80005e38:	0722                	slli	a4,a4,0x8
    80005e3a:	8fd9                	or	a5,a5,a4
    80005e3c:	0087979b          	slliw	a5,a5,0x8
    80005e40:	8321                	srli	a4,a4,0x8
    80005e42:	8fd9                	or	a5,a5,a4
    80005e44:	17c2                	slli	a5,a5,0x30
    80005e46:	93c1                	srli	a5,a5,0x30
  if (type == ETHTYPE_IP)
    80005e48:	8007871b          	addiw	a4,a5,-2048
    80005e4c:	cb1d                	beqz	a4,80005e82 <net_rx+0x72>
    net_rx_ip(m);
  else if (type == ETHTYPE_ARP)
    80005e4e:	2781                	sext.w	a5,a5
    80005e50:	6705                	lui	a4,0x1
    80005e52:	80670713          	addi	a4,a4,-2042 # 806 <_entry-0x7ffff7fa>
    80005e56:	18e78e63          	beq	a5,a4,80005ff2 <net_rx+0x1e2>
  kfree(m);
    80005e5a:	8526                	mv	a0,s1
    80005e5c:	ffffa097          	auipc	ra,0xffffa
    80005e60:	1c0080e7          	jalr	448(ra) # 8000001c <kfree>
    net_rx_arp(m);
  else
    mbuffree(m);
}
    80005e64:	60a6                	ld	ra,72(sp)
    80005e66:	6406                	ld	s0,64(sp)
    80005e68:	74e2                	ld	s1,56(sp)
    80005e6a:	7942                	ld	s2,48(sp)
    80005e6c:	79a2                	ld	s3,40(sp)
    80005e6e:	7a02                	ld	s4,32(sp)
    80005e70:	6ae2                	ld	s5,24(sp)
    80005e72:	6161                	addi	sp,sp,80
    80005e74:	8082                	ret
  kfree(m);
    80005e76:	8526                	mv	a0,s1
    80005e78:	ffffa097          	auipc	ra,0xffffa
    80005e7c:	1a4080e7          	jalr	420(ra) # 8000001c <kfree>
}
    80005e80:	b7d5                	j	80005e64 <net_rx+0x54>
  iphdr = mbufpullhdr(m, *iphdr);
    80005e82:	45d1                	li	a1,20
    80005e84:	8526                	mv	a0,s1
    80005e86:	00000097          	auipc	ra,0x0
    80005e8a:	c8e080e7          	jalr	-882(ra) # 80005b14 <mbufpull>
    80005e8e:	892a                	mv	s2,a0
  if (!iphdr)
    80005e90:	c519                	beqz	a0,80005e9e <net_rx+0x8e>
  if (iphdr->ip_vhl != ((4 << 4) | (20 >> 2)))
    80005e92:	00054703          	lbu	a4,0(a0)
    80005e96:	04500793          	li	a5,69
    80005e9a:	00f70863          	beq	a4,a5,80005eaa <net_rx+0x9a>
  kfree(m);
    80005e9e:	8526                	mv	a0,s1
    80005ea0:	ffffa097          	auipc	ra,0xffffa
    80005ea4:	17c080e7          	jalr	380(ra) # 8000001c <kfree>
}
    80005ea8:	bf75                	j	80005e64 <net_rx+0x54>
  if (in_cksum((unsigned char *)iphdr, sizeof(*iphdr)))
    80005eaa:	45d1                	li	a1,20
    80005eac:	00000097          	auipc	ra,0x0
    80005eb0:	bf4080e7          	jalr	-1036(ra) # 80005aa0 <in_cksum>
    80005eb4:	f56d                	bnez	a0,80005e9e <net_rx+0x8e>
    80005eb6:	00695783          	lhu	a5,6(s2)
    80005eba:	0087d713          	srli	a4,a5,0x8
    80005ebe:	0087979b          	slliw	a5,a5,0x8
    80005ec2:	0ff77713          	andi	a4,a4,255
    80005ec6:	8fd9                	or	a5,a5,a4
  if (htons(iphdr->ip_off) != 0)
    80005ec8:	17c2                	slli	a5,a5,0x30
    80005eca:	93c1                	srli	a5,a5,0x30
    80005ecc:	fbe9                	bnez	a5,80005e9e <net_rx+0x8e>
  if (htonl(iphdr->ip_dst) != local_ip)
    80005ece:	01092703          	lw	a4,16(s2)
  return (((val & 0x000000ffUL) << 24) |
    80005ed2:	0187179b          	slliw	a5,a4,0x18
          ((val & 0xff000000UL) >> 24));
    80005ed6:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005eda:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80005edc:	0087169b          	slliw	a3,a4,0x8
    80005ee0:	00ff0637          	lui	a2,0xff0
    80005ee4:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80005ee6:	8fd5                	or	a5,a5,a3
    80005ee8:	0087571b          	srliw	a4,a4,0x8
    80005eec:	66c1                	lui	a3,0x10
    80005eee:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80005ef2:	8f75                	and	a4,a4,a3
    80005ef4:	8fd9                	or	a5,a5,a4
    80005ef6:	2781                	sext.w	a5,a5
    80005ef8:	0a000737          	lui	a4,0xa000
    80005efc:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80005f00:	f8e79fe3          	bne	a5,a4,80005e9e <net_rx+0x8e>
  if (iphdr->ip_p != IPPROTO_UDP)
    80005f04:	00994703          	lbu	a4,9(s2)
    80005f08:	47c5                	li	a5,17
    80005f0a:	f8f71ae3          	bne	a4,a5,80005e9e <net_rx+0x8e>
  return (((val & 0x00ffU) << 8) |
    80005f0e:	00295783          	lhu	a5,2(s2)
    80005f12:	0087d713          	srli	a4,a5,0x8
    80005f16:	0087999b          	slliw	s3,a5,0x8
    80005f1a:	0ff77793          	andi	a5,a4,255
    80005f1e:	00f9e9b3          	or	s3,s3,a5
    80005f22:	19c2                	slli	s3,s3,0x30
    80005f24:	0309d993          	srli	s3,s3,0x30
  len = ntohs(iphdr->ip_len) - sizeof(*iphdr);
    80005f28:	fec9879b          	addiw	a5,s3,-20
    80005f2c:	03079a13          	slli	s4,a5,0x30
    80005f30:	030a5a13          	srli	s4,s4,0x30
  udphdr = mbufpullhdr(m, *udphdr);
    80005f34:	45a1                	li	a1,8
    80005f36:	8526                	mv	a0,s1
    80005f38:	00000097          	auipc	ra,0x0
    80005f3c:	bdc080e7          	jalr	-1060(ra) # 80005b14 <mbufpull>
    80005f40:	8aaa                	mv	s5,a0
  if (!udphdr)
    80005f42:	c915                	beqz	a0,80005f76 <net_rx+0x166>
    80005f44:	00455783          	lhu	a5,4(a0)
    80005f48:	0087d713          	srli	a4,a5,0x8
    80005f4c:	0087979b          	slliw	a5,a5,0x8
    80005f50:	0ff77713          	andi	a4,a4,255
    80005f54:	8fd9                	or	a5,a5,a4
  if (ntohs(udphdr->ulen) != len)
    80005f56:	2a01                	sext.w	s4,s4
    80005f58:	17c2                	slli	a5,a5,0x30
    80005f5a:	93c1                	srli	a5,a5,0x30
    80005f5c:	00fa1d63          	bne	s4,a5,80005f76 <net_rx+0x166>
  len -= sizeof(*udphdr);
    80005f60:	fe49879b          	addiw	a5,s3,-28
  if (len > m->len)
    80005f64:	0107979b          	slliw	a5,a5,0x10
    80005f68:	0107d79b          	srliw	a5,a5,0x10
    80005f6c:	0007871b          	sext.w	a4,a5
    80005f70:	488c                	lw	a1,16(s1)
    80005f72:	00e5f863          	bgeu	a1,a4,80005f82 <net_rx+0x172>
  kfree(m);
    80005f76:	8526                	mv	a0,s1
    80005f78:	ffffa097          	auipc	ra,0xffffa
    80005f7c:	0a4080e7          	jalr	164(ra) # 8000001c <kfree>
}
    80005f80:	b5d5                	j	80005e64 <net_rx+0x54>
  mbuftrim(m, m->len - len);
    80005f82:	9d9d                	subw	a1,a1,a5
    80005f84:	8526                	mv	a0,s1
    80005f86:	00000097          	auipc	ra,0x0
    80005f8a:	c9c080e7          	jalr	-868(ra) # 80005c22 <mbuftrim>
  sip = ntohl(iphdr->ip_src);
    80005f8e:	00c92783          	lw	a5,12(s2)
    80005f92:	000ad703          	lhu	a4,0(s5) # 3000 <_entry-0x7fffd000>
    80005f96:	00875693          	srli	a3,a4,0x8
    80005f9a:	0087171b          	slliw	a4,a4,0x8
    80005f9e:	0ff6f693          	andi	a3,a3,255
    80005fa2:	8ed9                	or	a3,a3,a4
    80005fa4:	002ad703          	lhu	a4,2(s5)
    80005fa8:	00875613          	srli	a2,a4,0x8
    80005fac:	0087171b          	slliw	a4,a4,0x8
    80005fb0:	0ff67613          	andi	a2,a2,255
    80005fb4:	8e59                	or	a2,a2,a4
  return (((val & 0x000000ffUL) << 24) |
    80005fb6:	0187971b          	slliw	a4,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80005fba:	0187d59b          	srliw	a1,a5,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005fbe:	8f4d                	or	a4,a4,a1
          ((val & 0x0000ff00UL) << 8) |
    80005fc0:	0087959b          	slliw	a1,a5,0x8
    80005fc4:	00ff0537          	lui	a0,0xff0
    80005fc8:	8de9                	and	a1,a1,a0
          ((val & 0x00ff0000UL) >> 8) |
    80005fca:	8f4d                	or	a4,a4,a1
    80005fcc:	0087d79b          	srliw	a5,a5,0x8
    80005fd0:	65c1                	lui	a1,0x10
    80005fd2:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005fd6:	8fed                	and	a5,a5,a1
    80005fd8:	8fd9                	or	a5,a5,a4
  sockrecvudp(m, sip, dport, sport);
    80005fda:	16c2                	slli	a3,a3,0x30
    80005fdc:	92c1                	srli	a3,a3,0x30
    80005fde:	1642                	slli	a2,a2,0x30
    80005fe0:	9241                	srli	a2,a2,0x30
    80005fe2:	0007859b          	sext.w	a1,a5
    80005fe6:	8526                	mv	a0,s1
    80005fe8:	00000097          	auipc	ra,0x0
    80005fec:	55c080e7          	jalr	1372(ra) # 80006544 <sockrecvudp>
  return;
    80005ff0:	bd95                	j	80005e64 <net_rx+0x54>
  arphdr = mbufpullhdr(m, *arphdr);
    80005ff2:	45f1                	li	a1,28
    80005ff4:	8526                	mv	a0,s1
    80005ff6:	00000097          	auipc	ra,0x0
    80005ffa:	b1e080e7          	jalr	-1250(ra) # 80005b14 <mbufpull>
    80005ffe:	892a                	mv	s2,a0
  if (!arphdr)
    80006000:	c179                	beqz	a0,800060c6 <net_rx+0x2b6>
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006002:	00054783          	lbu	a5,0(a0) # ff0000 <_entry-0x7f010000>
    80006006:	00154703          	lbu	a4,1(a0)
    8000600a:	0722                	slli	a4,a4,0x8
    8000600c:	8fd9                	or	a5,a5,a4
  return (((val & 0x00ffU) << 8) |
    8000600e:	0087979b          	slliw	a5,a5,0x8
    80006012:	8321                	srli	a4,a4,0x8
    80006014:	8fd9                	or	a5,a5,a4
    80006016:	17c2                	slli	a5,a5,0x30
    80006018:	93c1                	srli	a5,a5,0x30
    8000601a:	4705                	li	a4,1
    8000601c:	0ae79563          	bne	a5,a4,800060c6 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006020:	00254783          	lbu	a5,2(a0)
    80006024:	00354703          	lbu	a4,3(a0)
    80006028:	0722                	slli	a4,a4,0x8
    8000602a:	8fd9                	or	a5,a5,a4
    8000602c:	0087979b          	slliw	a5,a5,0x8
    80006030:	8321                	srli	a4,a4,0x8
    80006032:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006034:	0107979b          	slliw	a5,a5,0x10
    80006038:	0107d79b          	srliw	a5,a5,0x10
    8000603c:	8007879b          	addiw	a5,a5,-2048
    80006040:	e3d9                	bnez	a5,800060c6 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006042:	00454703          	lbu	a4,4(a0)
    80006046:	4799                	li	a5,6
    80006048:	06f71f63          	bne	a4,a5,800060c6 <net_rx+0x2b6>
      arphdr->hln != ETHADDR_LEN ||
    8000604c:	00554703          	lbu	a4,5(a0)
    80006050:	4791                	li	a5,4
    80006052:	06f71a63          	bne	a4,a5,800060c6 <net_rx+0x2b6>
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    80006056:	00654783          	lbu	a5,6(a0)
    8000605a:	00754703          	lbu	a4,7(a0)
    ...
    80006070:	04e79b63          	bne	a5,a4,800060c6 <net_rx+0x2b6>
  tip = ntohl(arphdr->tip); // target IP address
    80006074:	01854783          	lbu	a5,24(a0)
    80006078:	01954703          	lbu	a4,25(a0)
    8000607c:	0722                	slli	a4,a4,0x8
    8000607e:	8f5d                	or	a4,a4,a5
    80006080:	01a54783          	lbu	a5,26(a0)
    80006084:	07c2                	slli	a5,a5,0x10
    80006086:	8f5d                	or	a4,a4,a5
    80006088:	01b54783          	lbu	a5,27(a0)
    8000608c:	07e2                	slli	a5,a5,0x18
    8000608e:	8fd9                	or	a5,a5,a4
    80006090:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    80006094:	0187979b          	slliw	a5,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006098:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000609c:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    8000609e:	0087169b          	slliw	a3,a4,0x8
    800060a2:	00ff0637          	lui	a2,0xff0
    800060a6:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    800060a8:	8fd5                	or	a5,a5,a3
    800060aa:	0087571b          	srliw	a4,a4,0x8
    800060ae:	66c1                	lui	a3,0x10
    800060b0:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    800060b4:	8f75                	and	a4,a4,a3
    800060b6:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    800060b8:	2781                	sext.w	a5,a5
    800060ba:	0a000737          	lui	a4,0xa000
    800060be:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    800060c2:	00e78863          	beq	a5,a4,800060d2 <net_rx+0x2c2>
  kfree(m);
    800060c6:	8526                	mv	a0,s1
    800060c8:	ffffa097          	auipc	ra,0xffffa
    800060cc:	f54080e7          	jalr	-172(ra) # 8000001c <kfree>
}
    800060d0:	bb51                	j	80005e64 <net_rx+0x54>
  memmove(smac, arphdr->sha, ETHADDR_LEN); // sender's ethernet address
    800060d2:	4619                	li	a2,6
    800060d4:	00850593          	addi	a1,a0,8
    800060d8:	fb840513          	addi	a0,s0,-72
    800060dc:	ffffa097          	auipc	ra,0xffffa
    800060e0:	0fc080e7          	jalr	252(ra) # 800001d8 <memmove>
  sip = ntohl(arphdr->sip); // sender's IP address (qemu's slirp)
    800060e4:	00e94783          	lbu	a5,14(s2)
    800060e8:	00f94703          	lbu	a4,15(s2)
    800060ec:	0722                	slli	a4,a4,0x8
    800060ee:	8f5d                	or	a4,a4,a5
    800060f0:	01094783          	lbu	a5,16(s2)
    800060f4:	07c2                	slli	a5,a5,0x10
    800060f6:	8f5d                	or	a4,a4,a5
    800060f8:	01194783          	lbu	a5,17(s2)
    800060fc:	07e2                	slli	a5,a5,0x18
    800060fe:	8fd9                	or	a5,a5,a4
    80006100:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    80006104:	0187991b          	slliw	s2,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006108:	0187579b          	srliw	a5,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000610c:	00f96933          	or	s2,s2,a5
          ((val & 0x0000ff00UL) << 8) |
    80006110:	0087179b          	slliw	a5,a4,0x8
    80006114:	00ff06b7          	lui	a3,0xff0
    80006118:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    8000611a:	00f96933          	or	s2,s2,a5
    8000611e:	0087579b          	srliw	a5,a4,0x8
    80006122:	6741                	lui	a4,0x10
    80006124:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    80006128:	8ff9                	and	a5,a5,a4
    8000612a:	00f96933          	or	s2,s2,a5
    8000612e:	2901                	sext.w	s2,s2
  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006130:	08000513          	li	a0,128
    80006134:	00000097          	auipc	ra,0x0
    80006138:	b10080e7          	jalr	-1264(ra) # 80005c44 <mbufalloc>
    8000613c:	8a2a                	mv	s4,a0
  if (!m)
    8000613e:	d541                	beqz	a0,800060c6 <net_rx+0x2b6>
  arphdr = mbufputhdr(m, *arphdr);
    80006140:	45f1                	li	a1,28
    80006142:	00000097          	auipc	ra,0x0
    80006146:	aa6080e7          	jalr	-1370(ra) # 80005be8 <mbufput>
    8000614a:	89aa                	mv	s3,a0
  arphdr->hrd = htons(ARP_HRD_ETHER);
    8000614c:	00050023          	sb	zero,0(a0)
    80006150:	4785                	li	a5,1
    80006152:	00f500a3          	sb	a5,1(a0)
  arphdr->pro = htons(ETHTYPE_IP);
    80006156:	47a1                	li	a5,8
    80006158:	00f50123          	sb	a5,2(a0)
    8000615c:	000501a3          	sb	zero,3(a0)
  arphdr->hln = ETHADDR_LEN;
    80006160:	4799                	li	a5,6
    80006162:	00f50223          	sb	a5,4(a0)
  arphdr->pln = sizeof(uint32);
    80006166:	4791                	li	a5,4
    80006168:	00f502a3          	sb	a5,5(a0)
  arphdr->op = htons(op);
    8000616c:	00050323          	sb	zero,6(a0)
    80006170:	4a89                	li	s5,2
    80006172:	015503a3          	sb	s5,7(a0)
  memmove(arphdr->sha, local_mac, ETHADDR_LEN);
    80006176:	4619                	li	a2,6
    80006178:	00003597          	auipc	a1,0x3
    8000617c:	72858593          	addi	a1,a1,1832 # 800098a0 <local_mac>
    80006180:	0521                	addi	a0,a0,8
    80006182:	ffffa097          	auipc	ra,0xffffa
    80006186:	056080e7          	jalr	86(ra) # 800001d8 <memmove>
  arphdr->sip = htonl(local_ip);
    8000618a:	47a9                	li	a5,10
    8000618c:	00f98723          	sb	a5,14(s3)
    80006190:	000987a3          	sb	zero,15(s3)
    80006194:	01598823          	sb	s5,16(s3)
    80006198:	47bd                	li	a5,15
    8000619a:	00f988a3          	sb	a5,17(s3)
  memmove(arphdr->tha, dmac, ETHADDR_LEN);
    8000619e:	4619                	li	a2,6
    800061a0:	fb840593          	addi	a1,s0,-72
    800061a4:	01298513          	addi	a0,s3,18
    800061a8:	ffffa097          	auipc	ra,0xffffa
    800061ac:	030080e7          	jalr	48(ra) # 800001d8 <memmove>
  return (((val & 0x000000ffUL) << 24) |
    800061b0:	0189171b          	slliw	a4,s2,0x18
          ((val & 0xff000000UL) >> 24));
    800061b4:	0189579b          	srliw	a5,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800061b8:	8f5d                	or	a4,a4,a5
          ((val & 0x0000ff00UL) << 8) |
    800061ba:	0089179b          	slliw	a5,s2,0x8
    800061be:	00ff06b7          	lui	a3,0xff0
    800061c2:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    800061c4:	8f5d                	or	a4,a4,a5
    800061c6:	0089579b          	srliw	a5,s2,0x8
    800061ca:	66c1                	lui	a3,0x10
    800061cc:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    800061d0:	8ff5                	and	a5,a5,a3
    800061d2:	8fd9                	or	a5,a5,a4
  arphdr->tip = htonl(dip);
    800061d4:	00e98c23          	sb	a4,24(s3)
    800061d8:	0087d71b          	srliw	a4,a5,0x8
    800061dc:	00e98ca3          	sb	a4,25(s3)
    800061e0:	0107d71b          	srliw	a4,a5,0x10
    800061e4:	00e98d23          	sb	a4,26(s3)
    800061e8:	0187d79b          	srliw	a5,a5,0x18
    800061ec:	00f98da3          	sb	a5,27(s3)
  net_tx_eth(m, ETHTYPE_ARP);
    800061f0:	6585                	lui	a1,0x1
    800061f2:	80658593          	addi	a1,a1,-2042 # 806 <_entry-0x7ffff7fa>
    800061f6:	8552                	mv	a0,s4
    800061f8:	00000097          	auipc	ra,0x0
    800061fc:	978080e7          	jalr	-1672(ra) # 80005b70 <net_tx_eth>
  return 0;
    80006200:	b5d9                	j	800060c6 <net_rx+0x2b6>

0000000080006202 <sockinit>:
...
sockinit(void)
{
  ...
  initlock(&lock, "socktbl");
    8000620a:	00003597          	auipc	a1,0x3
    8000620e:	5f658593          	addi	a1,a1,1526 # 80009800 <syscalls+0x428>
    80006212:	00019517          	auipc	a0,0x19
    80006216:	10e50513          	addi	a0,a0,270 # 8001f320 <lock>
    8000621a:	00001097          	auipc	ra,0x1
    8000621e:	e5c080e7          	jalr	-420(ra) # 80007076 <initlock>
}
...
000000008000622a <sockalloc>:

int
sockalloc(struct file **f, uint32 raddr, uint16 lport, uint16 rport)
{
    8000622a:	7139                	addi	sp,sp,-64
    8000622c:	fc06                	sd	ra,56(sp)
    8000622e:	f822                	sd	s0,48(sp)
    80006230:	f426                	sd	s1,40(sp)
    80006232:	f04a                	sd	s2,32(sp)
    80006234:	ec4e                	sd	s3,24(sp)
    80006236:	e852                	sd	s4,16(sp)
    80006238:	e456                	sd	s5,8(sp)
    8000623a:	0080                	addi	s0,sp,64
    8000623c:	892a                	mv	s2,a0
    8000623e:	84ae                	mv	s1,a1
    80006240:	8a32                	mv	s4,a2
    80006242:	89b6                	mv	s3,a3
  struct sock *si, *pos;

  si = 0;
  *f = 0;
    80006244:	00053023          	sd	zero,0(a0)
  if ((*f = filealloc()) == 0)
    80006248:	ffffd097          	auipc	ra,0xffffd
    8000624c:	688080e7          	jalr	1672(ra) # 800038d0 <filealloc>
    80006250:	00a93023          	sd	a0,0(s2)
    80006254:	c975                	beqz	a0,80006348 <sockalloc+0x11e>
    goto bad;
  if ((si = (struct sock*)kalloc()) == 0)
    80006256:	ffffa097          	auipc	ra,0xffffa
    8000625a:	ec2080e7          	jalr	-318(ra) # 80000118 <kalloc>
    8000625e:	8aaa                	mv	s5,a0
    80006260:	c15d                	beqz	a0,80006306 <sockalloc+0xdc>
    goto bad;

  // initialize objects
  si->raddr = raddr;
    80006262:	c504                	sw	s1,8(a0)
  si->lport = lport;
    80006264:	01451623          	sh	s4,12(a0)
  si->rport = rport;
    80006268:	01351723          	sh	s3,14(a0)
  initlock(&si->lock, "sock");
    8000626c:	00003597          	auipc	a1,0x3
    80006270:	59c58593          	addi	a1,a1,1436 # 80009808 <syscalls+0x430>
    80006274:	0541                	addi	a0,a0,16
    80006276:	00001097          	auipc	ra,0x1
    8000627a:	e00080e7          	jalr	-512(ra) # 80007076 <initlock>
  mbufq_init(&si->rxq);
    8000627e:	028a8513          	addi	a0,s5,40
    80006282:	00000097          	auipc	ra,0x0
    80006286:	a7a080e7          	jalr	-1414(ra) # 80005cfc <mbufq_init>
  (*f)->type = FD_SOCK;
    8000628a:	00093783          	ld	a5,0(s2)
    8000628e:	4711                	li	a4,4
    80006290:	c398                	sw	a4,0(a5)
  (*f)->readable = 1;
    80006292:	00093703          	ld	a4,0(s2)
    80006296:	4785                	li	a5,1
    80006298:	00f70423          	sb	a5,8(a4)
  (*f)->writable = 1;
    8000629c:	00093703          	ld	a4,0(s2)
    800062a0:	00f704a3          	sb	a5,9(a4)
  (*f)->sock = si;
    800062a4:	00093783          	ld	a5,0(s2)
    800062a8:	0357b023          	sd	s5,32(a5) # f020020 <_entry-0x70fdffe0>

  // add to list of sockets
  acquire(&lock);
    800062ac:	00019517          	auipc	a0,0x19
    800062b0:	07450513          	addi	a0,a0,116 # 8001f320 <lock>
    800062b4:	00001097          	auipc	ra,0x1
    800062b8:	e52080e7          	jalr	-430(ra) # 80007106 <acquire>
  pos = sockets;
    800062bc:	00004597          	auipc	a1,0x4
    800062c0:	d6c5b583          	ld	a1,-660(a1) # 8000a028 <sockets>
  while (pos) {
    800062c4:	c9b1                	beqz	a1,80006318 <sockalloc+0xee>
  pos = sockets;
    800062c6:	87ae                	mv	a5,a1
    if (pos->raddr == raddr &&
    800062c8:	000a061b          	sext.w	a2,s4
        pos->lport == lport &&
    800062cc:	0009869b          	sext.w	a3,s3
    800062d0:	a019                	j	800062d6 <sockalloc+0xac>
	pos->rport == rport) {
      release(&lock);
      goto bad;
    }
    pos = pos->next;
    800062d2:	639c                	ld	a5,0(a5)
  while (pos) {
    800062d4:	c3b1                	beqz	a5,80006318 <sockalloc+0xee>
    if (pos->raddr == raddr &&
    800062d6:	4798                	lw	a4,8(a5)
    800062d8:	fe971de3          	bne	a4,s1,800062d2 <sockalloc+0xa8>
    800062dc:	00c7d703          	lhu	a4,12(a5)
    800062e0:	fec719e3          	bne	a4,a2,800062d2 <sockalloc+0xa8>
        pos->lport == lport &&
    800062e4:	00e7d703          	lhu	a4,14(a5)
    800062e8:	fed715e3          	bne	a4,a3,800062d2 <sockalloc+0xa8>
      release(&lock);
    800062ec:	00019517          	auipc	a0,0x19
    800062f0:	03450513          	addi	a0,a0,52 # 8001f320 <lock>
    800062f4:	00001097          	auipc	ra,0x1
    800062f8:	ec6080e7          	jalr	-314(ra) # 800071ba <release>
  release(&lock);
  return 0;
...
bad:
  if (si)
    kfree((char*)si);
    800062fc:	8556                	mv	a0,s5
    800062fe:	ffffa097          	auipc	ra,0xffffa
    80006302:	d1e080e7          	jalr	-738(ra) # 8000001c <kfree>
  if (*f)
    80006306:	00093503          	ld	a0,0(s2)
    8000630a:	c129                	beqz	a0,8000634c <sockalloc+0x122>
    fileclose(*f);
    8000630c:	ffffd097          	auipc	ra,0xffffd
    80006310:	680080e7          	jalr	1664(ra) # 8000398c <fileclose>
  return -1;
    80006314:	557d                	li	a0,-1
    80006316:	a005                	j	80006336 <sockalloc+0x10c>
  si->next = sockets;
    80006318:	00bab023          	sd	a1,0(s5)
  sockets = si;
    8000631c:	00004797          	auipc	a5,0x4
    80006320:	d157b623          	sd	s5,-756(a5) # 8000a028 <sockets>
  release(&lock);
    80006324:	00019517          	auipc	a0,0x19
    80006328:	ffc50513          	addi	a0,a0,-4 # 8001f320 <lock>
    8000632c:	00001097          	auipc	ra,0x1
    80006330:	e8e080e7          	jalr	-370(ra) # 800071ba <release>
  return 0;
    80006334:	4501                	li	a0,0
}
    80006336:	70e2                	ld	ra,56(sp)
    80006338:	7442                	ld	s0,48(sp)
    8000633a:	74a2                	ld	s1,40(sp)
    8000633c:	7902                	ld	s2,32(sp)
    8000633e:	69e2                	ld	s3,24(sp)
    80006340:	6a42                	ld	s4,16(sp)
    80006342:	6aa2                	ld	s5,8(sp)
    80006344:	6121                	addi	sp,sp,64
    80006346:	8082                	ret
  return -1;
    80006348:	557d                	li	a0,-1
    8000634a:	b7f5                	j	80006336 <sockalloc+0x10c>
    8000634c:	557d                	li	a0,-1
    8000634e:	b7e5                	j	80006336 <sockalloc+0x10c>

0000000080006350 <sockclose>:
...
sockclose(struct sock *si)
{
    ...
    8000635c:	892a                	mv	s2,a0
  struct sock **pos;
  struct mbuf *m;

  // remove from list of sockets
  acquire(&lock);
    8000635e:	00019517          	auipc	a0,0x19
    80006362:	fc250513          	addi	a0,a0,-62 # 8001f320 <lock>
    80006366:	00001097          	auipc	ra,0x1
    8000636a:	da0080e7          	jalr	-608(ra) # 80007106 <acquire>
  pos = &sockets;
    8000636e:	00004797          	auipc	a5,0x4
    80006372:	cba7b783          	ld	a5,-838(a5) # 8000a028 <sockets>
  while (*pos) {
    80006376:	cb99                	beqz	a5,8000638c <sockclose+0x3c>
    if (*pos == si){
    80006378:	02f90563          	beq	s2,a5,800063a2 <sockclose+0x52>
      *pos = si->next;
      break;
    }
    pos = &(*pos)->next;
    8000637c:	873e                	mv	a4,a5
    8000637e:	639c                	ld	a5,0(a5)
  while (*pos) {
    80006380:	c791                	beqz	a5,8000638c <sockclose+0x3c>
    if (*pos == si){
    80006382:	fef91de3          	bne	s2,a5,8000637c <sockclose+0x2c>
      *pos = si->next;
    80006386:	00093783          	ld	a5,0(s2)
    8000638a:	e31c                	sd	a5,0(a4)
  }
  release(&lock);
    8000638c:	00019517          	auipc	a0,0x19
    80006390:	f9450513          	addi	a0,a0,-108 # 8001f320 <lock>
    80006394:	00001097          	auipc	ra,0x1
    80006398:	e26080e7          	jalr	-474(ra) # 800071ba <release>

  // free any pending mbufs
  while (!mbufq_empty(&si->rxq)) {
    8000639c:	02890493          	addi	s1,s2,40
    800063a0:	a839                	j	800063be <sockclose+0x6e>
  pos = &sockets;
    800063a2:	00004717          	auipc	a4,0x4
    800063a6:	c8670713          	addi	a4,a4,-890 # 8000a028 <sockets>
    800063aa:	bff1                	j	80006386 <sockclose+0x36>
    m = mbufq_pophead(&si->rxq);
    800063ac:	8526                	mv	a0,s1
    800063ae:	00000097          	auipc	ra,0x0
    800063b2:	926080e7          	jalr	-1754(ra) # 80005cd4 <mbufq_pophead>
    mbuffree(m);
    800063b6:	00000097          	auipc	ra,0x0
    800063ba:	8e6080e7          	jalr	-1818(ra) # 80005c9c <mbuffree>
  while (!mbufq_empty(&si->rxq)) {
    800063be:	8526                	mv	a0,s1
    800063c0:	00000097          	auipc	ra,0x0
    800063c4:	92a080e7          	jalr	-1750(ra) # 80005cea <mbufq_empty>
    800063c8:	d175                	beqz	a0,800063ac <sockclose+0x5c>
  }

  kfree((char*)si);
    800063ca:	854a                	mv	a0,s2
    800063cc:	ffffa097          	auipc	ra,0xffffa
    800063d0:	c50080e7          	jalr	-944(ra) # 8000001c <kfree>
}
    800063d4:	60e2                	ld	ra,24(sp)
    800063d6:	6442                	ld	s0,16(sp)
    800063d8:	64a2                	ld	s1,8(sp)
    800063da:	6902                	ld	s2,0(sp)
    800063dc:	6105                	addi	sp,sp,32
    800063de:	8082                	ret

00000000800063e0 <sockread>:
...
sockread(struct sock *si, uint64 addr, int n)
{
    ...
    800063f4:	8a2e                	mv	s4,a1
    800063f6:	8ab2                	mv	s5,a2
  struct proc *pr = myproc();
    800063f8:	ffffb097          	auipc	ra,0xffffb
    800063fc:	aa8080e7          	jalr	-1368(ra) # 80000ea0 <myproc>
    80006400:	892a                	mv	s2,a0
  struct mbuf *m;
  int len;

  acquire(&si->lock);
    80006402:	01048993          	addi	s3,s1,16
    80006406:	854e                	mv	a0,s3
    80006408:	00001097          	auipc	ra,0x1
    8000640c:	cfe080e7          	jalr	-770(ra) # 80007106 <acquire>
  while (mbufq_empty(&si->rxq) && !pr->killed) {
    80006410:	02848493          	addi	s1,s1,40
    80006414:	8526                	mv	a0,s1
    80006416:	00000097          	auipc	ra,0x0
    8000641a:	8d4080e7          	jalr	-1836(ra) # 80005cea <mbufq_empty>
    8000641e:	c919                	beqz	a0,80006434 <sockread+0x54>
    80006420:	02892783          	lw	a5,40(s2)
    80006424:	eba5                	bnez	a5,80006494 <sockread+0xb4>
    sleep(&si->rxq, &si->lock);
    80006426:	85ce                	mv	a1,s3
    80006428:	8526                	mv	a0,s1
    8000642a:	ffffb097          	auipc	ra,0xffffb
    8000642e:	132080e7          	jalr	306(ra) # 8000155c <sleep>
    80006432:	b7cd                	j	80006414 <sockread+0x34>
  }
  if (pr->killed) {
    80006434:	02892783          	lw	a5,40(s2)
    80006438:	efb1                	bnez	a5,80006494 <sockread+0xb4>
    release(&si->lock);
    return -1;
  }
  m = mbufq_pophead(&si->rxq);
    ...
    80006440:	898080e7          	jalr	-1896(ra) # 80005cd4 <mbufq_pophead>
    80006444:	84aa                	mv	s1,a0
  release(&si->lock);
    80006446:	854e                	mv	a0,s3
    80006448:	00001097          	auipc	ra,0x1
    8000644c:	d72080e7          	jalr	-654(ra) # 800071ba <release>

  len = m->len;
    80006450:	489c                	lw	a5,16(s1)
  if (len > n)
    80006452:	89be                	mv	s3,a5
    80006454:	00fad363          	bge	s5,a5,8000645a <sockread+0x7a>
    80006458:	89d6                	mv	s3,s5
    8000645a:	2981                	sext.w	s3,s3
    len = n;
  if (copyout(pr->pagetable, addr, m->head, len) == -1) {
    8000645c:	86ce                	mv	a3,s3
    8000645e:	6490                	ld	a2,8(s1)
    80006460:	85d2                	mv	a1,s4
    80006462:	05093503          	ld	a0,80(s2)
    80006466:	ffffa097          	auipc	ra,0xffffa
    8000646a:	700080e7          	jalr	1792(ra) # 80000b66 <copyout>
    8000646e:	892a                	mv	s2,a0
    80006470:	57fd                	li	a5,-1
    80006472:	02f50863          	beq	a0,a5,800064a2 <sockread+0xc2>
    mbuffree(m);
    return -1;
  }
  mbuffree(m);
    ...
    8000647c:	824080e7          	jalr	-2012(ra) # 80005c9c <mbuffree>
  return len;
}
    80006480:	854e                	mv	a0,s3
    ...
    80006496:	00001097          	auipc	ra,0x1
    8000649a:	d24080e7          	jalr	-732(ra) # 800071ba <release>
    return -1;
    8000649e:	59fd                	li	s3,-1
    800064a0:	b7c5                	j	80006480 <sockread+0xa0>
    mbuffree(m);
    800064a2:	8526                	mv	a0,s1
    800064a4:	fffff097          	auipc	ra,0xfffff
    800064a8:	7f8080e7          	jalr	2040(ra) # 80005c9c <mbuffree>
    return -1;
    800064ac:	89ca                	mv	s3,s2
    800064ae:	bfc9                	j	80006480 <sockread+0xa0>

00000000800064b0 <sockwrite>:
...
sockwrite(struct sock *si, uint64 addr, int n)
{
    ...
    800064c2:	8aaa                	mv	s5,a0
    800064c4:	89ae                	mv	s3,a1
    800064c6:	8932                	mv	s2,a2
  struct proc *pr = myproc();
    800064c8:	ffffb097          	auipc	ra,0xffffb
    800064cc:	9d8080e7          	jalr	-1576(ra) # 80000ea0 <myproc>
    800064d0:	8a2a                	mv	s4,a0
  struct mbuf *m;

  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    800064d2:	08000513          	li	a0,128
    800064d6:	fffff097          	auipc	ra,0xfffff
    800064da:	76e080e7          	jalr	1902(ra) # 80005c44 <mbufalloc>
  if (!m)
    800064de:	c12d                	beqz	a0,80006540 <sockwrite+0x90>
    800064e0:	84aa                	mv	s1,a0
    return -1;

  if (copyin(pr->pagetable, mbufput(m, n), addr, n) == -1) {
    800064e2:	050a3a03          	ld	s4,80(s4)
    800064e6:	85ca                	mv	a1,s2
    800064e8:	fffff097          	auipc	ra,0xfffff
    800064ec:	700080e7          	jalr	1792(ra) # 80005be8 <mbufput>
    800064f0:	85aa                	mv	a1,a0
    800064f2:	86ca                	mv	a3,s2
    800064f4:	864e                	mv	a2,s3
    800064f6:	8552                	mv	a0,s4
    800064f8:	ffffa097          	auipc	ra,0xffffa
    800064fc:	6fa080e7          	jalr	1786(ra) # 80000bf2 <copyin>
    80006500:	89aa                	mv	s3,a0
    80006502:	57fd                	li	a5,-1
    80006504:	02f50863          	beq	a0,a5,80006534 <sockwrite+0x84>
    mbuffree(m);
    return -1;
  }
  net_tx_udp(m, si->raddr, si->lport, si->rport);
    80006508:	00ead683          	lhu	a3,14(s5)
    8000650c:	00cad603          	lhu	a2,12(s5)
    80006510:	008aa583          	lw	a1,8(s5)
    80006514:	8526                	mv	a0,s1
    80006516:	fffff097          	auipc	ra,0xfffff
    8000651a:	7f6080e7          	jalr	2038(ra) # 80005d0c <net_tx_udp>
  return n;
    8000651e:	89ca                	mv	s3,s2
}
    80006520:	854e                	mv	a0,s3
    ...
    80006530:	6121                	addi	sp,sp,64
    80006532:	8082                	ret
    mbuffree(m);
    80006534:	8526                	mv	a0,s1
    80006536:	fffff097          	auipc	ra,0xfffff
    8000653a:	766080e7          	jalr	1894(ra) # 80005c9c <mbuffree>
    return -1;
    8000653e:	b7cd                	j	80006520 <sockwrite+0x70>
    return -1;
    80006540:	59fd                	li	s3,-1
    80006542:	bff9                	j	80006520 <sockwrite+0x70>

0000000080006544 <sockrecvudp>:

// called by protocol handler layer to deliver UDP packets
void
sockrecvudp(struct mbuf *m, uint32 raddr, uint16 lport, uint16 rport)
{
    80006544:	7139                	addi	sp,sp,-64
    80006546:	fc06                	sd	ra,56(sp)
    80006548:	f822                	sd	s0,48(sp)
    8000654a:	f426                	sd	s1,40(sp)
    8000654c:	f04a                	sd	s2,32(sp)
    8000654e:	ec4e                	sd	s3,24(sp)
    80006550:	e852                	sd	s4,16(sp)
    80006552:	e456                	sd	s5,8(sp)
    80006554:	0080                	addi	s0,sp,64
    80006556:	8a2a                	mv	s4,a0
    80006558:	892e                	mv	s2,a1
    8000655a:	89b2                	mv	s3,a2
    8000655c:	8ab6                	mv	s5,a3
  ...
  acquire(&lock);
    8000655e:	00019517          	auipc	a0,0x19
    80006562:	dc250513          	addi	a0,a0,-574 # 8001f320 <lock>
    80006566:	00001097          	auipc	ra,0x1
    8000656a:	ba0080e7          	jalr	-1120(ra) # 80007106 <acquire>
  si = sockets;
    8000656e:	00004497          	auipc	s1,0x4
    80006572:	aba4b483          	ld	s1,-1350(s1) # 8000a028 <sockets>
  while (si) {
    80006576:	c4ad                	beqz	s1,800065e0 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    80006578:	0009871b          	sext.w	a4,s3
    8000657c:	000a869b          	sext.w	a3,s5
    80006580:	a019                	j	80006586 <sockrecvudp+0x42>
      goto found;
    si = si->next;
    80006582:	6084                	ld	s1,0(s1)
  while (si) {
    80006584:	ccb1                	beqz	s1,800065e0 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    80006586:	449c                	lw	a5,8(s1)
    80006588:	ff279de3          	bne	a5,s2,80006582 <sockrecvudp+0x3e>
    8000658c:	00c4d783          	lhu	a5,12(s1)
    80006590:	fee799e3          	bne	a5,a4,80006582 <sockrecvudp+0x3e>
    80006594:	00e4d783          	lhu	a5,14(s1)
    80006598:	fed795e3          	bne	a5,a3,80006582 <sockrecvudp+0x3e>
  release(&lock);
  mbuffree(m);
  return;
...
found:
  acquire(&si->lock);
    8000659c:	01048913          	addi	s2,s1,16
    800065a0:	854a                	mv	a0,s2
    800065a2:	00001097          	auipc	ra,0x1
    800065a6:	b64080e7          	jalr	-1180(ra) # 80007106 <acquire>
  mbufq_pushtail(&si->rxq, m);
    800065aa:	02848493          	addi	s1,s1,40
    800065ae:	85d2                	mv	a1,s4
    800065b0:	8526                	mv	a0,s1
    800065b2:	fffff097          	auipc	ra,0xfffff
    800065b6:	702080e7          	jalr	1794(ra) # 80005cb4 <mbufq_pushtail>
  wakeup(&si->rxq);
    800065ba:	8526                	mv	a0,s1
    800065bc:	ffffb097          	auipc	ra,0xffffb
    800065c0:	12c080e7          	jalr	300(ra) # 800016e8 <wakeup>
  release(&si->lock);
    800065c4:	854a                	mv	a0,s2
    800065c6:	00001097          	auipc	ra,0x1
    800065ca:	bf4080e7          	jalr	-1036(ra) # 800071ba <release>
  release(&lock);
    800065ce:	00019517          	auipc	a0,0x19
    800065d2:	d5250513          	addi	a0,a0,-686 # 8001f320 <lock>
    800065d6:	00001097          	auipc	ra,0x1
    800065da:	be4080e7          	jalr	-1052(ra) # 800071ba <release>
    800065de:	a831                	j	800065fa <sockrecvudp+0xb6>
  release(&lock);
    800065e0:	00019517          	auipc	a0,0x19
    800065e4:	d4050513          	addi	a0,a0,-704 # 8001f320 <lock>
    800065e8:	00001097          	auipc	ra,0x1
    800065ec:	bd2080e7          	jalr	-1070(ra) # 800071ba <release>
  mbuffree(m);
    800065f0:	8552                	mv	a0,s4
    800065f2:	fffff097          	auipc	ra,0xfffff
    800065f6:	6aa080e7          	jalr	1706(ra) # 80005c9c <mbuffree>
}
...
pci_init()
{
    8000660c:	715d                	addi	sp,sp,-80
    8000660e:	e486                	sd	ra,72(sp)
    80006610:	e0a2                	sd	s0,64(sp)
    80006612:	fc26                	sd	s1,56(sp)
    80006614:	f84a                	sd	s2,48(sp)
    80006616:	f44e                	sd	s3,40(sp)
    80006618:	f052                	sd	s4,32(sp)
    8000661a:	ec56                	sd	s5,24(sp)
    8000661c:	e85a                	sd	s6,16(sp)
    8000661e:	e45e                	sd	s7,8(sp)
    80006620:	0880                	addi	s0,sp,80
    80006622:	300004b7          	lui	s1,0x30000
    ...
    if(id == 0x100e8086){
    80006626:	100e8937          	lui	s2,0x100e8
    8000662a:	08690913          	addi	s2,s2,134 # 100e8086 <_entry-0x6ff17f7a>
      // command and status register.
      // bit 0 : I/O access enable
      // bit 1 : memory access enable
      // bit 2 : enable mastering
      base[1] = 7;
    8000662e:	4b9d                	li	s7,7
      for(int i = 0; i < 6; i++){
        uint32 old = base[4+i];
    ...
    80006630:	5afd                	li	s5,-1
      ...
      base[4+0] = e1000_regs;
    80006632:	40000b37          	lui	s6,0x40000
    80006636:	6a09                	lui	s4,0x2
  for(int dev = 0; dev < 32; dev++){
    80006638:	300409b7          	lui	s3,0x30040
    8000663c:	a821                	j	80006654 <pci_init+0x48>
      base[4+0] = e1000_regs;
    8000663e:	0166a823          	sw	s6,16(a3)

      e1000_init((uint32*)e1000_regs);
    80006642:	40000537          	lui	a0,0x40000
    80006646:	fffff097          	auipc	ra,0xfffff
    8000664a:	11a080e7          	jalr	282(ra) # 80005760 <e1000_init>
  for(int dev = 0; dev < 32; dev++){
    8000664e:	94d2                	add	s1,s1,s4
    80006650:	03348a63          	beq	s1,s3,80006684 <pci_init+0x78>
    volatile uint32 *base = ecam + off;
    80006654:	86a6                	mv	a3,s1
    uint32 id = base[0];
    80006656:	409c                	lw	a5,0(s1)
    80006658:	2781                	sext.w	a5,a5
    if(id == 0x100e8086){
    8000665a:	ff279ae3          	bne	a5,s2,8000664e <pci_init+0x42>
      base[1] = 7;
    8000665e:	0174a223          	sw	s7,4(s1) # 30000004 <_entry-0x4ffffffc>
      __sync_synchronize();
    80006662:	0ff0000f          	fence
      for(int i = 0; i < 6; i++){
    80006666:	01048793          	addi	a5,s1,16
    8000666a:	02848613          	addi	a2,s1,40
        uint32 old = base[4+i];
    8000666e:	4398                	lw	a4,0(a5)
    80006670:	2701                	sext.w	a4,a4
        base[4+i] = 0xffffffff;
    80006672:	0157a023          	sw	s5,0(a5)
        __sync_synchronize();
    80006676:	0ff0000f          	fence
        base[4+i] = old;
    8000667a:	c398                	sw	a4,0(a5)
      for(int i = 0; i < 6; i++){
    8000667c:	0791                	addi	a5,a5,4
    8000667e:	fec798e3          	bne	a5,a2,8000666e <pci_init+0x62>
    80006682:	bf75                	j	8000663e <pci_init+0x32>
    }
  }
}
    80006684:	60a6                	ld	ra,72(sp)
    80006686:	6406                	ld	s0,64(sp)
    80006688:	74e2                	ld	s1,56(sp)
    8000668a:	7942                	ld	s2,48(sp)
    8000668c:	79a2                	ld	s3,40(sp)
    8000668e:	7a02                	ld	s4,32(sp)
    80006690:	6ae2                	ld	s5,24(sp)
    80006692:	6b42                	ld	s6,16(sp)
    80006694:	6ba2                	ld	s7,8(sp)
    80006696:	6161                	addi	sp,sp,80
    80006698:	8082                	ret

000000008000669a <timerinit>:
...
timerinit()
{
  ...
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800066a0:	f14027f3          	csrr	a5,mhartid
  // each CPU has a separate source of timer interrupts.
  int id = r_mhartid();
    800066a4:	0007869b          	sext.w	a3,a5

  // ask the CLINT for a timer interrupt.
  int interval = 1000000; // cycles; about 1/10th second in qemu.
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    800066a8:	0037979b          	slliw	a5,a5,0x3
    800066ac:	02004737          	lui	a4,0x2004
    800066b0:	97ba                	add	a5,a5,a4
    800066b2:	0200c737          	lui	a4,0x200c
    800066b6:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    800066ba:	000f4637          	lui	a2,0xf4
    800066be:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    800066c2:	95b2                	add	a1,a1,a2
    800066c4:	e38c                	sd	a1,0(a5)
  ...
  uint64 *scratch = &timer_scratch[id][0];
    800066c6:	00269713          	slli	a4,a3,0x2
    800066ca:	9736                	add	a4,a4,a3
    800066cc:	00371693          	slli	a3,a4,0x3
    800066d0:	00019717          	auipc	a4,0x19
    800066d4:	c7070713          	addi	a4,a4,-912 # 8001f340 <timer_scratch>
    800066d8:	9736                	add	a4,a4,a3
  scratch[3] = CLINT_MTIMECMP(id);
    800066da:	ef1c                	sd	a5,24(a4)
  scratch[4] = interval;
    800066dc:	f310                	sd	a2,32(a4)
  asm volatile("csrw mscratch, %0" : : "r" (x));
    800066de:	34071073          	csrw	mscratch,a4
  asm volatile("csrw mtvec, %0" : : "r" (x));
    800066e2:	fffff797          	auipc	a5,0xfffff
    800066e6:	a1e78793          	addi	a5,a5,-1506 # 80005100 <timervec>
    800066ea:	30579073          	csrw	mtvec,a5
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    800066ee:	300027f3          	csrr	a5,mstatus
  ...
  w_mstatus(r_mstatus() | MSTATUS_MIE);
    800066f2:	0087e793          	ori	a5,a5,8
  asm volatile("csrw mstatus, %0" : : "r" (x));
    800066f6:	30079073          	csrw	mstatus,a5
  asm volatile("csrr %0, mie" : "=r" (x) );
    800066fa:	304027f3          	csrr	a5,mie

  // enable machine-mode timer interrupts.
  w_mie(r_mie() | MIE_MTIE);
    800066fe:	0807e793          	ori	a5,a5,128
  asm volatile("csrw mie, %0" : : "r" (x));
    80006702:	30479073          	csrw	mie,a5
}
    80006706:	6422                	ld	s0,8(sp)
    80006708:	0141                	addi	sp,sp,16
    8000670a:	8082                	ret

000000008000670c <start>:
{
  ...
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    80006714:	300027f3          	csrr	a5,mstatus
  x &= ~MSTATUS_MPP_MASK;
    80006718:	7779                	lui	a4,0xffffe
    8000671a:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffd727f>
    8000671e:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    80006720:	6705                	lui	a4,0x1
    80006722:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    80006726:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006728:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    8000672c:	ffffa797          	auipc	a5,0xffffa
    80006730:	bfa78793          	addi	a5,a5,-1030 # 80000326 <main>
    80006734:	34179073          	csrw	mepc,a5
  asm volatile("csrw satp, %0" : : "r" (x));
    80006738:	4781                	li	a5,0
    8000673a:	18079073          	csrw	satp,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
    8000673e:	67c1                	lui	a5,0x10
    80006740:	17fd                	addi	a5,a5,-1
    80006742:	30279073          	csrw	medeleg,a5
  asm volatile("csrw mideleg, %0" : : "r" (x));
    80006746:	30379073          	csrw	mideleg,a5
  asm volatile("csrr %0, sie" : "=r" (x) );
    8000674a:	104027f3          	csrr	a5,sie
  w_sie(r_sie() | SIE_SEIE | SIE_STIE | SIE_SSIE);
    8000674e:	2227e793          	ori	a5,a5,546
  asm volatile("csrw sie, %0" : : "r" (x));
    80006752:	10479073          	csrw	sie,a5
  asm volatile("csrw pmpaddr0, %0" : : "r" (x));
    80006756:	57fd                	li	a5,-1
    80006758:	83a9                	srli	a5,a5,0xa
    8000675a:	3b079073          	csrw	pmpaddr0,a5
  asm volatile("csrw pmpcfg0, %0" : : "r" (x));
    8000675e:	47bd                	li	a5,15
    80006760:	3a079073          	csrw	pmpcfg0,a5
  timerinit();
    80006764:	00000097          	auipc	ra,0x0
    80006768:	f36080e7          	jalr	-202(ra) # 8000669a <timerinit>
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    8000676c:	f14027f3          	csrr	a5,mhartid
  w_tp(id);
    80006770:	2781                	sext.w	a5,a5
  asm volatile("mv tp, %0" : : "r" (x));
    80006772:	823e                	mv	tp,a5
  asm volatile("mret");
...
{
    80006780:	715d                	addi	sp,sp,-80
    80006782:	e486                	sd	ra,72(sp)
    80006784:	e0a2                	sd	s0,64(sp)
    80006786:	fc26                	sd	s1,56(sp)
    80006788:	f84a                	sd	s2,48(sp)
    8000678a:	f44e                	sd	s3,40(sp)
    8000678c:	f052                	sd	s4,32(sp)
    8000678e:	ec56                	sd	s5,24(sp)
    80006790:	0880                	addi	s0,sp,80
  int i;

  for(i = 0; i < n; i++){
    80006792:	04c05663          	blez	a2,800067de <consolewrite+0x5e>
    80006796:	8a2a                	mv	s4,a0
    80006798:	84ae                	mv	s1,a1
    8000679a:	89b2                	mv	s3,a2
    8000679c:	4901                	li	s2,0
    char c;
    if(either_copyin(&c, user_src, src+i, 1) == -1)
    8000679e:	5afd                	li	s5,-1
    800067a0:	4685                	li	a3,1
    800067a2:	8626                	mv	a2,s1
    800067a4:	85d2                	mv	a1,s4
    800067a6:	fbf40513          	addi	a0,s0,-65
    800067aa:	ffffb097          	auipc	ra,0xffffb
    800067ae:	1ac080e7          	jalr	428(ra) # 80001956 <either_copyin>
    800067b2:	01550c63          	beq	a0,s5,800067ca <consolewrite+0x4a>
      break;
    uartputc(c);
    800067b6:	fbf44503          	lbu	a0,-65(s0)
    800067ba:	00000097          	auipc	ra,0x0
    800067be:	78e080e7          	jalr	1934(ra) # 80006f48 <uartputc>
  for(i = 0; i < n; i++){
    800067c2:	2905                	addiw	s2,s2,1
    800067c4:	0485                	addi	s1,s1,1
    800067c6:	fd299de3          	bne	s3,s2,800067a0 <consolewrite+0x20>
  }

  return i;
}
    800067ca:	854a                	mv	a0,s2
    800067cc:	60a6                	ld	ra,72(sp)
    800067ce:	6406                	ld	s0,64(sp)
    800067d0:	74e2                	ld	s1,56(sp)
    800067d2:	7942                	ld	s2,48(sp)
    800067d4:	79a2                	ld	s3,40(sp)
    800067d6:	7a02                	ld	s4,32(sp)
    800067d8:	6ae2                	ld	s5,24(sp)
    800067da:	6161                	addi	sp,sp,80
    800067dc:	8082                	ret
  for(i = 0; i < n; i++){
    800067de:	4901                	li	s2,0
    800067e0:	b7ed                	j	800067ca <consolewrite+0x4a>

00000000800067e2 <consoleread>:
...
consoleread(int user_dst, uint64 dst, int n)
{
    ...
    80006800:	8b2a                	mv	s6,a0
    80006802:	8aae                	mv	s5,a1
    80006804:	8a32                	mv	s4,a2
  uint target;
  int c;
  char cbuf;

  target = n;
    80006806:	00060b9b          	sext.w	s7,a2
  acquire(&cons.lock);
    8000680a:	00021517          	auipc	a0,0x21
    8000680e:	c7650513          	addi	a0,a0,-906 # 80027480 <cons>
    80006812:	00001097          	auipc	ra,0x1
    80006816:	8f4080e7          	jalr	-1804(ra) # 80007106 <acquire>
  while(n > 0){
    // wait until interrupt handler has put some
    // input into cons.buffer.
    while(cons.r == cons.w){
    8000681a:	00021497          	auipc	s1,0x21
    8000681e:	c6648493          	addi	s1,s1,-922 # 80027480 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
      sleep(&cons.r, &cons.lock);
    80006822:	89a6                	mv	s3,s1
    80006824:	00021917          	auipc	s2,0x21
    80006828:	cf490913          	addi	s2,s2,-780 # 80027518 <cons+0x98>
    }

    c = cons.buf[cons.r++ % INPUT_BUF];

    if(c == C('D')){  // end-of-file
    8000682c:	4c91                	li	s9,4
      break;
    }
    ...
    if(c == '\n'){
    80006830:	4da9                	li	s11,10
  while(n > 0){
    80006832:	07405863          	blez	s4,800068a2 <consoleread+0xc0>
    while(cons.r == cons.w){
    80006836:	0984a783          	lw	a5,152(s1)
    8000683a:	09c4a703          	lw	a4,156(s1)
    8000683e:	02f71463          	bne	a4,a5,80006866 <consoleread+0x84>
      if(myproc()->killed){
    80006842:	ffffa097          	auipc	ra,0xffffa
    80006846:	65e080e7          	jalr	1630(ra) # 80000ea0 <myproc>
    8000684a:	551c                	lw	a5,40(a0)
    8000684c:	e7b5                	bnez	a5,800068b8 <consoleread+0xd6>
      sleep(&cons.r, &cons.lock);
    8000684e:	85ce                	mv	a1,s3
    80006850:	854a                	mv	a0,s2
    80006852:	ffffb097          	auipc	ra,0xffffb
    80006856:	d0a080e7          	jalr	-758(ra) # 8000155c <sleep>
    while(cons.r == cons.w){
    8000685a:	0984a783          	lw	a5,152(s1)
    8000685e:	09c4a703          	lw	a4,156(s1)
    80006862:	fef700e3          	beq	a4,a5,80006842 <consoleread+0x60>
    c = cons.buf[cons.r++ % INPUT_BUF];
    80006866:	0017871b          	addiw	a4,a5,1
    8000686a:	08e4ac23          	sw	a4,152(s1)
    8000686e:	07f7f713          	andi	a4,a5,127
    80006872:	9726                	add	a4,a4,s1
    80006874:	01874703          	lbu	a4,24(a4)
    80006878:	00070c1b          	sext.w	s8,a4
    if(c == C('D')){  // end-of-file
    8000687c:	079c0663          	beq	s8,s9,800068e8 <consoleread+0x106>
    cbuf = c;
    80006880:	f8e407a3          	sb	a4,-113(s0)
    if(either_copyout(user_dst, dst, &cbuf, 1) == -1)
    80006884:	4685                	li	a3,1
    80006886:	f8f40613          	addi	a2,s0,-113
    8000688a:	85d6                	mv	a1,s5
    8000688c:	855a                	mv	a0,s6
    8000688e:	ffffb097          	auipc	ra,0xffffb
    80006892:	072080e7          	jalr	114(ra) # 80001900 <either_copyout>
    80006896:	01a50663          	beq	a0,s10,800068a2 <consoleread+0xc0>
    dst++;
    8000689a:	0a85                	addi	s5,s5,1
    --n;
    8000689c:	3a7d                	addiw	s4,s4,-1
    if(c == '\n'){
    8000689e:	f9bc1ae3          	bne	s8,s11,80006832 <consoleread+0x50>
  ...
  release(&cons.lock);
    800068a2:	00021517          	auipc	a0,0x21
    800068a6:	bde50513          	addi	a0,a0,-1058 # 80027480 <cons>
    800068aa:	00001097          	auipc	ra,0x1
    800068ae:	910080e7          	jalr	-1776(ra) # 800071ba <release>

  return target - n;
    800068b2:	414b853b          	subw	a0,s7,s4
    800068b6:	a811                	j	800068ca <consoleread+0xe8>
        release(&cons.lock);
    800068b8:	00021517          	auipc	a0,0x21
    800068bc:	bc850513          	addi	a0,a0,-1080 # 80027480 <cons>
    800068c0:	00001097          	auipc	ra,0x1
    800068c4:	8fa080e7          	jalr	-1798(ra) # 800071ba <release>
        return -1;
    800068c8:	557d                	li	a0,-1
}
    800068ca:	70e6                	ld	ra,120(sp)
    800068cc:	7446                	ld	s0,112(sp)
    800068ce:	74a6                	ld	s1,104(sp)
    800068d0:	7906                	ld	s2,96(sp)
    800068d2:	69e6                	ld	s3,88(sp)
    800068d4:	6a46                	ld	s4,80(sp)
    800068d6:	6aa6                	ld	s5,72(sp)
    800068d8:	6b06                	ld	s6,64(sp)
    800068da:	7be2                	ld	s7,56(sp)
    800068dc:	7c42                	ld	s8,48(sp)
    800068de:	7ca2                	ld	s9,40(sp)
    800068e0:	7d02                	ld	s10,32(sp)
    800068e2:	6de2                	ld	s11,24(sp)
    800068e4:	6109                	addi	sp,sp,128
    800068e6:	8082                	ret
      if(n < target){
    800068e8:	000a071b          	sext.w	a4,s4
    800068ec:	fb777be3          	bgeu	a4,s7,800068a2 <consoleread+0xc0>
        cons.r--;
    800068f0:	00021717          	auipc	a4,0x21
    800068f4:	c2f72423          	sw	a5,-984(a4) # 80027518 <cons+0x98>
    800068f8:	b76d                	j	800068a2 <consoleread+0xc0>

00000000800068fa <consputc>:
{
  ...
  if(c == BACKSPACE){
    80006902:	10000793          	li	a5,256
    80006906:	00f50a63          	beq	a0,a5,8000691a <consputc+0x20>
    uartputc_sync(c);
    8000690a:	00000097          	auipc	ra,0x0
    8000690e:	564080e7          	jalr	1380(ra) # 80006e6e <uartputc_sync>
}
    80006912:	60a2                	ld	ra,8(sp)
    80006914:	6402                	ld	s0,0(sp)
    80006916:	0141                	addi	sp,sp,16
    80006918:	8082                	ret
    uartputc_sync('\b'); uartputc_sync(' '); uartputc_sync('\b');
    8000691a:	4521                	li	a0,8
    8000691c:	00000097          	auipc	ra,0x0
    80006920:	552080e7          	jalr	1362(ra) # 80006e6e <uartputc_sync>
    80006924:	02000513          	li	a0,32
    80006928:	00000097          	auipc	ra,0x0
    8000692c:	546080e7          	jalr	1350(ra) # 80006e6e <uartputc_sync>
    80006930:	4521                	li	a0,8
    80006932:	00000097          	auipc	ra,0x0
    80006936:	53c080e7          	jalr	1340(ra) # 80006e6e <uartputc_sync>
    8000693a:	bfe1                	j	80006912 <consputc+0x18>

000000008000693c <consoleintr>:
...
consoleintr(int c)
{
    ...
    80006944:	e04a                	sd	s2,0(sp)
    80006946:	1000                	addi	s0,sp,32
    80006948:	84aa                	mv	s1,a0
  acquire(&cons.lock);
    8000694a:	00021517          	auipc	a0,0x21
    8000694e:	b3650513          	addi	a0,a0,-1226 # 80027480 <cons>
    80006952:	00000097          	auipc	ra,0x0
    80006956:	7b4080e7          	jalr	1972(ra) # 80007106 <acquire>

  switch(c){
    8000695a:	47d5                	li	a5,21
    8000695c:	0af48663          	beq	s1,a5,80006a08 <consoleintr+0xcc>
    80006960:	0297ca63          	blt	a5,s1,80006994 <consoleintr+0x58>
    80006964:	47a1                	li	a5,8
    80006966:	0ef48763          	beq	s1,a5,80006a54 <consoleintr+0x118>
    8000696a:	47c1                	li	a5,16
    8000696c:	10f49a63          	bne	s1,a5,80006a80 <consoleintr+0x144>
  case C('P'):  // Print process list.
    procdump();
    80006970:	ffffb097          	auipc	ra,0xffffb
    80006974:	03c080e7          	jalr	60(ra) # 800019ac <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    80006978:	00021517          	auipc	a0,0x21
    8000697c:	b0850513          	addi	a0,a0,-1272 # 80027480 <cons>
    80006980:	00001097          	auipc	ra,0x1
    80006984:	83a080e7          	jalr	-1990(ra) # 800071ba <release>
}
    80006988:	60e2                	ld	ra,24(sp)
    8000698a:	6442                	ld	s0,16(sp)
    8000698c:	64a2                	ld	s1,8(sp)
    8000698e:	6902                	ld	s2,0(sp)
    80006990:	6105                	addi	sp,sp,32
    80006992:	8082                	ret
  switch(c){
    80006994:	07f00793          	li	a5,127
    80006998:	0af48e63          	beq	s1,a5,80006a54 <consoleintr+0x118>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    8000699c:	00021717          	auipc	a4,0x21
    800069a0:	ae470713          	addi	a4,a4,-1308 # 80027480 <cons>
    800069a4:	0a072783          	lw	a5,160(a4)
    800069a8:	09872703          	lw	a4,152(a4)
    800069ac:	9f99                	subw	a5,a5,a4
    800069ae:	07f00713          	li	a4,127
    800069b2:	fcf763e3          	bltu	a4,a5,80006978 <consoleintr+0x3c>
      c = (c == '\r') ? '\n' : c;
    800069b6:	47b5                	li	a5,13
    800069b8:	0cf48763          	beq	s1,a5,80006a86 <consoleintr+0x14a>
      consputc(c);
    800069bc:	8526                	mv	a0,s1
    800069be:	00000097          	auipc	ra,0x0
    800069c2:	f3c080e7          	jalr	-196(ra) # 800068fa <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    800069c6:	00021797          	auipc	a5,0x21
    800069ca:	aba78793          	addi	a5,a5,-1350 # 80027480 <cons>
    800069ce:	0a07a703          	lw	a4,160(a5)
    800069d2:	0017069b          	addiw	a3,a4,1
    800069d6:	0006861b          	sext.w	a2,a3
    800069da:	0ad7a023          	sw	a3,160(a5)
    800069de:	07f77713          	andi	a4,a4,127
    800069e2:	97ba                	add	a5,a5,a4
    800069e4:	00978c23          	sb	s1,24(a5)
      if(c == '\n' || c == C('D') || cons.e == cons.r+INPUT_BUF){
    800069e8:	47a9                	li	a5,10
    800069ea:	0cf48563          	beq	s1,a5,80006ab4 <consoleintr+0x178>
    800069ee:	4791                	li	a5,4
    800069f0:	0cf48263          	beq	s1,a5,80006ab4 <consoleintr+0x178>
    800069f4:	00021797          	auipc	a5,0x21
    800069f8:	b247a783          	lw	a5,-1244(a5) # 80027518 <cons+0x98>
    800069fc:	0807879b          	addiw	a5,a5,128
    80006a00:	f6f61ce3          	bne	a2,a5,80006978 <consoleintr+0x3c>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a04:	863e                	mv	a2,a5
    80006a06:	a07d                	j	80006ab4 <consoleintr+0x178>
    while(cons.e != cons.w &&
    80006a08:	00021717          	auipc	a4,0x21
    80006a0c:	a7870713          	addi	a4,a4,-1416 # 80027480 <cons>
    80006a10:	0a072783          	lw	a5,160(a4)
    80006a14:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a18:	00021497          	auipc	s1,0x21
    80006a1c:	a6848493          	addi	s1,s1,-1432 # 80027480 <cons>
    while(cons.e != cons.w &&
    80006a20:	4929                	li	s2,10
    80006a22:	f4f70be3          	beq	a4,a5,80006978 <consoleintr+0x3c>
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a26:	37fd                	addiw	a5,a5,-1
    80006a28:	07f7f713          	andi	a4,a5,127
    80006a2c:	9726                	add	a4,a4,s1
    while(cons.e != cons.w &&
    80006a2e:	01874703          	lbu	a4,24(a4)
    80006a32:	f52703e3          	beq	a4,s2,80006978 <consoleintr+0x3c>
      cons.e--;
    80006a36:	0af4a023          	sw	a5,160(s1)
      consputc(BACKSPACE);
    80006a3a:	10000513          	li	a0,256
    80006a3e:	00000097          	auipc	ra,0x0
    80006a42:	ebc080e7          	jalr	-324(ra) # 800068fa <consputc>
    while(cons.e != cons.w &&
    80006a46:	0a04a783          	lw	a5,160(s1)
    80006a4a:	09c4a703          	lw	a4,156(s1)
    80006a4e:	fcf71ce3          	bne	a4,a5,80006a26 <consoleintr+0xea>
    80006a52:	b71d                	j	80006978 <consoleintr+0x3c>
    if(cons.e != cons.w){
    80006a54:	00021717          	auipc	a4,0x21
    80006a58:	a2c70713          	addi	a4,a4,-1492 # 80027480 <cons>
    80006a5c:	0a072783          	lw	a5,160(a4)
    80006a60:	09c72703          	lw	a4,156(a4)
    80006a64:	f0f70ae3          	beq	a4,a5,80006978 <consoleintr+0x3c>
      cons.e--;
    80006a68:	37fd                	addiw	a5,a5,-1
    80006a6a:	00021717          	auipc	a4,0x21
    80006a6e:	aaf72b23          	sw	a5,-1354(a4) # 80027520 <cons+0xa0>
      consputc(BACKSPACE);
    80006a72:	10000513          	li	a0,256
    80006a76:	00000097          	auipc	ra,0x0
    80006a7a:	e84080e7          	jalr	-380(ra) # 800068fa <consputc>
    80006a7e:	bded                	j	80006978 <consoleintr+0x3c>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80006a80:	ee048ce3          	beqz	s1,80006978 <consoleintr+0x3c>
    80006a84:	bf21                	j	8000699c <consoleintr+0x60>
      consputc(c);
    80006a86:	4529                	li	a0,10
    80006a88:	00000097          	auipc	ra,0x0
    80006a8c:	e72080e7          	jalr	-398(ra) # 800068fa <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a90:	00021797          	auipc	a5,0x21
    80006a94:	9f078793          	addi	a5,a5,-1552 # 80027480 <cons>
    80006a98:	0a07a703          	lw	a4,160(a5)
    80006a9c:	0017069b          	addiw	a3,a4,1
    80006aa0:	0006861b          	sext.w	a2,a3
    80006aa4:	0ad7a023          	sw	a3,160(a5)
    80006aa8:	07f77713          	andi	a4,a4,127
    80006aac:	97ba                	add	a5,a5,a4
    80006aae:	4729                	li	a4,10
    80006ab0:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80006ab4:	00021797          	auipc	a5,0x21
    80006ab8:	a6c7a423          	sw	a2,-1432(a5) # 8002751c <cons+0x9c>
        wakeup(&cons.r);
    80006abc:	00021517          	auipc	a0,0x21
    80006ac0:	a5c50513          	addi	a0,a0,-1444 # 80027518 <cons+0x98>
    80006ac4:	ffffb097          	auipc	ra,0xffffb
    80006ac8:	c24080e7          	jalr	-988(ra) # 800016e8 <wakeup>
    80006acc:	b575                	j	80006978 <consoleintr+0x3c>

0000000080006ace <consoleinit>:
...
consoleinit(void)
{
    ...
    80006ad2:	e022                	sd	s0,0(sp)
    80006ad4:	0800                	addi	s0,sp,16
  initlock(&cons.lock, "cons");
    80006ad6:	00003597          	auipc	a1,0x3
    80006ada:	d3a58593          	addi	a1,a1,-710 # 80009810 <syscalls+0x438>
    80006ade:	00021517          	auipc	a0,0x21
    80006ae2:	9a250513          	addi	a0,a0,-1630 # 80027480 <cons>
    80006ae6:	00000097          	auipc	ra,0x0
    80006aea:	590080e7          	jalr	1424(ra) # 80007076 <initlock>

  uartinit();
    80006aee:	00000097          	auipc	ra,0x0
    80006af2:	330080e7          	jalr	816(ra) # 80006e1e <uartinit>

  // connect read and write system calls
  // to consoleread and consolewrite.
  devsw[CONSOLE].read = consoleread;
    80006af6:	00013797          	auipc	a5,0x13
    80006afa:	5f278793          	addi	a5,a5,1522 # 8001a0e8 <devsw>
    80006afe:	00000717          	auipc	a4,0x0
    80006b02:	ce470713          	addi	a4,a4,-796 # 800067e2 <consoleread>
    80006b06:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    80006b08:	00000717          	auipc	a4,0x0
    80006b0c:	c7870713          	addi	a4,a4,-904 # 80006780 <consolewrite>
    80006b10:	ef98                	sd	a4,24(a5)
}
    80006b12:	60a2                	ld	ra,8(sp)
    80006b14:	6402                	ld	s0,0(sp)
    80006b16:	0141                	addi	sp,sp,16
    80006b18:	8082                	ret

0000000080006b1a <printint>:
...
{
    80006b1a:	7179                	addi	sp,sp,-48
    80006b1c:	f406                	sd	ra,40(sp)
    80006b1e:	f022                	sd	s0,32(sp)
    80006b20:	ec26                	sd	s1,24(sp)
    80006b22:	e84a                	sd	s2,16(sp)
    80006b24:	1800                	addi	s0,sp,48
  char buf[16];
  int i;
  uint x;

  if(sign && (sign = xx < 0))
    80006b26:	c219                	beqz	a2,80006b2c <printint+0x12>
    80006b28:	08054663          	bltz	a0,80006bb4 <printint+0x9a>
    x = -xx;
  else
    x = xx;
    80006b2c:	2501                	sext.w	a0,a0
    80006b2e:	4881                	li	a7,0
    80006b30:	fd040693          	addi	a3,s0,-48

  i = 0;
    80006b34:	4701                	li	a4,0
  do {
    buf[i++] = digits[x % base];
    80006b36:	2581                	sext.w	a1,a1
    80006b38:	00003617          	auipc	a2,0x3
    80006b3c:	d0860613          	addi	a2,a2,-760 # 80009840 <digits>
    80006b40:	883a                	mv	a6,a4
    80006b42:	2705                	addiw	a4,a4,1
    80006b44:	02b577bb          	remuw	a5,a0,a1
    80006b48:	1782                	slli	a5,a5,0x20
    80006b4a:	9381                	srli	a5,a5,0x20
    80006b4c:	97b2                	add	a5,a5,a2
    80006b4e:	0007c783          	lbu	a5,0(a5)
    80006b52:	00f68023          	sb	a5,0(a3)
  } while((x /= base) != 0);
    80006b56:	0005079b          	sext.w	a5,a0
    80006b5a:	02b5553b          	divuw	a0,a0,a1
    80006b5e:	0685                	addi	a3,a3,1
    80006b60:	feb7f0e3          	bgeu	a5,a1,80006b40 <printint+0x26>

  if(sign)
    80006b64:	00088b63          	beqz	a7,80006b7a <printint+0x60>
    buf[i++] = '-';
    80006b68:	fe040793          	addi	a5,s0,-32
    80006b6c:	973e                	add	a4,a4,a5
    80006b6e:	02d00793          	li	a5,45
    80006b72:	fef70823          	sb	a5,-16(a4)
    80006b76:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    80006b7a:	02e05763          	blez	a4,80006ba8 <printint+0x8e>
    80006b7e:	fd040793          	addi	a5,s0,-48
    80006b82:	00e784b3          	add	s1,a5,a4
    80006b86:	fff78913          	addi	s2,a5,-1
    80006b8a:	993a                	add	s2,s2,a4
    80006b8c:	377d                	addiw	a4,a4,-1
    80006b8e:	1702                	slli	a4,a4,0x20
    80006b90:	9301                	srli	a4,a4,0x20
    80006b92:	40e90933          	sub	s2,s2,a4
    consputc(buf[i]);
    80006b96:	fff4c503          	lbu	a0,-1(s1)
    80006b9a:	00000097          	auipc	ra,0x0
    80006b9e:	d60080e7          	jalr	-672(ra) # 800068fa <consputc>
  while(--i >= 0)
    80006ba2:	14fd                	addi	s1,s1,-1
    80006ba4:	ff2499e3          	bne	s1,s2,80006b96 <printint+0x7c>
}
    ...
    80006bb2:	8082                	ret
    x = -xx;
    80006bb4:	40a0053b          	negw	a0,a0
  if(sign && (sign = xx < 0))
    80006bb8:	4885                	li	a7,1
    x = -xx;
    80006bba:	bf9d                	j	80006b30 <printint+0x16>

0000000080006bbc <panic>:
    release(&pr.lock);
}
...
panic(char *s)
{
  ...
  pr.locking = 0;
    80006bc8:	00021797          	auipc	a5,0x21
    80006bcc:	9607ac23          	sw	zero,-1672(a5) # 80027540 <pr+0x18>
  printf("panic: ");
    80006bd0:	00003517          	auipc	a0,0x3
    80006bd4:	c4850513          	addi	a0,a0,-952 # 80009818 <syscalls+0x440>
    80006bd8:	00000097          	auipc	ra,0x0
    80006bdc:	02e080e7          	jalr	46(ra) # 80006c06 <printf>
  printf(s);
    80006be0:	8526                	mv	a0,s1
    80006be2:	00000097          	auipc	ra,0x0
    80006be6:	024080e7          	jalr	36(ra) # 80006c06 <printf>
  printf("\n");
    80006bea:	00002517          	auipc	a0,0x2
    80006bee:	45e50513          	addi	a0,a0,1118 # 80009048 <etext+0x48>
    80006bf2:	00000097          	auipc	ra,0x0
    80006bf6:	014080e7          	jalr	20(ra) # 80006c06 <printf>
  panicked = 1; // freeze uart output from other CPUs
    80006bfa:	4785                	li	a5,1
    80006bfc:	00003717          	auipc	a4,0x3
    80006c00:	42f72a23          	sw	a5,1076(a4) # 8000a030 <panicked>
  for(;;)
    80006c04:	a001                	j	80006c04 <panic+0x48>

0000000080006c06 <printf>:
{
    80006c06:	7131                	addi	sp,sp,-192
    80006c08:	fc86                	sd	ra,120(sp)
    80006c0a:	f8a2                	sd	s0,112(sp)
    80006c0c:	f4a6                	sd	s1,104(sp)
    80006c0e:	f0ca                	sd	s2,96(sp)
    80006c10:	ecce                	sd	s3,88(sp)
    ...
    80006c22:	0100                	addi	s0,sp,128
    80006c24:	8a2a                	mv	s4,a0
    80006c26:	e40c                	sd	a1,8(s0)
    80006c28:	e810                	sd	a2,16(s0)
    80006c2a:	ec14                	sd	a3,24(s0)
    80006c2c:	f018                	sd	a4,32(s0)
    80006c2e:	f41c                	sd	a5,40(s0)
    80006c30:	03043823          	sd	a6,48(s0)
    80006c34:	03143c23          	sd	a7,56(s0)
  locking = pr.locking;
    80006c38:	00021d97          	auipc	s11,0x21
    80006c3c:	908dad83          	lw	s11,-1784(s11) # 80027540 <pr+0x18>
  if(locking)
    80006c40:	020d9b63          	bnez	s11,80006c76 <printf+0x70>
  if (fmt == 0)
    80006c44:	040a0263          	beqz	s4,80006c88 <printf+0x82>
  va_start(ap, fmt);
    80006c48:	00840793          	addi	a5,s0,8
    80006c4c:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006c50:	000a4503          	lbu	a0,0(s4) # 2000 <_entry-0x7fffe000>
    80006c54:	16050263          	beqz	a0,80006db8 <printf+0x1b2>
    80006c58:	4481                	li	s1,0
    if(c != '%'){
    80006c5a:	02500a93          	li	s5,37
    switch(c){
    80006c5e:	07000b13          	li	s6,112
  consputc('x');
    80006c62:	4d41                	li	s10,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006c64:	00003b97          	auipc	s7,0x3
    80006c68:	bdcb8b93          	addi	s7,s7,-1060 # 80009840 <digits>
    switch(c){
    80006c6c:	07300c93          	li	s9,115
    80006c70:	06400c13          	li	s8,100
    80006c74:	a82d                	j	80006cae <printf+0xa8>
    acquire(&pr.lock);
    80006c76:	00021517          	auipc	a0,0x21
    80006c7a:	8b250513          	addi	a0,a0,-1870 # 80027528 <pr>
    80006c7e:	00000097          	auipc	ra,0x0
    80006c82:	488080e7          	jalr	1160(ra) # 80007106 <acquire>
    80006c86:	bf7d                	j	80006c44 <printf+0x3e>
    panic("null fmt");
    80006c88:	00003517          	auipc	a0,0x3
    80006c8c:	ba050513          	addi	a0,a0,-1120 # 80009828 <syscalls+0x450>
    80006c90:	00000097          	auipc	ra,0x0
    80006c94:	f2c080e7          	jalr	-212(ra) # 80006bbc <panic>
      consputc(c);
    80006c98:	00000097          	auipc	ra,0x0
    80006c9c:	c62080e7          	jalr	-926(ra) # 800068fa <consputc>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006ca0:	2485                	addiw	s1,s1,1
    80006ca2:	009a07b3          	add	a5,s4,s1
    80006ca6:	0007c503          	lbu	a0,0(a5)
    80006caa:	10050763          	beqz	a0,80006db8 <printf+0x1b2>
    if(c != '%'){
    80006cae:	ff5515e3          	bne	a0,s5,80006c98 <printf+0x92>
    c = fmt[++i] & 0xff;
    80006cb2:	2485                	addiw	s1,s1,1
    80006cb4:	009a07b3          	add	a5,s4,s1
    80006cb8:	0007c783          	lbu	a5,0(a5)
    80006cbc:	0007891b          	sext.w	s2,a5
    if(c == 0)
    80006cc0:	cfe5                	beqz	a5,80006db8 <printf+0x1b2>
    switch(c){
    80006cc2:	05678a63          	beq	a5,s6,80006d16 <printf+0x110>
    80006cc6:	02fb7663          	bgeu	s6,a5,80006cf2 <printf+0xec>
    80006cca:	09978963          	beq	a5,s9,80006d5c <printf+0x156>
    80006cce:	07800713          	li	a4,120
    80006cd2:	0ce79863          	bne	a5,a4,80006da2 <printf+0x19c>
      printint(va_arg(ap, int), 16, 1);
    80006cd6:	f8843783          	ld	a5,-120(s0)
    80006cda:	00878713          	addi	a4,a5,8
    80006cde:	f8e43423          	sd	a4,-120(s0)
    80006ce2:	4605                	li	a2,1
    80006ce4:	85ea                	mv	a1,s10
    80006ce6:	4388                	lw	a0,0(a5)
    80006ce8:	00000097          	auipc	ra,0x0
    80006cec:	e32080e7          	jalr	-462(ra) # 80006b1a <printint>
      break;
    80006cf0:	bf45                	j	80006ca0 <printf+0x9a>
    switch(c){
    80006cf2:	0b578263          	beq	a5,s5,80006d96 <printf+0x190>
    80006cf6:	0b879663          	bne	a5,s8,80006da2 <printf+0x19c>
      printint(va_arg(ap, int), 10, 1);
    80006cfa:	f8843783          	ld	a5,-120(s0)
    80006cfe:	00878713          	addi	a4,a5,8
    80006d02:	f8e43423          	sd	a4,-120(s0)
    80006d06:	4605                	li	a2,1
    80006d08:	45a9                	li	a1,10
    80006d0a:	4388                	lw	a0,0(a5)
    80006d0c:	00000097          	auipc	ra,0x0
    80006d10:	e0e080e7          	jalr	-498(ra) # 80006b1a <printint>
      break;
    80006d14:	b771                	j	80006ca0 <printf+0x9a>
      printptr(va_arg(ap, uint64));
    80006d16:	f8843783          	ld	a5,-120(s0)
    80006d1a:	00878713          	addi	a4,a5,8
    80006d1e:	f8e43423          	sd	a4,-120(s0)
    80006d22:	0007b983          	ld	s3,0(a5)
  consputc('0');
    80006d26:	03000513          	li	a0,48
    80006d2a:	00000097          	auipc	ra,0x0
    80006d2e:	bd0080e7          	jalr	-1072(ra) # 800068fa <consputc>
  consputc('x');
    80006d32:	07800513          	li	a0,120
    80006d36:	00000097          	auipc	ra,0x0
    80006d3a:	bc4080e7          	jalr	-1084(ra) # 800068fa <consputc>
    80006d3e:	896a                	mv	s2,s10
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006d40:	03c9d793          	srli	a5,s3,0x3c
    80006d44:	97de                	add	a5,a5,s7
    80006d46:	0007c503          	lbu	a0,0(a5)
    80006d4a:	00000097          	auipc	ra,0x0
    80006d4e:	bb0080e7          	jalr	-1104(ra) # 800068fa <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    80006d52:	0992                	slli	s3,s3,0x4
    80006d54:	397d                	addiw	s2,s2,-1
    80006d56:	fe0915e3          	bnez	s2,80006d40 <printf+0x13a>
    80006d5a:	b799                	j	80006ca0 <printf+0x9a>
      if((s = va_arg(ap, char*)) == 0)
    80006d5c:	f8843783          	ld	a5,-120(s0)
    80006d60:	00878713          	addi	a4,a5,8
    80006d64:	f8e43423          	sd	a4,-120(s0)
    80006d68:	0007b903          	ld	s2,0(a5)
    80006d6c:	00090e63          	beqz	s2,80006d88 <printf+0x182>
      for(; *s; s++)
    80006d70:	00094503          	lbu	a0,0(s2)
    80006d74:	d515                	beqz	a0,80006ca0 <printf+0x9a>
        consputc(*s);
    80006d76:	00000097          	auipc	ra,0x0
    80006d7a:	b84080e7          	jalr	-1148(ra) # 800068fa <consputc>
      for(; *s; s++)
    80006d7e:	0905                	addi	s2,s2,1
    80006d80:	00094503          	lbu	a0,0(s2)
    80006d84:	f96d                	bnez	a0,80006d76 <printf+0x170>
    80006d86:	bf29                	j	80006ca0 <printf+0x9a>
        s = "(null)";
    80006d88:	00003917          	auipc	s2,0x3
    80006d8c:	a9890913          	addi	s2,s2,-1384 # 80009820 <syscalls+0x448>
      for(; *s; s++)
    80006d90:	02800513          	li	a0,40
    80006d94:	b7cd                	j	80006d76 <printf+0x170>
      consputc('%');
    80006d96:	8556                	mv	a0,s5
    80006d98:	00000097          	auipc	ra,0x0
    80006d9c:	b62080e7          	jalr	-1182(ra) # 800068fa <consputc>
      break;
    80006da0:	b701                	j	80006ca0 <printf+0x9a>
      consputc('%');
    80006da2:	8556                	mv	a0,s5
    80006da4:	00000097          	auipc	ra,0x0
    80006da8:	b56080e7          	jalr	-1194(ra) # 800068fa <consputc>
      consputc(c);
    80006dac:	854a                	mv	a0,s2
    80006dae:	00000097          	auipc	ra,0x0
    80006db2:	b4c080e7          	jalr	-1204(ra) # 800068fa <consputc>
      break;
    80006db6:	b5ed                	j	80006ca0 <printf+0x9a>
  if(locking)
    80006db8:	020d9163          	bnez	s11,80006dda <printf+0x1d4>
}
    80006dbc:	70e6                	ld	ra,120(sp)
    80006dbe:	7446                	ld	s0,112(sp)
    80006dc0:	74a6                	ld	s1,104(sp)
    80006dc2:	7906                	ld	s2,96(sp)
    80006dc4:	69e6                	ld	s3,88(sp)
    80006dc6:	6a46                	ld	s4,80(sp)
    80006dc8:	6aa6                	ld	s5,72(sp)
    80006dca:	6b06                	ld	s6,64(sp)
    80006dcc:	7be2                	ld	s7,56(sp)
    80006dce:	7c42                	ld	s8,48(sp)
    80006dd0:	7ca2                	ld	s9,40(sp)
    80006dd2:	7d02                	ld	s10,32(sp)
    80006dd4:	6de2                	ld	s11,24(sp)
    80006dd6:	6129                	addi	sp,sp,192
    80006dd8:	8082                	ret
    release(&pr.lock);
    80006dda:	00020517          	auipc	a0,0x20
    80006dde:	74e50513          	addi	a0,a0,1870 # 80027528 <pr>
    80006de2:	00000097          	auipc	ra,0x0
    80006de6:	3d8080e7          	jalr	984(ra) # 800071ba <release>
}
    80006dea:	bfc9                	j	80006dbc <printf+0x1b6>

0000000080006dec <printfinit>:
    ;
}
...
printfinit(void)
{
    ...
    80006df4:	1000                	addi	s0,sp,32
  initlock(&pr.lock, "pr");
    80006df6:	00020497          	auipc	s1,0x20
    80006dfa:	73248493          	addi	s1,s1,1842 # 80027528 <pr>
    80006dfe:	00003597          	auipc	a1,0x3
    80006e02:	a3a58593          	addi	a1,a1,-1478 # 80009838 <syscalls+0x460>
    80006e06:	8526                	mv	a0,s1
    80006e08:	00000097          	auipc	ra,0x0
    80006e0c:	26e080e7          	jalr	622(ra) # 80007076 <initlock>
  pr.locking = 1;
    80006e10:	4785                	li	a5,1
    80006e12:	cc9c                	sw	a5,24(s1)
}
    80006e14:	60e2                	ld	ra,24(sp)
    80006e16:	6442                	ld	s0,16(sp)
    80006e18:	64a2                	ld	s1,8(sp)
    80006e1a:	6105                	addi	sp,sp,32
    80006e1c:	8082                	ret

0000000080006e1e <uartinit>:
...
uartinit(void)
{
    ...
    80006e20:	e406                	sd	ra,8(sp)
    80006e22:	e022                	sd	s0,0(sp)
    80006e24:	0800                	addi	s0,sp,16
  // disable interrupts.
  WriteReg(IER, 0x00);
    80006e26:	100007b7          	lui	a5,0x10000
    80006e2a:	000780a3          	sb	zero,1(a5) # 10000001 <_entry-0x6fffffff>

  // special mode to set baud rate.
  WriteReg(LCR, LCR_BAUD_LATCH);
    80006e2e:	f8000713          	li	a4,-128
    80006e32:	00e781a3          	sb	a4,3(a5)

  // LSB for baud rate of 38.4K.
  WriteReg(0, 0x03);
    80006e36:	470d                	li	a4,3
    80006e38:	00e78023          	sb	a4,0(a5)

  // MSB for baud rate of 38.4K.
  WriteReg(1, 0x00);
    80006e3c:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80006e40:	00e781a3          	sb	a4,3(a5)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    80006e44:	469d                	li	a3,7
    80006e46:	00d78123          	sb	a3,2(a5)

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80006e4a:	00e780a3          	sb	a4,1(a5)

  initlock(&uart_tx_lock, "uart");
    80006e4e:	00003597          	auipc	a1,0x3
    80006e52:	a0a58593          	addi	a1,a1,-1526 # 80009858 <digits+0x18>
    80006e56:	00020517          	auipc	a0,0x20
    80006e5a:	6f250513          	addi	a0,a0,1778 # 80027548 <uart_tx_lock>
    80006e5e:	00000097          	auipc	ra,0x0
    80006e62:	218080e7          	jalr	536(ra) # 80007076 <initlock>
}
    80006e66:	60a2                	ld	ra,8(sp)
    80006e68:	6402                	ld	s0,0(sp)
    80006e6a:	0141                	addi	sp,sp,16
    80006e6c:	8082                	ret

0000000080006e6e <uartputc_sync>:
...
uartputc_sync(int c)
{
    80006e6e:	1101                	addi	sp,sp,-32
    80006e70:	ec06                	sd	ra,24(sp)
    80006e72:	e822                	sd	s0,16(sp)
    80006e74:	e426                	sd	s1,8(sp)
    80006e76:	1000                	addi	s0,sp,32
    80006e78:	84aa                	mv	s1,a0
  push_off();
    80006e7a:	00000097          	auipc	ra,0x0
    80006e7e:	240080e7          	jalr	576(ra) # 800070ba <push_off>

  if(panicked){
    80006e82:	00003797          	auipc	a5,0x3
    80006e86:	1ae7a783          	lw	a5,430(a5) # 8000a030 <panicked>
    for(;;)
      ;
  }
  ...
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006e8a:	10000737          	lui	a4,0x10000
  if(panicked){
    80006e8e:	c391                	beqz	a5,80006e92 <uartputc_sync+0x24>
    for(;;)
    80006e90:	a001                	j	80006e90 <uartputc_sync+0x22>
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006e92:	00574783          	lbu	a5,5(a4) # 10000005 <_entry-0x6ffffffb>
    80006e96:	0ff7f793          	andi	a5,a5,255
    80006e9a:	0207f793          	andi	a5,a5,32
    80006e9e:	dbf5                	beqz	a5,80006e92 <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    80006ea0:	0ff4f793          	andi	a5,s1,255
    80006ea4:	10000737          	lui	a4,0x10000
    80006ea8:	00f70023          	sb	a5,0(a4) # 10000000 <_entry-0x70000000>

  pop_off();
    80006eac:	00000097          	auipc	ra,0x0
    80006eb0:	2ae080e7          	jalr	686(ra) # 8000715a <pop_off>
}
    80006eb4:	60e2                	ld	ra,24(sp)
    80006eb6:	6442                	ld	s0,16(sp)
    80006eb8:	64a2                	ld	s1,8(sp)
    80006eba:	6105                	addi	sp,sp,32
    80006ebc:	8082                	ret

0000000080006ebe <uartstart>:
...
uartstart()
{
  while(1){
    ...
    80006ebe:	00003717          	auipc	a4,0x3
    80006ec2:	17a73703          	ld	a4,378(a4) # 8000a038 <uart_tx_r>
    80006ec6:	00003797          	auipc	a5,0x3
    80006eca:	17a7b783          	ld	a5,378(a5) # 8000a040 <uart_tx_w>
    80006ece:	06e78c63          	beq	a5,a4,80006f46 <uartstart+0x88>
{
    80006ed2:	7139                	addi	sp,sp,-64
    80006ed4:	fc06                	sd	ra,56(sp)
    80006ed6:	f822                	sd	s0,48(sp)
    80006ed8:	f426                	sd	s1,40(sp)
    80006eda:	f04a                	sd	s2,32(sp)
    80006edc:	ec4e                	sd	s3,24(sp)
    80006ede:	e852                	sd	s4,16(sp)
    80006ee0:	e456                	sd	s5,8(sp)
    80006ee2:	0080                	addi	s0,sp,64
      // transmit buffer is empty.
      return;
    }
    
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006ee4:	10000937          	lui	s2,0x10000
    ...
    80006ee8:	00020a17          	auipc	s4,0x20
    80006eec:	660a0a13          	addi	s4,s4,1632 # 80027548 <uart_tx_lock>
    uart_tx_r += 1;
    80006ef0:	00003497          	auipc	s1,0x3
    80006ef4:	14848493          	addi	s1,s1,328 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80006ef8:	00003997          	auipc	s3,0x3
    80006efc:	14898993          	addi	s3,s3,328 # 8000a040 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f00:	00594783          	lbu	a5,5(s2) # 10000005 <_entry-0x6ffffffb>
    80006f04:	0ff7f793          	andi	a5,a5,255
    80006f08:	0207f793          	andi	a5,a5,32
    80006f0c:	c785                	beqz	a5,80006f34 <uartstart+0x76>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80006f0e:	01f77793          	andi	a5,a4,31
    80006f12:	97d2                	add	a5,a5,s4
    80006f14:	0187ca83          	lbu	s5,24(a5)
    uart_tx_r += 1;
    80006f18:	0705                	addi	a4,a4,1
    80006f1a:	e098                	sd	a4,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    80006f1c:	8526                	mv	a0,s1
    80006f1e:	ffffa097          	auipc	ra,0xffffa
    80006f22:	7ca080e7          	jalr	1994(ra) # 800016e8 <wakeup>
    
    WriteReg(THR, c);
    80006f26:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    80006f2a:	6098                	ld	a4,0(s1)
    80006f2c:	0009b783          	ld	a5,0(s3)
    80006f30:	fce798e3          	bne	a5,a4,80006f00 <uartstart+0x42>
  }
}
...
0000000080006f48 <uartputc>:
{
  ...
  if(panicked){
    ...
    80006f76:	00003797          	auipc	a5,0x3
    80006f7a:	0ca7b783          	ld	a5,202(a5) # 8000a040 <uart_tx_w>
    80006f7e:	00003717          	auipc	a4,0x3
    80006f82:	0ba73703          	ld	a4,186(a4) # 8000a038 <uart_tx_r>
    80006f86:	02070713          	addi	a4,a4,32
    80006f8a:	02f71b63          	bne	a4,a5,80006fc0 <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006f8e:	00020a17          	auipc	s4,0x20
    80006f92:	5baa0a13          	addi	s4,s4,1466 # 80027548 <uart_tx_lock>
    ...
    80006fa2:	0a290913          	addi	s2,s2,162 # 8000a040 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006fa6:	85d2                	mv	a1,s4
    80006fa8:	8526                	mv	a0,s1
    80006faa:	ffffa097          	auipc	ra,0xffffa
    80006fae:	5b2080e7          	jalr	1458(ra) # 8000155c <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fb2:	00093783          	ld	a5,0(s2)
    80006fb6:	6098                	ld	a4,0(s1)
    80006fb8:	02070713          	addi	a4,a4,32
    80006fbc:	fef705e3          	beq	a4,a5,80006fa6 <uartputc+0x5e>
    ...
    80006fcc:	9726                	add	a4,a4,s1
    80006fce:	01370c23          	sb	s3,24(a4)
      uart_tx_w += 1;
    80006fd2:	0785                	addi	a5,a5,1
    80006fd4:	00003717          	auipc	a4,0x3
    80006fd8:	06f73623          	sd	a5,108(a4) # 8000a040 <uart_tx_w>
      uartstart();
    80006fdc:	00000097          	auipc	ra,0x0
    80006fe0:	ee2080e7          	jalr	-286(ra) # 80006ebe <uartstart>
...
uartintr(void)
{
  ...
  while(1){
    ...
    80007036:	fcc080e7          	jalr	-52(ra) # 80006ffe <uartgetc>
    if(c == -1)
    8000703a:	00950763          	beq	a0,s1,80007048 <uartintr+0x22>
      break;
    consoleintr(c);
    8000703e:	00000097          	auipc	ra,0x0
    80007042:	8fe080e7          	jalr	-1794(ra) # 8000693c <consoleintr>
  while(1){
    80007046:	b7f5                	j	80007032 <uartintr+0xc>
  }
  ...
  uartstart();
    ...
    8000705e:	e64080e7          	jalr	-412(ra) # 80006ebe <uartstart>
  release(&uart_tx_lock);
    ...
    80007092:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    ...
    800070a4:	de4080e7          	jalr	-540(ra) # 80000e84 <mycpu>
...
push_off(void)
{
  ...
  mycpu()->noff += 1;
    ...
    800070fa:	d8e080e7          	jalr	-626(ra) # 80000e84 <mycpu>
  return (x & SSTATUS_SIE) != 0;
...
0000000080007106 <acquire>:
{
  ...
  lk->cpu = mycpu();
    ...
    8000713a:	d4e080e7          	jalr	-690(ra) # 80000e84 <mycpu>
    ...
    8000714e:	71650513          	addi	a0,a0,1814 # 80009860 <digits+0x20>
    80007152:	00000097          	auipc	ra,0x0
    80007156:	a6a080e7          	jalr	-1430(ra) # 80006bbc <panic>
...
pop_off(void)
{
  ...
  struct cpu *c = mycpu();
    ...
    80007166:	d22080e7          	jalr	-734(ra) # 80000e84 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000719e:	6ce50513          	addi	a0,a0,1742 # 80009868 <digits+0x28>
    800071a2:	00000097          	auipc	ra,0x0
    800071a6:	a1a080e7          	jalr	-1510(ra) # 80006bbc <panic>
    panic("pop_off");
    800071aa:	00002517          	auipc	a0,0x2
    800071ae:	6d650513          	addi	a0,a0,1750 # 80009880 <digits+0x40>
    800071b2:	00000097          	auipc	ra,0x0
    800071b6:	a0a080e7          	jalr	-1526(ra) # 80006bbc <panic>
...
00000000800071ba <release>:
{
  ...
  pop_off();
    ...
    800071f6:	69650513          	addi	a0,a0,1686 # 80009888 <digits+0x48>
    800071fa:	00000097          	auipc	ra,0x0
    800071fe:	9c2080e7          	jalr	-1598(ra) # 80006bbc <panic>
