...
int main(int argc, char* argv[]) {
  ...
  24:	89ae                	mv	s3,a1
    ...
    for (i = 1; i < argc; i++) {
  26:	4785                	li	a5,1
  28:	02a7d463          	bge	a5,a0,50 <main+0x50>
  2c:	00858713          	addi	a4,a1,8
  30:	cc040793          	addi	a5,s0,-832
  34:	ffe5061b          	addiw	a2,a0,-2
  38:	1602                	slli	a2,a2,0x20
  3a:	9201                	srli	a2,a2,0x20
  3c:	060e                	slli	a2,a2,0x3
  3e:	cc840693          	addi	a3,s0,-824
  42:	9636                	add	a2,a2,a3
        xargs[i - 1] = argv[i];
  44:	6314                	ld	a3,0(a4)
  46:	e394                	sd	a3,0(a5)
    for (i = 1; i < argc; i++) {
  48:	0721                	addi	a4,a4,8
  4a:	07a1                	addi	a5,a5,8
  4c:	fec79ce3          	bne	a5,a2,44 <main+0x44>
    }

    // 无限循环，直到用户输入为空
    while (1) {
        int x = argc - 1;
  50:	fffa0a9b          	addiw	s5,s4,-1
        // 从标准输入读取一行
        ...
        xargs[x++] = buf;
  54:	0a8e                	slli	s5,s5,0x3
  56:	fc040793          	addi	a5,s0,-64
  5a:	9abe                	add	s5,s5,a5

        // 遍历输入的字符串，处理空格和换行符
        for (char* p = buf; *p; p++) {
            if (*p == ' ') {
  5c:	02000493          	li	s1,32
                *p = 0;
                xargs[x++] = p + 1;
            } else if (*p == '\n') {
  60:	4929                	li	s2,10
  62:	a091                	j	a6 <main+0xa6>
                *p = 0;
  64:	00078023          	sb	zero,0(a5)
                xargs[x++] = p + 1;
  68:	00369713          	slli	a4,a3,0x3
  6c:	fc040613          	addi	a2,s0,-64
  70:	9732                	add	a4,a4,a2
  72:	00178613          	addi	a2,a5,1
  76:	d0c73023          	sd	a2,-768(a4)
  7a:	2685                	addiw	a3,a3,1
        for (char* p = buf; *p; p++) {
  7c:	0785                	addi	a5,a5,1
  7e:	0007c703          	lbu	a4,0(a5)
  82:	cb01                	beqz	a4,92 <main+0x92>
            if (*p == ' ') {
  84:	fe9700e3          	beq	a4,s1,64 <main+0x64>
            } else if (*p == '\n') {
  88:	ff271ae3          	bne	a4,s2,7c <main+0x7c>
                *p = 0;
  8c:	00078023          	sb	zero,0(a5)
  90:	b7f5                	j	7c <main+0x7c>
            }
        }
  ...
  96:	2e0080e7          	jalr	736(ra) # 372 <fork>
  9a:	c905                	beqz	a0,ca <main+0xca>
  ...
  a2:	2e4080e7          	jalr	740(ra) # 382 <wait>
        if (!gets(buf, sizeof(buf)) || buf[0] == 0)
  a6:	20000593          	li	a1,512
  aa:	dc040513          	addi	a0,s0,-576
  ae:	00000097          	auipc	ra,0x0
  b2:	112080e7          	jalr	274(ra) # 1c0 <gets>
  b6:	c131                	beqz	a0,fa <main+0xfa>
  b8:	dc044703          	lbu	a4,-576(s0)
  bc:	cf1d                	beqz	a4,fa <main+0xfa>
        xargs[x++] = buf;
  be:	dc040793          	addi	a5,s0,-576
  c2:	d0fab023          	sd	a5,-768(s5)
  c6:	86d2                	mv	a3,s4
  c8:	bf75                	j	84 <main+0x84>
            exec(argv[1], xargs);
  ca:	cc040593          	addi	a1,s0,-832
  ce:	0089b503          	ld	a0,8(s3)
  d2:	00000097          	auipc	ra,0x0
  d6:	2e0080e7          	jalr	736(ra) # 3b2 <exec>
            fprintf(2, "exec %s failed\n", argv[1]);
  da:	0089b603          	ld	a2,8(s3)
  de:	00000597          	auipc	a1,0x0
  e2:	7c258593          	addi	a1,a1,1986 # 8a0 <malloc+0xe8>
  e6:	4509                	li	a0,2
  e8:	00000097          	auipc	ra,0x0
  ec:	5e4080e7          	jalr	1508(ra) # 6cc <fprintf>
            exit(1);
  f0:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46a:	45250513          	addi	a0,a0,1106 # 8b8 <digits>
 46e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 536:	386b8b93          	addi	s7,s7,902 # 8b8 <digits>
 ...
 676:	23e90913          	addi	s2,s2,574 # 8b0 <malloc+0xf8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 73e:	1967b783          	ld	a5,406(a5) # 8d0 <freep>
...
malloc(uint nbytes)
{
 ...
 7e0:	0f453503          	ld	a0,244(a0) # 8d0 <freep>
 ...
 808:	0cc90913          	addi	s2,s2,204 # 8d0 <freep>
  if(p == (char*)-1)
 80c:	5afd                	li	s5,-1
 80e:	a88d                	j	880 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 810:	00000797          	auipc	a5,0x0
 814:	0c878793          	addi	a5,a5,200 # 8d8 <base>
 818:	00000717          	auipc	a4,0x0
 81c:	0af73c23          	sd	a5,184(a4) # 8d0 <freep>
 820:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 842:	08a73923          	sd	a0,146(a4) # 8d0 <freep>
      return (void*)(p + 1);
